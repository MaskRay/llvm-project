...
PassBuilder::buildInlinerPipeline(OptimizationLevel Level,
  ...
  if (Opts.AttributorRun & AttributorRunOption::CGSCC)
    MainCGPipeline.addPass(AttributorCGSCCPass());
  else if (Opts.AttributorRun & AttributorRunOption::CGSCC_LIGHT)
...
PassBuilder::buildModuleSimplificationPipeline(OptimizationLevel Level,
  ...
  if (Opts.AttributorRun & AttributorRunOption::MODULE)
    MPM.addPass(AttributorPass());
  else if (Opts.AttributorRun & AttributorRunOption::MODULE_LIGHT)
