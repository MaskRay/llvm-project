...
getType64(MCFixupKind Kind, X86MCExpr::VariantKind &Modifier, bool &IsPCRel) {
  ...
  case X86::reloc_signed_4byte_relax:
    if (Modifier == X86MCExpr::VK_None && !IsPCRel)
      return RT64_32S;
    return RT64_32;
  case X86::reloc_global_offset_table:
    Modifier = X86MCExpr::VK_GOT;
    IsPCRel = true;
    return RT64_32;
  case FK_Data_4:
  case FK_PCRel_4:
...
static unsigned getRelocType64(MCContext &Ctx, SMLoc Loc,
                               X86MCExpr::VariantKind Modifier,
...
unsigned X86ELFObjectWriter::getRelocType(MCContext &Ctx, const MCValue &Target,
  ...
  auto Modifier = X86MCExpr::VariantKind(Target.getAccessVariant());
  switch (Modifier) {
  case X86MCExpr::VK_GOTTPOFF:
  case X86MCExpr::VK_INDNTPOFF:
  case X86MCExpr::VK_NTPOFF:
...
bool X86ELFObjectWriter::needsRelocateWithSymbol(const MCValue &V,
                                                 const MCSymbol &Sym,
                                                 unsigned Type) const {
  switch (getVariantKind(V.getSymA())) {
  case X86MCExpr::VK_GOT:
  case X86MCExpr::VK_PLT:
  case X86MCExpr::VK_GOTPCREL:
  case X86MCExpr::VK_GOTPCREL_NORELAX:
