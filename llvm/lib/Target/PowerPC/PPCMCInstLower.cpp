...
static MCOperand GetSymbolRef(const MachineOperand &MO, const MCSymbol *Symbol,
  ...
  switch (access) {
    case PPCII::MO_TPREL_LO:
      RefKind = PPCMCExpr::VK_PPC_TPREL_LO;
      break;
    case PPCII::MO_TPREL_HA:
      RefKind = PPCMCExpr::VK_PPC_TPREL_HA;
      break;
    case PPCII::MO_DTPREL_LO:
      RefKind = PPCMCExpr::VK_PPC_DTPREL_LO;
      break;
    case PPCII::MO_TLSLD_LO:
      RefKind = PPCMCExpr::VK_PPC_GOT_TLSLD_LO;
      break;
    case PPCII::MO_TOC_LO:
      RefKind = PPCMCExpr::VK_PPC_TOC_LO;
      break;
    case PPCII::MO_TLS:
      RefKind = PPCMCExpr::VK_PPC_TLS;
      break;
    case PPCII::MO_TLS_PCREL_FLAG:
      RefKind = PPCMCExpr::VK_PPC_TLS_PCREL;
      break;
  }
  ...
  if (MO.getTargetFlags() == PPCII::MO_PLT)
    ...
    RefKind = PPCMCExpr::VK_PPC_GOT_PCREL;
    ...
    RefKind = PPCMCExpr::VK_PPC_GOT_TLSGD_PCREL;
  else if (MO.getTargetFlags() == PPCII::MO_GOT_TLSLD_PCREL_FLAG)
    RefKind = PPCMCExpr::VK_PPC_GOT_TLSLD_PCREL;
  else if (MO.getTargetFlags() == PPCII::MO_GOT_TPREL_PCREL_FLAG)
    RefKind = PPCMCExpr::VK_PPC_GOT_TPREL_PCREL;
    ...
    if (Model == TLSModel::LocalExec)
      RefKind = PPCMCExpr::VK_PPC_AIX_TLSLE;
      ...
      RefKind = PPCMCExpr::VK_PPC_AIX_TLSIE;
    else if (Model == TLSModel::LocalDynamic)
      RefKind = PPCMCExpr::VK_PPC_AIX_TLSLD;
  }
  ...
  if (Subtarget->isUsingPCRelativeCalls()) {
    if (MIOpcode == PPC::TAILB || MIOpcode == PPC::TAILB8 ||
      ...
      RefKind = PPCMCExpr::VK_PPC_NOTOC;
    }
    if (MO.getTargetFlags() == PPCII::MO_PCREL_OPT_FLAG)
      RefKind = PPCMCExpr::VK_PPC_PCREL_OPT;
  }
