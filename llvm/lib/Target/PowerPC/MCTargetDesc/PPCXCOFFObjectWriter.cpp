...
std::pair<uint8_t, uint8_t> PPCXCOFFObjectWriter::getRelocTypeAndSignSize(
  ...
  const auto Modifier = Target.isAbsolute() ? MCSymbolRefExpr::VK_None
  ...
  case FK_Data_8:
    ...
    case PPCMCExpr::VK_PPC_AIX_TLSML:
