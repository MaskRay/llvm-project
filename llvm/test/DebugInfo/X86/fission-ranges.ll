...
; CHECK-NEXT:   DW_LLE_startx_length (0x00000005, 0x0000006e): DW_OP_breg7 RSP-48
; CHECK-NEXT:   DW_LLE_end_of_list   ()
; CHECK:      [[B]]:
; CHECK-NEXT:   DW_LLE_startx_length (0x00000006, 0x0000000b): DW_OP_reg0 RAX
; CHECK-NEXT:   DW_LLE_startx_length (0x00000007, 0x00000046): DW_OP_breg7 RSP-32
; CHECK-NEXT:   DW_LLE_end_of_list   ()
; CHECK:      [[D]]:
; CHECK-NEXT:   DW_LLE_startx_length (0x00000008, 0x0000000b): DW_OP_reg0 RAX
; CHECK-NEXT:   DW_LLE_startx_length (0x00000009, 0x0000002e): DW_OP_breg7 RSP-20
; CHECK-NEXT:   DW_LLE_end_of_list   ()
