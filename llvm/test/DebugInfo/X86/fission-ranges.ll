...
; CHECK-MIR: DBG_VALUE $rsp, 0, ![[BDIVAR]], !DIExpression(DW_OP_constu, 40, DW_OP_minus)
...
; CHECK-NEXT:   DW_LLE_startx_length (0x00000002, 0x00000003): DW_OP_reg0 RAX
; CHECK-NEXT:   DW_LLE_startx_length (0x00000003, 0x00000022): DW_OP_breg7 RSP-48
; CHECK-NEXT:   DW_LLE_end_of_list   ()
; CHECK:      [[E]]:
; CHECK-NEXT:   DW_LLE_startx_length (0x00000004, 0x00000003): DW_OP_reg0 RAX
; CHECK-NEXT:   DW_LLE_startx_length (0x00000005, 0x0000007a): DW_OP_breg7 RSP-32
; CHECK-NEXT:   DW_LLE_end_of_list   ()
; CHECK:      [[B]]:
; CHECK-NEXT:   DW_LLE_startx_length (0x00000006, 0x00000003): DW_OP_reg0 RAX
; CHECK-NEXT:   DW_LLE_startx_length (0x00000007, 0x00000062): DW_OP_breg7 RSP-40
; CHECK-NEXT:   DW_LLE_end_of_list   ()
; CHECK:      [[D]]:
; CHECK-NEXT:   DW_LLE_startx_length (0x00000008, 0x00000003): DW_OP_reg0 RAX
; CHECK-NEXT:   DW_LLE_startx_length (0x00000009, 0x00000042): DW_OP_breg7 RSP-44
; CHECK-NEXT:   DW_LLE_end_of_list   ()
