...
; CHECK-NEXT:    s32i a2, a1, 0 # 4-byte Folded Spill
; CHECK-NEXT:  .LBB0_2:
...
; CHECK-NEXT:    xor a8, a3, a5
; CHECK-NEXT:    xor a9, a2, a4
; CHECK-NEXT:    or a8, a9, a8
; CHECK-NEXT:    movi a9, 1
; CHECK-NEXT:    movi a3, 0
; CHECK-NEXT:    s32i a3, a1, 4 # 4-byte Folded Spill
; CHECK-NEXT:    or a2, a9, a9
; CHECK-NEXT:    s32i a2, a1, 0 # 4-byte Folded Spill
; CHECK-NEXT:    beq a8, a3, .LBB10_2
; CHECK-NEXT:  # %bb.1:
; CHECK-NEXT:    l32i a3, a1, 4 # 4-byte Folded Reload
...
; CHECK-NEXT:    or a1, a8, a8
; CHECK-NEXT:    s32i a5, a1, 36 # 4-byte Folded Spill
; CHECK-NEXT:    s32i a4, a1, 32 # 4-byte Folded Spill
; CHECK-NEXT:    s32i a3, a1, 28 # 4-byte Folded Spill
...
; CHECK-NEXT:    # kill: def $a8 killed $a2
; CHECK-NEXT:    movi a8, 0
; CHECK-NEXT:    s32i a8, a1, 20 # 4-byte Folded Spill
; CHECK-NEXT:    movi a9, 1
; CHECK-NEXT:    s32i a9, a1, 16 # 4-byte Folded Spill
; CHECK-NEXT:    or a10, a9, a9
; CHECK-NEXT:    s32i a10, a1, 12 # 4-byte Folded Spill
; CHECK-NEXT:    blt a3, a5, .LBB11_2
; CHECK-NEXT:  # %bb.1:
; CHECK-NEXT:    l32i a3, a1, 20 # 4-byte Folded Reload
; CHECK-NEXT:    or a8, a3, a3
; CHECK-NEXT:    s32i a8, a1, 12 # 4-byte Folded Spill
; CHECK-NEXT:  .LBB11_2:
; CHECK-NEXT:    l32i a8, a1, 12 # 4-byte Folded Reload
; CHECK-NEXT:    s32i a8, a1, 8 # 4-byte Folded Spill
; CHECK-NEXT:    l32i a9, a1, 16 # 4-byte Folded Reload
; CHECK-NEXT:    s32i a9, a1, 4 # 4-byte Folded Spill
; CHECK-NEXT:    l32i a2, a1, 24 # 4-byte Folded Reload
; CHECK-NEXT:    l32i a4, a1, 32 # 4-byte Folded Reload
; CHECK-NEXT:    bltu a2, a4, .LBB11_4
; CHECK-NEXT:  # %bb.3:
; CHECK-NEXT:    l32i a3, a1, 20 # 4-byte Folded Reload
; CHECK-NEXT:    or a8, a3, a3
; CHECK-NEXT:    s32i a8, a1, 4 # 4-byte Folded Spill
...
; CHECK-NEXT:    l32i a5, a1, 36 # 4-byte Folded Reload
; CHECK-NEXT:    beq a3, a5, .LBB11_6
; CHECK-NEXT:  # %bb.5:
; CHECK-NEXT:    l32i a8, a1, 8 # 4-byte Folded Reload
; CHECK-NEXT:    or a2, a8, a8
; CHECK-NEXT:    s32i a2, a1, 0 # 4-byte Folded Spill
; CHECK-NEXT:  .LBB11_6:
; CHECK-NEXT:    l32i a2, a1, 0 # 4-byte Folded Reload
