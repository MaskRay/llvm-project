...
; SPILL-O0-NEXT:    sw s0, 24(sp) # 4-byte Folded Spill
; SPILL-O0-NEXT:    .cfi_offset ra, -4
; SPILL-O0-NEXT:    .cfi_offset s0, -8
...
; SPILL-O0-NEXT:    lw s0, 24(sp) # 4-byte Folded Reload
; SPILL-O0-NEXT:    .cfi_restore ra
; SPILL-O0-NEXT:    .cfi_restore s0
; SPILL-O0-NEXT:    addi sp, sp, 32
...
; SPILL-O0-VSETVLI-NEXT:    sw s0, 24(sp) # 4-byte Folded Spill
; SPILL-O0-VSETVLI-NEXT:    .cfi_offset ra, -4
; SPILL-O0-VSETVLI-NEXT:    .cfi_offset s0, -8
...
; SPILL-O0-VSETVLI-NEXT:    lw s0, 24(sp) # 4-byte Folded Reload
; SPILL-O0-VSETVLI-NEXT:    .cfi_restore ra
; SPILL-O0-VSETVLI-NEXT:    .cfi_restore s0
; SPILL-O0-VSETVLI-NEXT:    addi sp, sp, 32
