...
; MIPS64R6O0-NEXT:    addu $4, $3, $2
; MIPS64R6O0-NEXT:    sc $4, 0($1)
; MIPS64R6O0-NEXT:    beqzc $4, .LBB0_1
...
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    ll $3, 0($1)
; MIPS64R6O0-NEXT:    subu $4, $3, $2
; MIPS64R6O0-NEXT:    sc $4, 0($1)
; MIPS64R6O0-NEXT:    beqzc $4, .LBB1_1
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    move $2, $3
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    ll $3, 0($1)
; MIPS64R6O0-NEXT:    xor $4, $3, $2
; MIPS64R6O0-NEXT:    sc $4, 0($1)
; MIPS64R6O0-NEXT:    beqzc $4, .LBB2_1
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    move $2, $3
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    ll $3, 0($1)
; MIPS64R6O0-NEXT:    or $4, $3, $2
; MIPS64R6O0-NEXT:    sc $4, 0($1)
; MIPS64R6O0-NEXT:    beqzc $4, .LBB3_1
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    move $2, $3
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    ll $3, 0($1)
; MIPS64R6O0-NEXT:    and $4, $3, $2
; MIPS64R6O0-NEXT:    sc $4, 0($1)
; MIPS64R6O0-NEXT:    beqzc $4, .LBB4_1
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    move $2, $3
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    ll $3, 0($1)
; MIPS64R6O0-NEXT:    and $4, $3, $2
; MIPS64R6O0-NEXT:    nor $4, $zero, $4
; MIPS64R6O0-NEXT:    sc $4, 0($1)
; MIPS64R6O0-NEXT:    beqzc $4, .LBB5_1
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    move $2, $3
; MIPS64R6O0-NEXT:    jrc $ra
;
...
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    ll $4, 0($1)
; MIPS64R6O0-NEXT:    bnec $4, $2, .LBB7_3
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
...
; MIPS64R6O0-NEXT:    ori $4, $zero, 255
; MIPS64R6O0-NEXT:    sllv $4, $4, $1
; MIPS64R6O0-NEXT:    nor $5, $zero, $4
; MIPS64R6O0-NEXT:    sllv $2, $2, $1
; MIPS64R6O0-NEXT:  .LBB8_1: # %entry
; MIPS64R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6O0-NEXT:    ll $7, 0($3)
; MIPS64R6O0-NEXT:    addu $8, $7, $2
; MIPS64R6O0-NEXT:    and $8, $8, $4
; MIPS64R6O0-NEXT:    and $9, $7, $5
; MIPS64R6O0-NEXT:    or $9, $9, $8
; MIPS64R6O0-NEXT:    sc $9, 0($3)
; MIPS64R6O0-NEXT:    beqzc $9, .LBB8_1
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    and $6, $7, $4
...
; MIPS32R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS32R6O0-NEXT:    ll $8, 0($2)
; MIPS32R6O0-NEXT:    and $9, $8, $3
; MIPS32R6O0-NEXT:    bnec $9, $4, $BB12_3
; MIPS32R6O0-NEXT:  # %bb.2: # %entry
; MIPS32R6O0-NEXT:    # in Loop: Header=BB12_1 Depth=1
; MIPS32R6O0-NEXT:    and $8, $8, $6
; MIPS32R6O0-NEXT:    or $8, $8, $5
; MIPS32R6O0-NEXT:    sc $8, 0($2)
; MIPS32R6O0-NEXT:    beqzc $8, $BB12_1
; MIPS32R6O0-NEXT:  $BB12_3: # %entry
; MIPS32R6O0-NEXT:    srlv $7, $9, $1
...
; MIPS64R6O0-NEXT:    and $9, $8, $5
; MIPS64R6O0-NEXT:    bnec $9, $3, .LBB12_3
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    # in Loop: Header=BB12_1 Depth=1
; MIPS64R6O0-NEXT:    and $8, $8, $6
; MIPS64R6O0-NEXT:    or $8, $8, $2
; MIPS64R6O0-NEXT:    sc $8, 0($4)
...
; MIPS32R6O0-NEXT:    # kill: def $at killed $a2
; MIPS32R6O0-NEXT:    # kill: def $at killed $a1
; MIPS32R6O0-NEXT:    addiu $1, $zero, -4
; MIPS32R6O0-NEXT:    and $1, $4, $1
; MIPS32R6O0-NEXT:    andi $2, $4, 3
; MIPS32R6O0-NEXT:    sll $2, $2, 3
; MIPS32R6O0-NEXT:    ori $3, $zero, 255
; MIPS32R6O0-NEXT:    sllv $3, $3, $2
; MIPS32R6O0-NEXT:    nor $4, $zero, $3
; MIPS32R6O0-NEXT:    andi $7, $5, 255
; MIPS32R6O0-NEXT:    sllv $7, $7, $2
; MIPS32R6O0-NEXT:    andi $6, $6, 255
; MIPS32R6O0-NEXT:    sllv $6, $6, $2
; MIPS32R6O0-NEXT:  $BB13_1: # %entry
; MIPS32R6O0-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS32R6O0-NEXT:    ll $9, 0($1)
; MIPS32R6O0-NEXT:    and $10, $9, $3
; MIPS32R6O0-NEXT:    bnec $10, $7, $BB13_3
; MIPS32R6O0-NEXT:  # %bb.2: # %entry
; MIPS32R6O0-NEXT:    # in Loop: Header=BB13_1 Depth=1
; MIPS32R6O0-NEXT:    and $9, $9, $4
; MIPS32R6O0-NEXT:    or $9, $9, $6
; MIPS32R6O0-NEXT:    sc $9, 0($1)
; MIPS32R6O0-NEXT:    beqzc $9, $BB13_1
; MIPS32R6O0-NEXT:  $BB13_3: # %entry
; MIPS32R6O0-NEXT:    srlv $8, $10, $2
; MIPS32R6O0-NEXT:    seb $8, $8
; MIPS32R6O0-NEXT:  # %bb.4: # %entry
; MIPS32R6O0-NEXT:    sw $8, 0($sp) # 4-byte Folded Spill
; MIPS32R6O0-NEXT:  # %bb.5: # %entry
; MIPS32R6O0-NEXT:    lw $1, 0($sp) # 4-byte Folded Reload
; MIPS32R6O0-NEXT:    lw $5, 4($sp) # 4-byte Folded Reload
; MIPS32R6O0-NEXT:    xor $1, $1, $5
...
; MIPS64R6O0-NEXT:    xori $4, $4, 3
; MIPS64R6O0-NEXT:    sll $4, $4, 3
; MIPS64R6O0-NEXT:    ori $5, $zero, 255
; MIPS64R6O0-NEXT:    sllv $5, $5, $4
; MIPS64R6O0-NEXT:    nor $6, $zero, $5
; MIPS64R6O0-NEXT:    andi $7, $2, 255
...
; MIPS32R6O0-NEXT:    # kill: def $at killed $a3
; MIPS32R6O0-NEXT:    # kill: def $at killed $a2
; MIPS32R6O0-NEXT:    # kill: def $at killed $a1
...
; MIPS32R6O0-NEXT:    addiu $2, $zero, -4
; MIPS32R6O0-NEXT:    and $2, $4, $2
; MIPS32R6O0-NEXT:    andi $3, $4, 3
; MIPS32R6O0-NEXT:    sll $3, $3, 3
; MIPS32R6O0-NEXT:    ori $4, $zero, 65535
; MIPS32R6O0-NEXT:    sllv $4, $4, $3
; MIPS32R6O0-NEXT:    nor $5, $zero, $4
; MIPS32R6O0-NEXT:    andi $6, $1, 65535
; MIPS32R6O0-NEXT:    sllv $6, $6, $3
; MIPS32R6O0-NEXT:    andi $7, $7, 65535
; MIPS32R6O0-NEXT:    sllv $7, $7, $3
; MIPS32R6O0-NEXT:  $BB15_1: # =>This Inner Loop Header: Depth=1
; MIPS32R6O0-NEXT:    ll $9, 0($2)
; MIPS32R6O0-NEXT:    and $10, $9, $4
; MIPS32R6O0-NEXT:    bnec $10, $6, $BB15_3
; MIPS32R6O0-NEXT:  # %bb.2: # in Loop: Header=BB15_1 Depth=1
; MIPS32R6O0-NEXT:    and $9, $9, $5
; MIPS32R6O0-NEXT:    or $9, $9, $7
; MIPS32R6O0-NEXT:    sc $9, 0($2)
; MIPS32R6O0-NEXT:    beqzc $9, $BB15_1
; MIPS32R6O0-NEXT:  $BB15_3:
; MIPS32R6O0-NEXT:    srlv $8, $10, $3
; MIPS32R6O0-NEXT:    seh $8, $8
...
; MIPS64R6O0-NEXT:    addu $4, $3, $2
; MIPS64R6O0-NEXT:    sc $4, 0($1)
; MIPS64R6O0-NEXT:    beqzc $4, .LBB16_1
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    sync
; MIPS64R6O0-NEXT:    move $2, $3
; MIPS64R6O0-NEXT:    jrc $ra
...
; MIPS64R6O0-NEXT:    addu $4, $3, $2
; MIPS64R6O0-NEXT:    sc $4, 0($1)
; MIPS64R6O0-NEXT:    beqzc $4, .LBB18_1
; MIPS64R6O0-NEXT:  # %bb.2: # %entry
; MIPS64R6O0-NEXT:    move $2, $3
; MIPS64R6O0-NEXT:    jrc $ra
;
