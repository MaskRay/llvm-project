...
; MIPS64-NEXT:    slt $5, $2, $1
; MIPS64-NEXT:    move $3, $2
; MIPS64-NEXT:    movn $3, $1, $5
; MIPS64-NEXT:    sc $3, 0($4)
...
; MIPS64R6-NEXT:    slt $5, $2, $1
; MIPS64R6-NEXT:    seleqz $3, $2, $5
; MIPS64R6-NEXT:    selnez $5, $1, $5
; MIPS64R6-NEXT:    or $3, $3, $5
; MIPS64R6-NEXT:    sc $3, 0($4)
...
; MIPS64EL-NEXT:    slt $5, $2, $1
; MIPS64EL-NEXT:    move $3, $2
; MIPS64EL-NEXT:    movn $3, $1, $5
; MIPS64EL-NEXT:    sc $3, 0($4)
; MIPS64EL-NEXT:    beqz $3, .LBB0_1
; MIPS64EL-NEXT:    nop
...
; MIPS64ELR6-NEXT:    slt $5, $2, $1
; MIPS64ELR6-NEXT:    seleqz $3, $2, $5
; MIPS64ELR6-NEXT:    selnez $5, $1, $5
; MIPS64ELR6-NEXT:    or $3, $3, $5
; MIPS64ELR6-NEXT:    sc $3, 0($4)
; MIPS64ELR6-NEXT:    beqzc $3, .LBB0_1
...
; MIPS64EL-NEXT:    slt $5, $2, $1
; MIPS64EL-NEXT:    move $3, $2
; MIPS64EL-NEXT:    movz $3, $1, $5
; MIPS64EL-NEXT:    sc $3, 0($4)
; MIPS64EL-NEXT:    beqz $3, .LBB1_1
; MIPS64EL-NEXT:    nop
; MIPS64EL-NEXT:  # %bb.2: # %entry
; MIPS64EL-NEXT:    sync
; MIPS64EL-NEXT:    jr $ra
...
; MIPS64ELR6-NEXT:    seleqz $5, $1, $5
; MIPS64ELR6-NEXT:    or $3, $3, $5
; MIPS64ELR6-NEXT:    sc $3, 0($4)
; MIPS64ELR6-NEXT:    beqzc $3, .LBB1_1
; MIPS64ELR6-NEXT:  # %bb.2: # %entry
; MIPS64ELR6-NEXT:    sync
; MIPS64ELR6-NEXT:    jrc $ra
entry:
...
; MIPS64EL-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64EL-NEXT:    ll $2, 0($4)
; MIPS64EL-NEXT:    sltu $5, $2, $1
; MIPS64EL-NEXT:    move $3, $2
; MIPS64EL-NEXT:    movn $3, $1, $5
; MIPS64EL-NEXT:    sc $3, 0($4)
; MIPS64EL-NEXT:    beqz $3, .LBB2_1
; MIPS64EL-NEXT:    nop
; MIPS64EL-NEXT:  # %bb.2: # %entry
; MIPS64EL-NEXT:    sync
; MIPS64EL-NEXT:    jr $ra
...
; MIPS64ELR6-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64ELR6-NEXT:    ll $2, 0($4)
; MIPS64ELR6-NEXT:    sltu $5, $2, $1
; MIPS64ELR6-NEXT:    seleqz $3, $2, $5
; MIPS64ELR6-NEXT:    selnez $5, $1, $5
; MIPS64ELR6-NEXT:    or $3, $3, $5
; MIPS64ELR6-NEXT:    sc $3, 0($4)
; MIPS64ELR6-NEXT:    beqzc $3, .LBB2_1
; MIPS64ELR6-NEXT:  # %bb.2: # %entry
; MIPS64ELR6-NEXT:    sync
; MIPS64ELR6-NEXT:    jrc $ra
entry:
...
; MIPS64ELR6-NEXT:    or $3, $3, $5
; MIPS64ELR6-NEXT:    sc $3, 0($4)
; MIPS64ELR6-NEXT:    beqzc $3, .LBB3_1
; MIPS64ELR6-NEXT:  # %bb.2: # %entry
; MIPS64ELR6-NEXT:    sync
; MIPS64ELR6-NEXT:    jrc $ra
entry:
...
; MIPS-NEXT:    sllv $3, $3, $2
; MIPS-NEXT:    nor $4, $zero, $3
; MIPS-NEXT:    sllv $5, $5, $2
; MIPS-NEXT:  $BB4_1: # %entry
; MIPS-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS-NEXT:    ll $7, 0($1)
; MIPS-NEXT:    srav $9, $7, $2
; MIPS-NEXT:    seh $9, $9
; MIPS-NEXT:    or $6, $zero, $9
; MIPS-NEXT:    sllv $9, $9, $2
; MIPS-NEXT:    slt $10, $9, $5
; MIPS-NEXT:    move $8, $9
; MIPS-NEXT:    movn $8, $5, $10
; MIPS-NEXT:    and $8, $8, $3
; MIPS-NEXT:    and $9, $7, $4
; MIPS-NEXT:    or $9, $9, $8
; MIPS-NEXT:    sc $9, 0($1)
; MIPS-NEXT:    beqz $9, $BB4_1
; MIPS-NEXT:    nop
; MIPS-NEXT:  # %bb.2: # %entry
; MIPS-NEXT:    .insn
; MIPS-NEXT:  # %bb.3: # %entry
; MIPS-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MIPSR6-NEXT:    and $1, $4, $1
; MIPSR6-NEXT:    andi $2, $4, 3
; MIPSR6-NEXT:    xori $2, $2, 2
; MIPSR6-NEXT:    sll $2, $2, 3
; MIPSR6-NEXT:    ori $3, $zero, 65535
; MIPSR6-NEXT:    sllv $3, $3, $2
; MIPSR6-NEXT:    nor $4, $zero, $3
; MIPSR6-NEXT:    sllv $5, $5, $2
; MIPSR6-NEXT:  $BB4_1: # %entry
; MIPSR6-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPSR6-NEXT:    ll $7, 0($1)
; MIPSR6-NEXT:    srav $9, $7, $2
; MIPSR6-NEXT:    seh $9, $9
; MIPSR6-NEXT:    or $6, $zero, $9
; MIPSR6-NEXT:    sllv $9, $9, $2
; MIPSR6-NEXT:    slt $10, $9, $5
; MIPSR6-NEXT:    seleqz $8, $9, $10
; MIPSR6-NEXT:    selnez $10, $5, $10
; MIPSR6-NEXT:    or $8, $8, $10
; MIPSR6-NEXT:    and $8, $8, $3
; MIPSR6-NEXT:    and $9, $7, $4
; MIPSR6-NEXT:    or $9, $9, $8
; MIPSR6-NEXT:    sc $9, 0($1)
; MIPSR6-NEXT:    beqzc $9, $BB4_1
; MIPSR6-NEXT:    nop
; MIPSR6-NEXT:  # %bb.2: # %entry
; MIPSR6-NEXT:    .insn
; MIPSR6-NEXT:  # %bb.3: # %entry
; MIPSR6-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MM-NEXT:    or $9, $9, $8
; MM-NEXT:    sc $9, 0($1)
; MM-NEXT:    beqzc $9, $BB4_1
; MM-NEXT:  # %bb.2: # %entry
; MM-NEXT:    .insn
; MM-NEXT:  # %bb.3: # %entry
; MM-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
; MM-NEXT:  # %bb.4: # %entry
; MM-NEXT:    sync
...
; MMR6-NEXT:    and $1, $4, $1
; MMR6-NEXT:    andi $2, $4, 3
; MMR6-NEXT:    xori $2, $2, 2
; MMR6-NEXT:    sll $2, $2, 3
; MMR6-NEXT:    ori $3, $zero, 65535
; MMR6-NEXT:    sllv $3, $3, $2
; MMR6-NEXT:    nor $4, $zero, $3
; MMR6-NEXT:    sllv $5, $5, $2
; MMR6-NEXT:  $BB4_1: # %entry
; MMR6-NEXT:    # =>This Inner Loop Header: Depth=1
; MMR6-NEXT:    ll $7, 0($1)
; MMR6-NEXT:    srav $9, $7, $2
; MMR6-NEXT:    seh $9, $9
; MMR6-NEXT:    or $6, $zero, $9
; MMR6-NEXT:    sllv $9, $9, $2
; MMR6-NEXT:    slt $10, $9, $5
; MMR6-NEXT:    seleqz $8, $9, $10
; MMR6-NEXT:    selnez $10, $5, $10
; MMR6-NEXT:    or $8, $8, $10
; MMR6-NEXT:    and $8, $8, $3
; MMR6-NEXT:    and $9, $7, $4
; MMR6-NEXT:    or $9, $9, $8
; MMR6-NEXT:    sc $9, 0($1)
; MMR6-NEXT:    beqc $9, $zero, $BB4_1
; MMR6-NEXT:  # %bb.2: # %entry
; MMR6-NEXT:    .insn
...
; MIPS2-NEXT:    and $1, $4, $1
; MIPS2-NEXT:    andi $2, $4, 3
; MIPS2-NEXT:    sll $2, $2, 3
; MIPS2-NEXT:    ori $3, $zero, 65535
; MIPS2-NEXT:    sllv $3, $3, $2
; MIPS2-NEXT:    nor $4, $zero, $3
; MIPS2-NEXT:    sllv $5, $5, $2
; MIPS2-NEXT:  $BB4_1: # %entry
; MIPS2-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS2-NEXT:    ll $7, 0($1)
; MIPS2-NEXT:    srav $9, $7, $2
; MIPS2-NEXT:    sll $9, $9, 16
; MIPS2-NEXT:    sra $9, $9, 16
; MIPS2-NEXT:    or $6, $zero, $9
; MIPS2-NEXT:    sllv $9, $9, $2
; MIPS2-NEXT:    slt $10, $9, $5
; MIPS2-NEXT:    move $8, $5
; MIPS2-NEXT:    beqz $10, $BB4_3
; MIPS2-NEXT:    nop
; MIPS2-NEXT:  # %bb.2: # %entry
...
; MIPS2-NEXT:    # in Loop: Header=BB4_1 Depth=1
; MIPS2-NEXT:    and $8, $8, $3
; MIPS2-NEXT:    and $9, $7, $4
; MIPS2-NEXT:    or $9, $9, $8
; MIPS2-NEXT:    sc $9, 0($1)
; MIPS2-NEXT:    beqz $9, $BB4_1
; MIPS2-NEXT:    nop
; MIPS2-NEXT:  # %bb.5: # %entry
; MIPS2-NEXT:    .insn
; MIPS2-NEXT:  # %bb.6: # %entry
; MIPS2-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MIPS32-NEXT:    nor $4, $zero, $3
; MIPS32-NEXT:    sllv $5, $5, $2
; MIPS32-NEXT:  $BB4_1: # %entry
; MIPS32-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS32-NEXT:    ll $7, 0($1)
; MIPS32-NEXT:    srav $9, $7, $2
; MIPS32-NEXT:    sll $9, $9, 16
; MIPS32-NEXT:    sra $9, $9, 16
; MIPS32-NEXT:    or $6, $zero, $9
; MIPS32-NEXT:    sllv $9, $9, $2
; MIPS32-NEXT:    slt $10, $9, $5
; MIPS32-NEXT:    move $8, $9
; MIPS32-NEXT:    movn $8, $5, $10
; MIPS32-NEXT:    and $8, $8, $3
; MIPS32-NEXT:    and $9, $7, $4
; MIPS32-NEXT:    or $9, $9, $8
; MIPS32-NEXT:    sc $9, 0($1)
; MIPS32-NEXT:    beqz $9, $BB4_1
; MIPS32-NEXT:    nop
; MIPS32-NEXT:  # %bb.2: # %entry
; MIPS32-NEXT:    .insn
...
; MIPSEL-NEXT:    andi $2, $4, 3
; MIPSEL-NEXT:    sll $2, $2, 3
; MIPSEL-NEXT:    ori $3, $zero, 65535
; MIPSEL-NEXT:    sllv $3, $3, $2
; MIPSEL-NEXT:    nor $4, $zero, $3
; MIPSEL-NEXT:    sllv $5, $5, $2
; MIPSEL-NEXT:  $BB4_1: # %entry
; MIPSEL-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPSEL-NEXT:    ll $7, 0($1)
; MIPSEL-NEXT:    srav $9, $7, $2
; MIPSEL-NEXT:    seh $9, $9
; MIPSEL-NEXT:    or $6, $zero, $9
; MIPSEL-NEXT:    sllv $9, $9, $2
; MIPSEL-NEXT:    slt $10, $9, $5
; MIPSEL-NEXT:    move $8, $9
; MIPSEL-NEXT:    movn $8, $5, $10
; MIPSEL-NEXT:    and $8, $8, $3
; MIPSEL-NEXT:    and $9, $7, $4
; MIPSEL-NEXT:    or $9, $9, $8
; MIPSEL-NEXT:    sc $9, 0($1)
; MIPSEL-NEXT:    beqz $9, $BB4_1
; MIPSEL-NEXT:    nop
; MIPSEL-NEXT:  # %bb.2: # %entry
; MIPSEL-NEXT:    .insn
; MIPSEL-NEXT:  # %bb.3: # %entry
; MIPSEL-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MIPSELR6-NEXT:    and $1, $4, $1
; MIPSELR6-NEXT:    andi $2, $4, 3
; MIPSELR6-NEXT:    sll $2, $2, 3
; MIPSELR6-NEXT:    ori $3, $zero, 65535
; MIPSELR6-NEXT:    sllv $3, $3, $2
; MIPSELR6-NEXT:    nor $4, $zero, $3
; MIPSELR6-NEXT:    sllv $5, $5, $2
; MIPSELR6-NEXT:  $BB4_1: # %entry
; MIPSELR6-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPSELR6-NEXT:    ll $7, 0($1)
; MIPSELR6-NEXT:    srav $9, $7, $2
; MIPSELR6-NEXT:    seh $9, $9
; MIPSELR6-NEXT:    or $6, $zero, $9
; MIPSELR6-NEXT:    sllv $9, $9, $2
; MIPSELR6-NEXT:    slt $10, $9, $5
; MIPSELR6-NEXT:    seleqz $8, $9, $10
; MIPSELR6-NEXT:    selnez $10, $5, $10
; MIPSELR6-NEXT:    or $8, $8, $10
; MIPSELR6-NEXT:    and $8, $8, $3
; MIPSELR6-NEXT:    and $9, $7, $4
; MIPSELR6-NEXT:    or $9, $9, $8
; MIPSELR6-NEXT:    sc $9, 0($1)
; MIPSELR6-NEXT:    beqzc $9, $BB4_1
; MIPSELR6-NEXT:    nop
; MIPSELR6-NEXT:  # %bb.2: # %entry
; MIPSELR6-NEXT:    .insn
; MIPSELR6-NEXT:  # %bb.3: # %entry
; MIPSELR6-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MMEL-NEXT:    and $1, $4, $1
; MMEL-NEXT:    andi $2, $4, 3
; MMEL-NEXT:    sll $2, $2, 3
; MMEL-NEXT:    ori $3, $zero, 65535
; MMEL-NEXT:    sllv $3, $3, $2
; MMEL-NEXT:    nor $4, $zero, $3
; MMEL-NEXT:    sllv $5, $5, $2
; MMEL-NEXT:  $BB4_1: # %entry
; MMEL-NEXT:    # =>This Inner Loop Header: Depth=1
; MMEL-NEXT:    ll $7, 0($1)
; MMEL-NEXT:    srav $9, $7, $2
; MMEL-NEXT:    seh $9, $9
; MMEL-NEXT:    or $6, $zero, $9
; MMEL-NEXT:    sllv $9, $9, $2
; MMEL-NEXT:    slt $10, $9, $5
; MMEL-NEXT:    or $8, $9, $zero
; MMEL-NEXT:    movn $8, $5, $10
; MMEL-NEXT:    and $8, $8, $3
; MMEL-NEXT:    and $9, $7, $4
; MMEL-NEXT:    or $9, $9, $8
; MMEL-NEXT:    sc $9, 0($1)
; MMEL-NEXT:    beqzc $9, $BB4_1
; MMEL-NEXT:  # %bb.2: # %entry
; MMEL-NEXT:    .insn
; MMEL-NEXT:  # %bb.3: # %entry
; MMEL-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MMELR6-NEXT:    and $1, $4, $1
; MMELR6-NEXT:    andi $2, $4, 3
; MMELR6-NEXT:    sll $2, $2, 3
; MMELR6-NEXT:    ori $3, $zero, 65535
; MMELR6-NEXT:    sllv $3, $3, $2
; MMELR6-NEXT:    nor $4, $zero, $3
; MMELR6-NEXT:    sllv $5, $5, $2
; MMELR6-NEXT:  $BB4_1: # %entry
; MMELR6-NEXT:    # =>This Inner Loop Header: Depth=1
; MMELR6-NEXT:    ll $7, 0($1)
; MMELR6-NEXT:    srav $9, $7, $2
; MMELR6-NEXT:    seh $9, $9
; MMELR6-NEXT:    or $6, $zero, $9
; MMELR6-NEXT:    sllv $9, $9, $2
; MMELR6-NEXT:    slt $10, $9, $5
; MMELR6-NEXT:    seleqz $8, $9, $10
; MMELR6-NEXT:    selnez $10, $5, $10
; MMELR6-NEXT:    or $8, $8, $10
; MMELR6-NEXT:    and $8, $8, $3
; MMELR6-NEXT:    and $9, $7, $4
; MMELR6-NEXT:    or $9, $9, $8
; MMELR6-NEXT:    sc $9, 0($1)
; MMELR6-NEXT:    beqc $9, $zero, $BB4_1
; MMELR6-NEXT:  # %bb.2: # %entry
; MMELR6-NEXT:    .insn
; MMELR6-NEXT:  # %bb.3: # %entry
; MMELR6-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MIPS64-NEXT:    and $2, $4, $2
; MIPS64-NEXT:    andi $3, $4, 3
; MIPS64-NEXT:    xori $3, $3, 2
; MIPS64-NEXT:    sll $3, $3, 3
; MIPS64-NEXT:    ori $4, $zero, 65535
; MIPS64-NEXT:    sllv $4, $4, $3
; MIPS64-NEXT:    nor $5, $zero, $4
; MIPS64-NEXT:    sllv $1, $1, $3
; MIPS64-NEXT:  .LBB4_1: # %entry
; MIPS64-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64-NEXT:    ll $7, 0($2)
; MIPS64-NEXT:    srav $9, $7, $3
; MIPS64-NEXT:    seh $9, $9
; MIPS64-NEXT:    or $6, $zero, $9
; MIPS64-NEXT:    sllv $9, $9, $3
; MIPS64-NEXT:    slt $10, $9, $1
; MIPS64-NEXT:    move $8, $9
; MIPS64-NEXT:    movn $8, $1, $10
; MIPS64-NEXT:    and $8, $8, $4
; MIPS64-NEXT:    and $9, $7, $5
...
; MIPS64R6-NEXT:    and $2, $4, $2
; MIPS64R6-NEXT:    andi $3, $4, 3
; MIPS64R6-NEXT:    xori $3, $3, 2
; MIPS64R6-NEXT:    sll $3, $3, 3
; MIPS64R6-NEXT:    ori $4, $zero, 65535
; MIPS64R6-NEXT:    sllv $4, $4, $3
; MIPS64R6-NEXT:    nor $5, $zero, $4
; MIPS64R6-NEXT:    sllv $1, $1, $3
; MIPS64R6-NEXT:  .LBB4_1: # %entry
; MIPS64R6-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64R6-NEXT:    ll $7, 0($2)
; MIPS64R6-NEXT:    srav $9, $7, $3
; MIPS64R6-NEXT:    seh $9, $9
; MIPS64R6-NEXT:    or $6, $zero, $9
; MIPS64R6-NEXT:    sllv $9, $9, $3
; MIPS64R6-NEXT:    slt $10, $9, $1
; MIPS64R6-NEXT:    seleqz $8, $9, $10
; MIPS64R6-NEXT:    selnez $10, $1, $10
; MIPS64R6-NEXT:    or $8, $8, $10
; MIPS64R6-NEXT:    and $8, $8, $4
; MIPS64R6-NEXT:    and $9, $7, $5
...
; MIPS64EL-NEXT:    and $2, $4, $2
; MIPS64EL-NEXT:    andi $3, $4, 3
; MIPS64EL-NEXT:    sll $3, $3, 3
; MIPS64EL-NEXT:    ori $4, $zero, 65535
; MIPS64EL-NEXT:    sllv $4, $4, $3
; MIPS64EL-NEXT:    nor $5, $zero, $4
; MIPS64EL-NEXT:    sllv $1, $1, $3
; MIPS64EL-NEXT:  .LBB4_1: # %entry
; MIPS64EL-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64EL-NEXT:    ll $7, 0($2)
; MIPS64EL-NEXT:    srav $9, $7, $3
; MIPS64EL-NEXT:    seh $9, $9
; MIPS64EL-NEXT:    or $6, $zero, $9
; MIPS64EL-NEXT:    sllv $9, $9, $3
; MIPS64EL-NEXT:    slt $10, $9, $1
; MIPS64EL-NEXT:    move $8, $9
; MIPS64EL-NEXT:    movn $8, $1, $10
; MIPS64EL-NEXT:    and $8, $8, $4
; MIPS64EL-NEXT:    and $9, $7, $5
; MIPS64EL-NEXT:    or $9, $9, $8
; MIPS64EL-NEXT:    sc $9, 0($2)
...
; MIPS64ELR6-NEXT:    and $2, $4, $2
; MIPS64ELR6-NEXT:    andi $3, $4, 3
; MIPS64ELR6-NEXT:    sll $3, $3, 3
; MIPS64ELR6-NEXT:    ori $4, $zero, 65535
; MIPS64ELR6-NEXT:    sllv $4, $4, $3
; MIPS64ELR6-NEXT:    nor $5, $zero, $4
; MIPS64ELR6-NEXT:    sllv $1, $1, $3
; MIPS64ELR6-NEXT:  .LBB4_1: # %entry
; MIPS64ELR6-NEXT:    # =>This Inner Loop Header: Depth=1
; MIPS64ELR6-NEXT:    ll $7, 0($2)
; MIPS64ELR6-NEXT:    srav $9, $7, $3
; MIPS64ELR6-NEXT:    seh $9, $9
; MIPS64ELR6-NEXT:    or $6, $zero, $9
; MIPS64ELR6-NEXT:    sllv $9, $9, $3
; MIPS64ELR6-NEXT:    slt $10, $9, $1
; MIPS64ELR6-NEXT:    seleqz $8, $9, $10
; MIPS64ELR6-NEXT:    selnez $10, $1, $10
; MIPS64ELR6-NEXT:    or $8, $8, $10
; MIPS64ELR6-NEXT:    and $8, $8, $4
; MIPS64ELR6-NEXT:    and $9, $7, $5
; MIPS64ELR6-NEXT:    or $9, $9, $8
; MIPS64ELR6-NEXT:    sc $9, 0($2)
...
; MIPS-NEXT:    slt $10, $9, $5
; MIPS-NEXT:    move $8, $9
; MIPS-NEXT:    movz $8, $5, $10
; MIPS-NEXT:    and $8, $8, $3
; MIPS-NEXT:    and $9, $7, $4
; MIPS-NEXT:    or $9, $9, $8
; MIPS-NEXT:    sc $9, 0($1)
; MIPS-NEXT:    beqz $9, $BB5_1
; MIPS-NEXT:    nop
; MIPS-NEXT:  # %bb.2: # %entry
; MIPS-NEXT:    .insn
; MIPS-NEXT:  # %bb.3: # %entry
...
; MIPSR6-NEXT:    sllv $9, $9, $2
; MIPSR6-NEXT:    slt $10, $9, $5
; MIPSR6-NEXT:    selnez $8, $9, $10
; MIPSR6-NEXT:    seleqz $10, $5, $10
; MIPSR6-NEXT:    or $8, $8, $10
; MIPSR6-NEXT:    and $8, $8, $3
; MIPSR6-NEXT:    and $9, $7, $4
; MIPSR6-NEXT:    or $9, $9, $8
; MIPSR6-NEXT:    sc $9, 0($1)
; MIPSR6-NEXT:    beqzc $9, $BB5_1
; MIPSR6-NEXT:    nop
; MIPSR6-NEXT:  # %bb.2: # %entry
; MIPSR6-NEXT:    .insn
; MIPSR6-NEXT:  # %bb.3: # %entry
...
; MMR6-NEXT:    sllv $9, $9, $2
; MMR6-NEXT:    slt $10, $9, $5
; MMR6-NEXT:    selnez $8, $9, $10
; MMR6-NEXT:    seleqz $10, $5, $10
; MMR6-NEXT:    or $8, $8, $10
; MMR6-NEXT:    and $8, $8, $3
; MMR6-NEXT:    and $9, $7, $4
; MMR6-NEXT:    or $9, $9, $8
; MMR6-NEXT:    sc $9, 0($1)
; MMR6-NEXT:    beqc $9, $zero, $BB5_1
; MMR6-NEXT:  # %bb.2: # %entry
; MMR6-NEXT:    .insn
; MMR6-NEXT:  # %bb.3: # %entry
; MMR6-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MIPS32-NEXT:    slt $10, $9, $5
; MIPS32-NEXT:    move $8, $9
; MIPS32-NEXT:    movz $8, $5, $10
; MIPS32-NEXT:    and $8, $8, $3
; MIPS32-NEXT:    and $9, $7, $4
; MIPS32-NEXT:    or $9, $9, $8
; MIPS32-NEXT:    sc $9, 0($1)
; MIPS32-NEXT:    beqz $9, $BB5_1
; MIPS32-NEXT:    nop
; MIPS32-NEXT:  # %bb.2: # %entry
; MIPS32-NEXT:    .insn
; MIPS32-NEXT:  # %bb.3: # %entry
...
; MIPSEL-NEXT:    slt $10, $9, $5
; MIPSEL-NEXT:    move $8, $9
; MIPSEL-NEXT:    movz $8, $5, $10
; MIPSEL-NEXT:    and $8, $8, $3
; MIPSEL-NEXT:    and $9, $7, $4
; MIPSEL-NEXT:    or $9, $9, $8
; MIPSEL-NEXT:    sc $9, 0($1)
; MIPSEL-NEXT:    beqz $9, $BB5_1
; MIPSEL-NEXT:    nop
; MIPSEL-NEXT:  # %bb.2: # %entry
; MIPSEL-NEXT:    .insn
; MIPSEL-NEXT:  # %bb.3: # %entry
...
; MIPSELR6-NEXT:    sllv $9, $9, $2
; MIPSELR6-NEXT:    slt $10, $9, $5
; MIPSELR6-NEXT:    selnez $8, $9, $10
; MIPSELR6-NEXT:    seleqz $10, $5, $10
; MIPSELR6-NEXT:    or $8, $8, $10
; MIPSELR6-NEXT:    and $8, $8, $3
; MIPSELR6-NEXT:    and $9, $7, $4
; MIPSELR6-NEXT:    or $9, $9, $8
; MIPSELR6-NEXT:    sc $9, 0($1)
; MIPSELR6-NEXT:    beqzc $9, $BB5_1
; MIPSELR6-NEXT:    nop
; MIPSELR6-NEXT:  # %bb.2: # %entry
; MIPSELR6-NEXT:    .insn
; MIPSELR6-NEXT:  # %bb.3: # %entry
...
; MMEL-NEXT:    slt $10, $9, $5
; MMEL-NEXT:    or $8, $9, $zero
; MMEL-NEXT:    movz $8, $5, $10
; MMEL-NEXT:    and $8, $8, $3
; MMEL-NEXT:    and $9, $7, $4
; MMEL-NEXT:    or $9, $9, $8
; MMEL-NEXT:    sc $9, 0($1)
; MMEL-NEXT:    beqzc $9, $BB5_1
; MMEL-NEXT:  # %bb.2: # %entry
; MMEL-NEXT:    .insn
; MMEL-NEXT:  # %bb.3: # %entry
; MMEL-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MMELR6-NEXT:    sllv $9, $9, $2
; MMELR6-NEXT:    slt $10, $9, $5
; MMELR6-NEXT:    selnez $8, $9, $10
; MMELR6-NEXT:    seleqz $10, $5, $10
; MMELR6-NEXT:    or $8, $8, $10
; MMELR6-NEXT:    and $8, $8, $3
; MMELR6-NEXT:    and $9, $7, $4
; MMELR6-NEXT:    or $9, $9, $8
; MMELR6-NEXT:    sc $9, 0($1)
; MMELR6-NEXT:    beqc $9, $zero, $BB5_1
; MMELR6-NEXT:  # %bb.2: # %entry
; MMELR6-NEXT:    .insn
; MMELR6-NEXT:  # %bb.3: # %entry
; MMELR6-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MIPS64R6-NEXT:    sllv $9, $9, $3
; MIPS64R6-NEXT:    slt $10, $9, $1
; MIPS64R6-NEXT:    selnez $8, $9, $10
; MIPS64R6-NEXT:    seleqz $10, $1, $10
; MIPS64R6-NEXT:    or $8, $8, $10
; MIPS64R6-NEXT:    and $8, $8, $4
; MIPS64R6-NEXT:    and $9, $7, $5
; MIPS64R6-NEXT:    or $9, $9, $8
...
; MIPS64ELR6-NEXT:    sllv $9, $9, $3
; MIPS64ELR6-NEXT:    slt $10, $9, $1
; MIPS64ELR6-NEXT:    selnez $8, $9, $10
; MIPS64ELR6-NEXT:    seleqz $10, $1, $10
; MIPS64ELR6-NEXT:    or $8, $8, $10
; MIPS64ELR6-NEXT:    and $8, $8, $4
; MIPS64ELR6-NEXT:    and $9, $7, $5
; MIPS64ELR6-NEXT:    or $9, $9, $8
...
; MIPS-NEXT:    ll $7, 0($1)
; MIPS-NEXT:    srav $9, $7, $2
; MIPS-NEXT:    andi $9, $9, 65535
; MIPS-NEXT:    or $6, $zero, $9
; MIPS-NEXT:    sllv $9, $9, $2
; MIPS-NEXT:    sltu $10, $9, $5
; MIPS-NEXT:    move $8, $9
; MIPS-NEXT:    movn $8, $5, $10
; MIPS-NEXT:    and $8, $8, $3
; MIPS-NEXT:    and $9, $7, $4
...
; MIPSR6-NEXT:    ll $7, 0($1)
; MIPSR6-NEXT:    srav $9, $7, $2
; MIPSR6-NEXT:    andi $9, $9, 65535
; MIPSR6-NEXT:    or $6, $zero, $9
; MIPSR6-NEXT:    sllv $9, $9, $2
; MIPSR6-NEXT:    sltu $10, $9, $5
; MIPSR6-NEXT:    seleqz $8, $9, $10
; MIPSR6-NEXT:    selnez $10, $5, $10
; MIPSR6-NEXT:    or $8, $8, $10
; MIPSR6-NEXT:    and $8, $8, $3
...
; MMR6-NEXT:    ll $7, 0($1)
; MMR6-NEXT:    srav $9, $7, $2
; MMR6-NEXT:    andi $9, $9, 65535
; MMR6-NEXT:    or $6, $zero, $9
; MMR6-NEXT:    sllv $9, $9, $2
; MMR6-NEXT:    sltu $10, $9, $5
; MMR6-NEXT:    seleqz $8, $9, $10
; MMR6-NEXT:    selnez $10, $5, $10
; MMR6-NEXT:    or $8, $8, $10
; MMR6-NEXT:    and $8, $8, $3
...
; MIPS2-NEXT:    ll $7, 0($1)
; MIPS2-NEXT:    srav $9, $7, $2
; MIPS2-NEXT:    andi $9, $9, 65535
; MIPS2-NEXT:    or $6, $zero, $9
; MIPS2-NEXT:    sllv $9, $9, $2
; MIPS2-NEXT:    sltu $10, $9, $5
; MIPS2-NEXT:    move $8, $5
; MIPS2-NEXT:    beqz $10, $BB6_3
; MIPS2-NEXT:    nop
; MIPS2-NEXT:  # %bb.2: # %entry
...
; MIPSEL-NEXT:    ll $7, 0($1)
; MIPSEL-NEXT:    srav $9, $7, $2
; MIPSEL-NEXT:    andi $9, $9, 65535
; MIPSEL-NEXT:    or $6, $zero, $9
; MIPSEL-NEXT:    sllv $9, $9, $2
; MIPSEL-NEXT:    sltu $10, $9, $5
; MIPSEL-NEXT:    move $8, $9
; MIPSEL-NEXT:    movn $8, $5, $10
; MIPSEL-NEXT:    and $8, $8, $3
; MIPSEL-NEXT:    and $9, $7, $4
...
; MIPSELR6-NEXT:    ll $7, 0($1)
; MIPSELR6-NEXT:    srav $9, $7, $2
; MIPSELR6-NEXT:    andi $9, $9, 65535
; MIPSELR6-NEXT:    or $6, $zero, $9
; MIPSELR6-NEXT:    sllv $9, $9, $2
; MIPSELR6-NEXT:    sltu $10, $9, $5
; MIPSELR6-NEXT:    seleqz $8, $9, $10
; MIPSELR6-NEXT:    selnez $10, $5, $10
; MIPSELR6-NEXT:    or $8, $8, $10
; MIPSELR6-NEXT:    and $8, $8, $3
...
; MMEL-NEXT:    ll $7, 0($1)
; MMEL-NEXT:    srav $9, $7, $2
; MMEL-NEXT:    andi $9, $9, 65535
; MMEL-NEXT:    or $6, $zero, $9
; MMEL-NEXT:    sllv $9, $9, $2
; MMEL-NEXT:    sltu $10, $9, $5
; MMEL-NEXT:    or $8, $9, $zero
; MMEL-NEXT:    movn $8, $5, $10
; MMEL-NEXT:    and $8, $8, $3
; MMEL-NEXT:    and $9, $7, $4
...
; MMELR6-NEXT:    ll $7, 0($1)
; MMELR6-NEXT:    srav $9, $7, $2
; MMELR6-NEXT:    andi $9, $9, 65535
; MMELR6-NEXT:    or $6, $zero, $9
; MMELR6-NEXT:    sllv $9, $9, $2
; MMELR6-NEXT:    sltu $10, $9, $5
; MMELR6-NEXT:    seleqz $8, $9, $10
; MMELR6-NEXT:    selnez $10, $5, $10
; MMELR6-NEXT:    or $8, $8, $10
; MMELR6-NEXT:    and $8, $8, $3
...
; MIPS64-NEXT:    ll $7, 0($2)
; MIPS64-NEXT:    srav $9, $7, $3
; MIPS64-NEXT:    andi $9, $9, 65535
; MIPS64-NEXT:    or $6, $zero, $9
; MIPS64-NEXT:    sllv $9, $9, $3
; MIPS64-NEXT:    sltu $10, $9, $1
; MIPS64-NEXT:    move $8, $9
; MIPS64-NEXT:    movn $8, $1, $10
; MIPS64-NEXT:    and $8, $8, $4
; MIPS64-NEXT:    and $9, $7, $5
...
; MIPS64R6-NEXT:    ll $7, 0($2)
; MIPS64R6-NEXT:    srav $9, $7, $3
; MIPS64R6-NEXT:    andi $9, $9, 65535
; MIPS64R6-NEXT:    or $6, $zero, $9
; MIPS64R6-NEXT:    sllv $9, $9, $3
; MIPS64R6-NEXT:    sltu $10, $9, $1
; MIPS64R6-NEXT:    seleqz $8, $9, $10
; MIPS64R6-NEXT:    selnez $10, $1, $10
; MIPS64R6-NEXT:    or $8, $8, $10
; MIPS64R6-NEXT:    and $8, $8, $4
...
; MIPS64EL-NEXT:    ll $7, 0($2)
; MIPS64EL-NEXT:    srav $9, $7, $3
; MIPS64EL-NEXT:    andi $9, $9, 65535
; MIPS64EL-NEXT:    or $6, $zero, $9
; MIPS64EL-NEXT:    sllv $9, $9, $3
; MIPS64EL-NEXT:    sltu $10, $9, $1
; MIPS64EL-NEXT:    move $8, $9
; MIPS64EL-NEXT:    movn $8, $1, $10
; MIPS64EL-NEXT:    and $8, $8, $4
; MIPS64EL-NEXT:    and $9, $7, $5
...
; MIPS64ELR6-NEXT:    ll $7, 0($2)
; MIPS64ELR6-NEXT:    srav $9, $7, $3
; MIPS64ELR6-NEXT:    andi $9, $9, 65535
; MIPS64ELR6-NEXT:    or $6, $zero, $9
; MIPS64ELR6-NEXT:    sllv $9, $9, $3
; MIPS64ELR6-NEXT:    sltu $10, $9, $1
; MIPS64ELR6-NEXT:    seleqz $8, $9, $10
; MIPS64ELR6-NEXT:    selnez $10, $1, $10
; MIPS64ELR6-NEXT:    or $8, $8, $10
; MIPS64ELR6-NEXT:    and $8, $8, $4
...
; MIPS-NEXT:    and $1, $4, $1
; MIPS-NEXT:    andi $2, $4, 3
; MIPS-NEXT:    xori $2, $2, 3
; MIPS-NEXT:    sll $2, $2, 3
; MIPS-NEXT:    ori $3, $zero, 255
; MIPS-NEXT:    sllv $3, $3, $2
; MIPS-NEXT:    nor $4, $zero, $3
; MIPS-NEXT:    sllv $5, $5, $2
...
; MIPSR6-NEXT:    and $1, $4, $1
; MIPSR6-NEXT:    andi $2, $4, 3
; MIPSR6-NEXT:    xori $2, $2, 3
; MIPSR6-NEXT:    sll $2, $2, 3
; MIPSR6-NEXT:    ori $3, $zero, 255
; MIPSR6-NEXT:    sllv $3, $3, $2
; MIPSR6-NEXT:    nor $4, $zero, $3
; MIPSR6-NEXT:    sllv $5, $5, $2
...
; MMR6-NEXT:    and $1, $4, $1
; MMR6-NEXT:    andi $2, $4, 3
; MMR6-NEXT:    xori $2, $2, 3
; MMR6-NEXT:    sll $2, $2, 3
; MMR6-NEXT:    ori $3, $zero, 255
; MMR6-NEXT:    sllv $3, $3, $2
; MMR6-NEXT:    nor $4, $zero, $3
; MMR6-NEXT:    sllv $5, $5, $2
...
; MIPS2-NEXT:    ll $7, 0($1)
; MIPS2-NEXT:    srav $9, $7, $2
; MIPS2-NEXT:    sll $9, $9, 24
; MIPS2-NEXT:    sra $9, $9, 24
; MIPS2-NEXT:    or $6, $zero, $9
; MIPS2-NEXT:    sllv $9, $9, $2
; MIPS2-NEXT:    slt $10, $9, $5
; MIPS2-NEXT:    move $8, $5
; MIPS2-NEXT:    beqz $10, $BB8_3
; MIPS2-NEXT:    nop
; MIPS2-NEXT:  # %bb.2: # %entry
...
; MIPS64-NEXT:    and $2, $4, $2
; MIPS64-NEXT:    andi $3, $4, 3
; MIPS64-NEXT:    xori $3, $3, 3
; MIPS64-NEXT:    sll $3, $3, 3
; MIPS64-NEXT:    ori $4, $zero, 255
; MIPS64-NEXT:    sllv $4, $4, $3
; MIPS64-NEXT:    nor $5, $zero, $4
; MIPS64-NEXT:    sllv $1, $1, $3
...
; MIPS64R6-NEXT:    and $2, $4, $2
; MIPS64R6-NEXT:    andi $3, $4, 3
; MIPS64R6-NEXT:    xori $3, $3, 3
; MIPS64R6-NEXT:    sll $3, $3, 3
; MIPS64R6-NEXT:    ori $4, $zero, 255
; MIPS64R6-NEXT:    sllv $4, $4, $3
; MIPS64R6-NEXT:    nor $5, $zero, $4
; MIPS64R6-NEXT:    sllv $1, $1, $3
...
; MIPS64ELR6-NEXT:    andi $3, $4, 3
; MIPS64ELR6-NEXT:    sll $3, $3, 3
; MIPS64ELR6-NEXT:    ori $4, $zero, 255
; MIPS64ELR6-NEXT:    sllv $4, $4, $3
; MIPS64ELR6-NEXT:    nor $5, $zero, $4
; MIPS64ELR6-NEXT:    sllv $1, $1, $3
...
; MIPS2-NEXT:    ll $7, 0($1)
; MIPS2-NEXT:    srav $9, $7, $2
; MIPS2-NEXT:    andi $9, $9, 255
; MIPS2-NEXT:    or $6, $zero, $9
; MIPS2-NEXT:    sllv $9, $9, $2
; MIPS2-NEXT:    sltu $10, $9, $5
; MIPS2-NEXT:    move $8, $5
; MIPS2-NEXT:    beqz $10, $BB10_3
; MIPS2-NEXT:    nop
; MIPS2-NEXT:  # %bb.2: # %entry
...
; MMELR6-NEXT:    or $9, $9, $8
; MMELR6-NEXT:    sc $9, 0($1)
; MMELR6-NEXT:    beqc $9, $zero, $BB10_1
; MMELR6-NEXT:  # %bb.2: # %entry
; MMELR6-NEXT:    .insn
; MMELR6-NEXT:  # %bb.3: # %entry
; MMELR6-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
...
; MMELR6-NEXT:    or $9, $9, $8
; MMELR6-NEXT:    sc $9, 0($1)
; MMELR6-NEXT:    beqc $9, $zero, $BB11_1
; MMELR6-NEXT:  # %bb.2: # %entry
; MMELR6-NEXT:    .insn
; MMELR6-NEXT:  # %bb.3: # %entry
; MMELR6-NEXT:    sw $6, 4($sp) # 4-byte Folded Spill
