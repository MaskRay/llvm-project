...
; MIPS32-NEXT:    lw $2, 24($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    sltu $3, $2, $1
; MIPS32-NEXT:    bnez $3, $BB0_13
; MIPS32-NEXT:    nop
...
; MIPS32_PIC-NEXT:    lw $4, 32($sp) # 4-byte Folded Reload
; MIPS32_PIC-NEXT:    subu $1, $4, $1
; MIPS32_PIC-NEXT:    sw $1, 4($sp) # 4-byte Folded Spill
; MIPS32_PIC-NEXT:    lw $2, 28($sp) # 4-byte Folded Reload
; MIPS32_PIC-NEXT:    sltu $3, $2, $1
; MIPS32_PIC-NEXT:    bnez $3, $BB0_13
; MIPS32_PIC-NEXT:    nop
