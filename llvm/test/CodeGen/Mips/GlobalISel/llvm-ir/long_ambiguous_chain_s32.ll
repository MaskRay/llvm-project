...
; MIPS32-NEXT:    sw $5, 40($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $6, 36($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $7, 32($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    addiu $1, $sp, 64
; MIPS32-NEXT:    lw $1, 0($1)
; MIPS32-NEXT:    sw $1, 28($sp) # 4-byte Folded Spill
...
; MIPS32-NEXT:    lw $5, 40($sp) # 4-byte Folded Reload
...
; MIPS32-NEXT:    lw $7, 32($sp) # 4-byte Folded Reload
...
; MIPS32-NEXT:    sw $6, 44($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $7, 40($sp) # 4-byte Folded Spill
...
; MIPS32-NEXT:    lw $5, 48($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $1, $5, 1
...
; MIPS32-NEXT:    lw $6, 44($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $1, $6, 1
...
; MIPS32-NEXT:    lw $7, 40($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    lw $1, 0($7)
...
; MIPS32-NEXT:    lw $4, 24($sp) # 4-byte Folded Reload
...
; MIPS32-NEXT:    lw $4, 52($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $1, $4, 1
