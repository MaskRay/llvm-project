...
; MIPS32-NEXT:    sw $6, 20($sp) # 4-byte Folded Spill
...
; MIPS32-NEXT:    move $2, $6
; MIPS32-NEXT:    sw $2, 4($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    lw $7, 16($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    move $3, $7
; MIPS32-NEXT:    sw $3, 0($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    j $BB4_4
; MIPS32-NEXT:    nop
...
; MIPS32-NEXT:    lw $3, 0($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    lw $2, 4($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    addiu $sp, $sp, 24
; MIPS32-NEXT:    jr $ra
; MIPS32-NEXT:    nop
...
; MIPS32-NEXT:    lw $7, 28($sp) # 4-byte Folded Reload
...
; MIPS32-NEXT:    lw $7, 12($sp) # 4-byte Folded Reload
...
; MIPS32-NEXT:    ldc1 $f12, 16($sp) # 8-byte Folded Reload
; MIPS32-NEXT:    mov.d $f0, $f12
; MIPS32-NEXT:    sdc1 $f0, 0($sp) # 8-byte Folded Spill
; MIPS32-NEXT:    j $BB8_4
; MIPS32-NEXT:    nop
; MIPS32-NEXT:  $BB8_3: # %cond.false
; MIPS32-NEXT:    ldc1 $f14, 8($sp) # 8-byte Folded Reload
