...
; MIPS32-NEXT:    sw $4, 68($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $5, 64($sp) # 4-byte Folded Spill
...
; MIPS32-NEXT:    lw $6, 60($sp) # 4-byte Folded Reload
...
; MIPS32-NEXT:    sw $4, 76($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $5, 72($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $6, 68($sp) # 4-byte Folded Spill
...
; MIPS32-NEXT:    lw $5, 72($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $1, $5, 1
...
; MIPS32-NEXT:    lw $7, 64($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    lw $1, 0($7)
; MIPS32-NEXT:    lw $2, 4($7)
...
; MIPS32-NEXT:    move $8, $7
; MIPS32-NEXT:    sw $8, 20($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $7, 16($sp) # 4-byte Folded Spill
...
; MIPS32-NEXT:    lw $4, 76($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $1, $4, 1
...
; MIPS32-NEXT:    lw $6, 68($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $5, $6, 1
; MIPS32-NEXT:    movn $2, $4, $5
; MIPS32-NEXT:    movn $1, $3, $5
; MIPS32-NEXT:    lw $5, 72($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $5, $5, 1
; MIPS32-NEXT:    move $6, $4
; MIPS32-NEXT:    movn $6, $2, $5
...
; MIPS32-NEXT:    sw $4, 84($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $5, 80($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $6, 76($sp) # 4-byte Folded Spill
; MIPS32-NEXT:    sw $7, 72($sp) # 4-byte Folded Spill
...
; MIPS32-NEXT:    lw $5, 80($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $1, $5, 1
...
; MIPS32-NEXT:    lw $6, 76($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $1, $6, 1
...
; MIPS32-NEXT:    lw $7, 72($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    ldc1 $f0, 0($7)
...
; MIPS32-NEXT:    lw $4, 84($sp) # 4-byte Folded Reload
; MIPS32-NEXT:    andi $1, $4, 1
