...
; ARMOPTNONE:       @ %bb.0:
; ARMOPTNONE-NEXT:    ldrexd r0, r1, [r0]
; ARMOPTNONE-NEXT:    mov r2, r0
; ARMOPTNONE-NEXT:    @ kill: def $r1 killed $r1 killed $r0_r1
...
; ARMOPTNONE-NEXT:    str r2, [sp, #16] @ 4-byte Spill
; ARMOPTNONE-NEXT:    str r1, [sp, #12] @ 4-byte Spill
; ARMOPTNONE-NEXT:    dmb ish
; ARMOPTNONE-NEXT:    ldrexd r4, r5, [r0]
; ARMOPTNONE-NEXT:    mov r3, r5
; ARMOPTNONE-NEXT:    mov r9, r4
; ARMOPTNONE-NEXT:    clrex
; ARMOPTNONE-NEXT:    str r9, [sp, #8] @ 4-byte Spill
; ARMOPTNONE-NEXT:    str r3, [sp, #4] @ 4-byte Spill
...
; ARMOPTNONE-NEXT:    ldr r2, [sp, #8] @ 4-byte Reload
; ARMOPTNONE-NEXT:    mov r3, r2
; ARMOPTNONE-NEXT:    @ implicit-def: $r9
; ARMOPTNONE-NEXT:    @ implicit-def: $r12
; ARMOPTNONE-NEXT:    ldr r12, [sp, #20] @ 4-byte Reload
; ARMOPTNONE-NEXT:    mov r4, r12
; ARMOPTNONE-NEXT:    mov r5, r9
; ARMOPTNONE-NEXT:    ldr r9, [sp, #12] @ 4-byte Reload
; ARMOPTNONE-NEXT:    mov r8, r9
; ARMOPTNONE-NEXT:    ldr r12, [sp, #16] @ 4-byte Reload
; ARMOPTNONE-NEXT:    mov r9, r12
; ARMOPTNONE-NEXT:    mov r10, r3
; ARMOPTNONE-NEXT:    mov r11, r1
...
; ARMOPTNONE-NEXT:    ldrexd r0, r1, [r4]
; ARMOPTNONE-NEXT:    cmp r0, r10
; ARMOPTNONE-NEXT:    cmpeq r1, r11
; ARMOPTNONE-NEXT:    bne LBB5_4
; ARMOPTNONE-NEXT:  @ %bb.3: @ %atomicrmw.start
; ARMOPTNONE-NEXT:    @ in Loop: Header=BB5_2 Depth=2
; ARMOPTNONE-NEXT:    strexd r5, r8, r9, [r4]
; ARMOPTNONE-NEXT:    cmp r5, #0
...
; ARMOPTNONE-NEXT:    ldr r12, [sp] @ 4-byte Reload
; ARMOPTNONE-NEXT:    eor r12, r9, r12
; ARMOPTNONE-NEXT:    @ kill: def $r0 killed $r0 killed $r0_r1
; ARMOPTNONE-NEXT:    eor r1, r0, r3
; ARMOPTNONE-NEXT:    orr r1, r1, r12
; ARMOPTNONE-NEXT:    cmp r1, #0
; ARMOPTNONE-NEXT:    mov r2, r0
; ARMOPTNONE-NEXT:    str r2, [sp, #8] @ 4-byte Spill
; ARMOPTNONE-NEXT:    str r9, [sp, #4] @ 4-byte Spill
...
; ARMOPTNONE:       @ %bb.0:
; ARMOPTNONE-NEXT:    ldrexd r0, r1, [r0]
; ARMOPTNONE-NEXT:    mov r2, r1
; ARMOPTNONE-NEXT:    @ kill: def $r0 killed $r0 killed $r0_r1
; ARMOPTNONE-NEXT:    clrex
; ARMOPTNONE-NEXT:    dmb ish
; ARMOPTNONE-NEXT:    vmov d16, r0, r2
...
; ARMOPTNONE:       @ %bb.0:
; ARMOPTNONE-NEXT:    vmov s0, r1
; ARMOPTNONE-NEXT:    vmov r1, s0
; ARMOPTNONE-NEXT:    dmb ish
...
; ARMOPTNONE-NEXT:    str r2, [sp, #12] @ 4-byte Spill
...
; ARMOPTNONE-NEXT:    mov r4, r12
; ARMOPTNONE-NEXT:    mov r5, r9
; ARMOPTNONE-NEXT:    ldr r9, [sp, #16] @ 4-byte Reload
; ARMOPTNONE-NEXT:    mov r8, r9
; ARMOPTNONE-NEXT:    ldr r12, [sp, #12] @ 4-byte Reload
; ARMOPTNONE-NEXT:    mov r9, r12
; ARMOPTNONE-NEXT:    mov r10, r3
; ARMOPTNONE-NEXT:    mov r11, r1
; ARMOPTNONE-NEXT:    str r1, [sp] @ 4-byte Spill
