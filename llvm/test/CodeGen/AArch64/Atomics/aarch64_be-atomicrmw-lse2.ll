...
; -O0:    ldaxrb w11, [x0]
; -O0:    cmp w11, w9, uxtb
; -O0:    stlxrb w12, w10, [x0]
; -O0:    subs w9, w11, w9, uxtb
;
...
; -O0:    ldaxrh w11, [x0]
; -O0:    cmp w11, w9, uxth
; -O0:    stlxrh w12, w10, [x0]
; -O0:    subs w9, w11, w9, uxth
;
...
; -O0:    cmp x1, x9
; -O0:    cmp x14, x11
; -O0:    stxp w15, x13, x12, [x0]
; -O0:    stxp w15, x14, x1, [x0]
; -O0:    subs x11, x14, x11
; -O0:    ccmp x1, x9, #0, eq
;
...
; -O0:    cmp x1, x9
; -O0:    cmp x14, x11
; -O0:    stlxp w15, x13, x12, [x0]
; -O0:    stlxp w15, x14, x1, [x0]
; -O0:    subs x11, x14, x11
; -O0:    ccmp x1, x9, #0, eq
;
...
; -O0:    sxtb w10, w9
; -O0:    subs w10, w10, w11, sxtb
; -O0:    csel w10, w9, w11, gt
; -O0:    ldaxrb w11, [x0]
; -O0:    cmp w11, w9, uxtb
; -O0:    stlxrb w12, w10, [x0]
; -O0:    subs w9, w11, w9, uxtb
...
; -O0:    and w10, w9, #0xff
; -O0:    subs w12, w10, w11, uxtb
; -O0:    csel w11, w9, w11, hi
; -O0:    ldaxrb w12, [x0]
; -O0:    cmp w12, w9, uxtb
; -O0:    stlxrb w13, w11, [x0]
; -O0:    subs w9, w12, w10
;
...
; -O0:    subs w12, w10, w11, uxth
; -O0:    csel w11, w9, w11, hi
; -O0:    ldaxrh w12, [x0]
; -O0:    cmp w12, w9, uxth
; -O0:    stlxrh w13, w11, [x0]
; -O0:    subs w9, w12, w10
;
