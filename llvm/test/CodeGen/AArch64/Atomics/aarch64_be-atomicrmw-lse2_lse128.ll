...
; CHECK-LABEL: atomicrmw_and_i128_aligned_monotonic:
; CHECK:    mvn x1, x3
; CHECK:    mvn x8, x2
; CHECK:    ldclrp x8, x1, [x0]
...
; CHECK-LABEL: atomicrmw_and_i128_aligned_acquire:
; CHECK:    mvn x1, x3
; CHECK:    mvn x8, x2
; CHECK:    ldclrpa x8, x1, [x0]
...
; CHECK-LABEL: atomicrmw_and_i128_aligned_release:
; CHECK:    mvn x1, x3
; CHECK:    mvn x8, x2
; CHECK:    ldclrpl x8, x1, [x0]
...
; CHECK-LABEL: atomicrmw_and_i128_aligned_acq_rel:
; CHECK:    mvn x1, x3
; CHECK:    mvn x8, x2
; CHECK:    ldclrpal x8, x1, [x0]
...
; CHECK-LABEL: atomicrmw_and_i128_aligned_seq_cst:
; CHECK:    mvn x1, x3
; CHECK:    mvn x8, x2
; CHECK:    ldclrpal x8, x1, [x0]
...
; -O0:    subs x13, x12, x9
; -O0:    csel x12, x9, x12, lt
; -O0:    csel x13, x11, x13, lt
; -O0:    casp x0, x1, x2, x3, [x12]
; -O0:    subs x11, x0, x11
; -O0:    ccmp x12, x9, #0, eq
;
...
; -O0:    sxth w9, w8
; -O0:    subs w9, w9, w10, sxth
; -O0:    csel w9, w8, w10, gt
; -O0:    bl __atomic_compare_exchange
;
...
; -O0:    subs x13, x12, x9
; -O0:    csel x12, x9, x12, ge
; -O0:    csel x13, x11, x13, ge
; -O0:    casp x0, x1, x2, x3, [x12]
; -O0:    subs x11, x0, x11
; -O0:    ccmp x12, x9, #0, eq
;
...
; -O0:    subs x13, x12, x9
; -O0:    csel x12, x9, x12, lo
; -O0:    csel x13, x11, x13, lo
; -O0:    casp x0, x1, x2, x3, [x12]
; -O0:    subs x11, x0, x11
; -O0:    ccmp x12, x9, #0, eq
;
...
; -O0:    subs x13, x12, x9
; -O0:    csel x12, x9, x12, hs
; -O0:    csel x13, x11, x13, hs
; -O0:    casp x0, x1, x2, x3, [x12]
; -O0:    subs x11, x0, x11
; -O0:    ccmp x12, x9, #0, eq
;
