...
; -O0:    cmp x12, x8
; -O0:    cmp x1, x9
; -O0:    stxp w13, x10, x11, [x0]
; -O0:    stxp w13, x12, x1, [x0]
; -O0:    eor x8, x12, x8
; -O0:    eor x9, x1, x9
; -O0:    orr x8, x8, x9
;
...
; -O0:    cmp x12, x8
; -O0:    cmp x1, x9
; -O0:    stlxp w13, x10, x11, [x0]
; -O0:    stlxp w13, x12, x1, [x0]
; -O0:    eor x8, x12, x8
; -O0:    eor x9, x1, x9
; -O0:    orr x8, x8, x9
;
...
; -O0:    add w10, w1, w9, uxth
; -O0:    ldaxrb w11, [x0]
; -O0:    cmp w11, w9, uxtb
; -O0:    stlxrb w12, w10, [x0]
; -O0:    and w10, w11, #0xff
; -O0:    subs w9, w10, w9, uxtb
;
...
; -O0:    csel x9, x9, x2, ne
; -O0:    ands w8, w8, #0x1
; -O0:    csel x8, x10, x3, ne
; -O0:    ldxp x12, x1, [x0]
; -O0:    cmp x12, x10
; -O0:    cmp x1, x11
; -O0:    stxp w13, x9, x8, [x0]
; -O0:    stxp w13, x12, x1, [x0]
; -O0:    eor x8, x12, x8
; -O0:    eor x9, x1, x9
; -O0:    orr x8, x8, x9
