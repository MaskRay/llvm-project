...
; NOLSE-NEXT:    // in Loop: Header=BB4_2 Depth=2
; NOLSE-NEXT:    stlxp w12, x8, x10, [x13]
; NOLSE-NEXT:    cbnz w12, .LBB4_2
; NOLSE-NEXT:  .LBB4_5: // %atomicrmw.start
; NOLSE-NEXT:    // in Loop: Header=BB4_1 Depth=1
; NOLSE-NEXT:    mov x0, x10
; NOLSE-NEXT:    str x0, [sp, #8] // 8-byte Spill
; NOLSE-NEXT:    mov x0, x8
; NOLSE-NEXT:    str x0, [sp, #16] // 8-byte Spill
; NOLSE-NEXT:    subs x10, x10, x11
; NOLSE-NEXT:    ccmp x8, x9, #0, eq
; NOLSE-NEXT:    str x0, [sp, #32] // 8-byte Spill
; NOLSE-NEXT:    ldr x8, [sp, #8] // 8-byte Reload
...
; NOLSE-NEXT:    add sp, sp, #64
; NOLSE-NEXT:    ret
;
; LSE-LABEL: test_rmw_add_128:
; LSE:       // %bb.0: // %entry
; LSE-NEXT:    sub sp, sp, #64
; LSE-NEXT:    .cfi_def_cfa_offset 64
; LSE-NEXT:    str x0, [sp, #40] // 8-byte Spill
; LSE-NEXT:    ldr x1, [x0, #8]
; LSE-NEXT:    ldr x0, [x0]
; LSE-NEXT:    str x0, [sp, #32] // 8-byte Spill
; LSE-NEXT:    str x1, [sp, #24] // 8-byte Spill
; LSE-NEXT:    b .LBB4_1
; LSE-NEXT:  .LBB4_1: // %atomicrmw.start
; LSE-NEXT:    // =>This Inner Loop Header: Depth=1
; LSE-NEXT:    ldr x9, [sp, #32] // 8-byte Reload
; LSE-NEXT:    ldr x11, [sp, #24] // 8-byte Reload
; LSE-NEXT:    ldr x8, [sp, #40] // 8-byte Reload
; LSE-NEXT:    mov x0, x9
; LSE-NEXT:    mov x1, x11
; LSE-NEXT:    adds x2, x9, #1
...
; LSE-NEXT:    mov x10, x1
; LSE-NEXT:    str x10, [sp, #16] // 8-byte Spill
; LSE-NEXT:    subs x10, x10, x11
; LSE-NEXT:    ccmp x8, x9, #0, eq
...
; NOLSE-NEXT:    ldr w8, [sp, #12] // 4-byte Reload
; NOLSE-NEXT:    ldr x10, [sp, #16] // 8-byte Reload
; NOLSE-NEXT:    mov w9, #-2 // =0xfffffffe
; NOLSE-NEXT:    orn w11, w9, w8
...
; LSE-NEXT:    ldrb w0, [x0]
; LSE-NEXT:    str w0, [sp, #12] // 4-byte Spill
; LSE-NEXT:    b .LBB5_1
; LSE-NEXT:  .LBB5_1: // %atomicrmw.start
; LSE-NEXT:    // =>This Inner Loop Header: Depth=1
; LSE-NEXT:    ldr w8, [sp, #12] // 4-byte Reload
; LSE-NEXT:    ldr x10, [sp, #16] // 8-byte Reload
; LSE-NEXT:    mov w9, #-2 // =0xfffffffe
; LSE-NEXT:    orn w9, w9, w8
; LSE-NEXT:    mov w0, w8
; LSE-NEXT:    casalb w0, w9, [x10]
; LSE-NEXT:    subs w8, w0, w8, uxtb
; LSE-NEXT:    str w0, [sp, #8] // 4-byte Spill
; LSE-NEXT:    str w0, [sp, #12] // 4-byte Spill
; LSE-NEXT:    b.ne .LBB5_1
; LSE-NEXT:    b .LBB5_2
; LSE-NEXT:  .LBB5_2: // %atomicrmw.end
; LSE-NEXT:    ldr w0, [sp, #8] // 4-byte Reload
...
; LSE-NEXT:    orn w9, w9, w8
; LSE-NEXT:    mov w0, w8
; LSE-NEXT:    casalh w0, w9, [x10]
; LSE-NEXT:    subs w8, w0, w8, uxth
; LSE-NEXT:    str w0, [sp, #8] // 4-byte Spill
; LSE-NEXT:    str w0, [sp, #12] // 4-byte Spill
...
; LSE-NEXT:    orn w9, w9, w8
; LSE-NEXT:    mov w0, w8
; LSE-NEXT:    casal w0, w9, [x10]
; LSE-NEXT:    subs w8, w0, w8
; LSE-NEXT:    str w0, [sp, #8] // 4-byte Spill
; LSE-NEXT:    str w0, [sp, #12] // 4-byte Spill
...
; NOLSE-NEXT:    mvn w11, w9
; NOLSE-NEXT:    // implicit-def: $x9
; NOLSE-NEXT:    mov w9, w11
; NOLSE-NEXT:    orr x11, x9, #0xfffffffffffffffe
...
; LSE-NEXT:    // =>This Inner Loop Header: Depth=1
; LSE-NEXT:    ldr x8, [sp, #8] // 8-byte Reload
; LSE-NEXT:    ldr x10, [sp, #16] // 8-byte Reload
; LSE-NEXT:    mov w9, w8
; LSE-NEXT:    mvn w11, w9
; LSE-NEXT:    // implicit-def: $x9
; LSE-NEXT:    mov w9, w11
; LSE-NEXT:    orr x9, x9, #0xfffffffffffffffe
; LSE-NEXT:    mov x0, x8
; LSE-NEXT:    casal x0, x9, [x10]
; LSE-NEXT:    subs x8, x0, x8
; LSE-NEXT:    str x0, [sp] // 8-byte Spill
; LSE-NEXT:    str x0, [sp, #8] // 8-byte Spill
; LSE-NEXT:    b.ne .LBB8_1
; LSE-NEXT:    b .LBB8_2
; LSE-NEXT:  .LBB8_2: // %atomicrmw.end
; LSE-NEXT:    ldr x0, [sp] // 8-byte Reload
; LSE-NEXT:    add sp, sp, #32
; LSE-NEXT:    ret
entry:
