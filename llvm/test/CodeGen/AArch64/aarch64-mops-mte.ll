...
; GISel-O0-NEXT:    mov x9, x8
; GISel-O0-NEXT:    setgp [x0]!, x9!, x8
; GISel-O0-NEXT:    setgm [x0]!, x9!, x8
; GISel-O0-NEXT:    setge [x0]!, x9!, x8
; GISel-O0-NEXT:    ret
;
...
; GISel-O0:       // %bb.0: // %entry
; GISel-O0-NEXT:    mov x8, xzr
; GISel-O0-NEXT:    // implicit-def: $x3
; GISel-O0-NEXT:    mov w3, w2
; GISel-O0-NEXT:    setgp [x0]!, x8!, x3
; GISel-O0-NEXT:    setgm [x0]!, x8!, x3
; GISel-O0-NEXT:    setge [x0]!, x8!, x3
; GISel-O0-NEXT:    ret
;
...
; GISel-O0-NEXT:    // implicit-def: $x3
; GISel-O0-NEXT:    mov w3, w2
; GISel-O0-NEXT:    setgp [x0]!, x1!, x3
; GISel-O0-NEXT:    setgm [x0]!, x1!, x3
; GISel-O0-NEXT:    setge [x0]!, x1!, x3
; GISel-O0-NEXT:    ret
;
