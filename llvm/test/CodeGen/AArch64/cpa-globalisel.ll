...
; CHECK-CPA-O0:       // %bb.0: // %entry
; CHECK-CPA-O0-NEXT:    // implicit-def: $x2
; CHECK-CPA-O0-NEXT:    mov w2, w0
; CHECK-CPA-O0-NEXT:    sxtw x8, w2
...
; CHECK-NOCPA-O0-NEXT:    smaddl x0, w0, w9, x8
...
; CHECK-CPA-O0-NEXT:    mov w9, #48 // =0x30
; CHECK-CPA-O0-NEXT:    // kill: def $x9 killed $w9
; CHECK-CPA-O0-NEXT:    mov w10, #288 // =0x120
; CHECK-CPA-O0-NEXT:    // kill: def $x10 killed $w10
; CHECK-CPA-O0-NEXT:    adrp x11, array2
; CHECK-CPA-O0-NEXT:    add x11, x11, :lo12:array2
; CHECK-CPA-O0-NEXT:    addpt x10, x11, x10
; CHECK-CPA-O0-NEXT:    msubpt x0, x9, x8, x10
; CHECK-CPA-O0-NEXT:    mov w8, #48 // =0x30
; CHECK-CPA-O0-NEXT:    mov w2, w8
; CHECK-CPA-O0-NEXT:    mov w8, #96 // =0x60
; CHECK-CPA-O0-NEXT:    // kill: def $x8 killed $w8
; CHECK-CPA-O0-NEXT:    addpt x8, x11, x8
; CHECK-CPA-O0-NEXT:    mov x1, x8
; CHECK-CPA-O0-NEXT:    b memcpy
;
...
; CHECK-NOCPA-O0:       // %bb.0: // %entry
; CHECK-NOCPA-O0-NEXT:    // implicit-def: $x2
; CHECK-NOCPA-O0-NEXT:    mov w2, w0
; CHECK-NOCPA-O0-NEXT:    sxtw x8, w2
; CHECK-NOCPA-O0-NEXT:    mov w9, #48 // =0x30
...
; CHECK-NOCPA-O0-NEXT:    add x10, x9, #288
; CHECK-NOCPA-O0-NEXT:    add x0, x10, x8
; CHECK-NOCPA-O0-NEXT:    mov w8, #48 // =0x30
; CHECK-NOCPA-O0-NEXT:    mov w2, w8
; CHECK-NOCPA-O0-NEXT:    add x8, x9, #96
; CHECK-NOCPA-O0-NEXT:    mov x1, x8
; CHECK-NOCPA-O0-NEXT:    b memcpy
;
...
; CHECK-CPA-O0-NEXT:    smull x8, w0, w8
...
; CHECK-CPA-O0-NEXT:    // kill: def $x10 killed $w10
; CHECK-CPA-O0-NEXT:    addpt x9, x9, x10
; CHECK-CPA-O0-NEXT:    str q0, [x9, x8, lsl #4]
; CHECK-CPA-O0-NEXT:    ret
;
...
; CHECK-CPA-O0-NEXT:    subs x8, x8, w0, sxtw
; CHECK-CPA-O0-NEXT:    adrp x9, array
; CHECK-CPA-O0-NEXT:    add x9, x9, :lo12:array
; CHECK-CPA-O0-NEXT:    ldr q0, [x9, #32]
; CHECK-CPA-O0-NEXT:    mov w10, #96 // =0x60
...
; CHECK-NOCPA-O0-NEXT:    subs x8, x8, w0, sxtw
; CHECK-NOCPA-O0-NEXT:    adrp x9, array
; CHECK-NOCPA-O0-NEXT:    add x9, x9, :lo12:array
; CHECK-NOCPA-O0-NEXT:    ldr q0, [x9, #32]
; CHECK-NOCPA-O0-NEXT:    add x9, x9, #96
...
; CHECK-CPA-O0-NEXT:    mov w10, #48 // =0x30
; CHECK-CPA-O0-NEXT:    // kill: def $x10 killed $w10
; CHECK-CPA-O0-NEXT:    maddpt x8, x9, x10, x8
; CHECK-CPA-O0-NEXT:    ldr x8, [x8, #24]
; CHECK-CPA-O0-NEXT:    ldr x9, [sp, #16]
; CHECK-CPA-O0-NEXT:    ldr x10, [sp, #8]
; CHECK-CPA-O0-NEXT:    mul x9, x9, x10
; CHECK-CPA-O0-NEXT:    add x8, x8, x9
; CHECK-CPA-O0-NEXT:    subs x0, x8, x10
; CHECK-CPA-O0-NEXT:    add sp, sp, #32
; CHECK-CPA-O0-NEXT:    ret
;
...
; CHECK-NOCPA-O0-NEXT:    // kill: def $w10 killed $w10 killed $x10
; CHECK-NOCPA-O0-NEXT:    // kill: def $w9 killed $w9 killed $x9
; CHECK-NOCPA-O0-NEXT:    smaddl x8, w9, w10, x8
; CHECK-NOCPA-O0-NEXT:    ldr x8, [x8, #24]
; CHECK-NOCPA-O0-NEXT:    ldr x9, [sp, #16]
; CHECK-NOCPA-O0-NEXT:    ldr x10, [sp, #8]
; CHECK-NOCPA-O0-NEXT:    mul x9, x9, x10
; CHECK-NOCPA-O0-NEXT:    add x8, x8, x9
; CHECK-NOCPA-O0-NEXT:    subs x0, x8, x10
; CHECK-NOCPA-O0-NEXT:    add sp, sp, #32
; CHECK-NOCPA-O0-NEXT:    ret
;
...
; CHECK-CPA-O0-NEXT:    add w8, w8, #1
; CHECK-CPA-O0-NEXT:    mov w10, #2 // =0x2
; CHECK-CPA-O0-NEXT:    // kill: def $x10 killed $w10
; CHECK-CPA-O0-NEXT:    adrp x11, a
; CHECK-CPA-O0-NEXT:    add x11, x11, :lo12:a
; CHECK-CPA-O0-NEXT:    addpt x10, x11, x10
; CHECK-CPA-O0-NEXT:    addpt x9, x10, x9, lsl #1
; CHECK-CPA-O0-NEXT:    ldrb w8, [x9, w8, sxtw]
...
; CHECK-NOCPA-O0-NEXT:    add w8, w8, #1
; CHECK-NOCPA-O0-NEXT:    adrp x10, a
; CHECK-NOCPA-O0-NEXT:    add x10, x10, :lo12:a
; CHECK-NOCPA-O0-NEXT:    add x10, x10, #2
; CHECK-NOCPA-O0-NEXT:    add x9, x10, x9, lsl #1
; CHECK-NOCPA-O0-NEXT:    ldrb w8, [x9, w8, sxtw]
