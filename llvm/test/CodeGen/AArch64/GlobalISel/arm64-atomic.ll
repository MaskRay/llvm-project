...
; CHECK-NOLSE-O0-NEXT:    subs w8, w8, w9
...
; CHECK-OUTLINE-O0-NEXT:    str w1, [sp, #28] ; 4-byte Spill
...
; CHECK-LSE-O0-NEXT:    str w0, [sp, #12] ; 4-byte Spill
; CHECK-LSE-O0-NEXT:    subs w8, w8, w9
; CHECK-LSE-O0-NEXT:    str w0, [sp, #28] ; 4-byte Spill
...
; CHECK-NOLSE-O0-NEXT:    subs x8, x8, x9
...
; CHECK-LSE-O0-NEXT:    subs x8, x8, x9
...
; CHECK-NOLSE-O0-NEXT:    ldr w9, [sp, #12] ; 4-byte Reload
; CHECK-NOLSE-O0-NEXT:    ldr x11, [sp, #16] ; 8-byte Reload
...
; CHECK-NOLSE-O0-NEXT:    stlxrb w10, w12, [x11]
; CHECK-NOLSE-O0-NEXT:    cbnz w10, LBB28_2
...
; CHECK-NOLSE-O0-NEXT:    stlxrb w10, w12, [x11]
; CHECK-NOLSE-O0-NEXT:    cbnz w10, LBB29_2
...
; CHECK-NOLSE-O0-NEXT:    stlxrb w10, w12, [x11]
; CHECK-NOLSE-O0-NEXT:    cbnz w10, LBB30_2
...
; CHECK-NOLSE-O0-NEXT:    stlxrb w10, w12, [x11]
; CHECK-NOLSE-O0-NEXT:    cbnz w10, LBB31_2
...
; CHECK-NOLSE-O0-NEXT:    stlxrb w10, w12, [x11]
; CHECK-NOLSE-O0-NEXT:    cbnz w10, LBB32_2
...
; CHECK-NOLSE-O0-NEXT:    subs w10, w10, w8, sxtb
...
; CHECK-NOLSE-O0-NEXT:    stlxrb w10, w12, [x11]
; CHECK-NOLSE-O0-NEXT:    cbnz w10, LBB33_2
...
; CHECK-OUTLINE-O0-NEXT:    ldr w9, [sp, #12] ; 4-byte Reload
...
; CHECK-OUTLINE-O0-NEXT:    ldr w0, [sp, #8] ; 4-byte Reload
; CHECK-OUTLINE-O0-NEXT:    ldp x29, x30, [sp, #32] ; 16-byte Folded Reload
; CHECK-OUTLINE-O0-NEXT:    add sp, sp, #48
; CHECK-OUTLINE-O0-NEXT:    ret
;
...
; CHECK-NOLSE-O0-NEXT:    stlxrb w10, w12, [x11]
; CHECK-NOLSE-O0-NEXT:    cbnz w10, LBB34_2
...
; CHECK-NOLSE-O0-NEXT:    subs w10, w10, w8, uxtb
...
; CHECK-NOLSE-O0-NEXT:    stlxrb w10, w12, [x11]
; CHECK-NOLSE-O0-NEXT:    cbnz w10, LBB35_2
...
; CHECK-NOLSE-O0-NEXT:    stlxrb w10, w12, [x11]
; CHECK-NOLSE-O0-NEXT:    cbnz w10, LBB36_2
...
; CHECK-NOLSE-O0-NEXT:    str w9, [sp, #8] ; 4-byte Spill
; CHECK-NOLSE-O0-NEXT:    uxth w8, w8
