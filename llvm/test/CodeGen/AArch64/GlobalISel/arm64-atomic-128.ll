...
; CHECK-LLSC-O0-NEXT:    ldaxp x8, x9, [x0]
; CHECK-LLSC-O0-NEXT:    cmp x8, x2
; CHECK-LLSC-O0-NEXT:    cset w10, ne
; CHECK-LLSC-O0-NEXT:    cmp x9, x3
...
; CHECK-LLSC-O0-NEXT:    stxp w10, x8, x9, [x0]
; CHECK-LLSC-O0-NEXT:    cbnz w10, .LBB0_1
; CHECK-LLSC-O0-NEXT:  .LBB0_4:
; CHECK-LLSC-O0-NEXT:    // implicit-def: $q0
; CHECK-LLSC-O0-NEXT:    mov v0.d[0], x8
; CHECK-LLSC-O0-NEXT:    mov v0.d[1], x9
...
; CHECK-OUTLINE-LLSC-O0-NEXT:    stp x30, x19, [sp, #-16]! // 16-byte Folded Spill
; CHECK-OUTLINE-LLSC-O0-NEXT:    .cfi_def_cfa_offset 16
; CHECK-OUTLINE-LLSC-O0-NEXT:    .cfi_offset w19, -8
; CHECK-OUTLINE-LLSC-O0-NEXT:    .cfi_offset w30, -16
; CHECK-OUTLINE-LLSC-O0-NEXT:    mov x19, x0
...
; CHECK-OUTLINE-LLSC-O0-NEXT:    mov x4, x19
...
; CHECK-OUTLINE-LLSC-O0-NEXT:    str q0, [x19]
; CHECK-OUTLINE-LLSC-O0-NEXT:    ldp x30, x19, [sp], #16 // 16-byte Folded Reload
; CHECK-OUTLINE-LLSC-O0-NEXT:    ret
;
; CHECK-CAS-O0-LABEL: val_compare_and_swap:
; CHECK-CAS-O0:       // %bb.0:
; CHECK-CAS-O0-NEXT:    mov x6, x2
; CHECK-CAS-O0-NEXT:    mov x7, x3
; CHECK-CAS-O0-NEXT:    mov x2, x4
; CHECK-CAS-O0-NEXT:    mov x3, x5
; CHECK-CAS-O0-NEXT:    caspa x6, x7, x2, x3, [x0]
; CHECK-CAS-O0-NEXT:    mov x8, x6
; CHECK-CAS-O0-NEXT:    mov x9, x7
; CHECK-CAS-O0-NEXT:    // implicit-def: $q0
; CHECK-CAS-O0-NEXT:    mov v0.d[0], x8
; CHECK-CAS-O0-NEXT:    mov v0.d[1], x9
...
; CHECK-LLSC-O0-NEXT:    stlxp w10, x8, x9, [x0]
; CHECK-LLSC-O0-NEXT:    cbnz w10, .LBB1_1
...
; CHECK-CAS-O0-NEXT:    mov x2, x4
; CHECK-CAS-O0-NEXT:    mov x3, x5
; CHECK-CAS-O0-NEXT:    caspal x6, x7, x2, x3, [x0]
; CHECK-CAS-O0-NEXT:    mov x8, x6
; CHECK-CAS-O0-NEXT:    mov x9, x7
; CHECK-CAS-O0-NEXT:    // implicit-def: $q0
; CHECK-CAS-O0-NEXT:    mov v0.d[0], x8
...
; CHECK-LLSC-O0-NEXT:    ldxp x9, x10, [x2]
; CHECK-LLSC-O0-NEXT:    cmp x9, x8
; CHECK-LLSC-O0-NEXT:    cset w11, ne
; CHECK-LLSC-O0-NEXT:    cmp x10, x8
; CHECK-LLSC-O0-NEXT:    cinc w11, w11, ne
; CHECK-LLSC-O0-NEXT:    cbnz w11, .LBB4_3
; CHECK-LLSC-O0-NEXT:  // %bb.2: // in Loop: Header=BB4_1 Depth=1
; CHECK-LLSC-O0-NEXT:    stxp w11, x8, x8, [x2]
; CHECK-LLSC-O0-NEXT:    cbnz w11, .LBB4_1
; CHECK-LLSC-O0-NEXT:    b .LBB4_4
; CHECK-LLSC-O0-NEXT:  .LBB4_3: // in Loop: Header=BB4_1 Depth=1
; CHECK-LLSC-O0-NEXT:    stxp w11, x9, x10, [x2]
; CHECK-LLSC-O0-NEXT:    cbnz w11, .LBB4_1
...
; CHECK-OUTLINE-LLSC-O0-NEXT:    .cfi_offset w19, -8
; CHECK-OUTLINE-LLSC-O0-NEXT:    .cfi_offset w30, -16
; CHECK-OUTLINE-LLSC-O0-NEXT:    mov x19, x3
; CHECK-OUTLINE-LLSC-O0-NEXT:    mov x8, xzr
; CHECK-OUTLINE-LLSC-O0-NEXT:    mov x0, x8
; CHECK-OUTLINE-LLSC-O0-NEXT:    mov x1, x8
; CHECK-OUTLINE-LLSC-O0-NEXT:    str x2, [sp, #8] // 8-byte Spill
; CHECK-OUTLINE-LLSC-O0-NEXT:    mov x2, x8
; CHECK-OUTLINE-LLSC-O0-NEXT:    mov x3, x8
...
; CHECK-CAS-O0-NEXT:    mov x6, x8
; CHECK-CAS-O0-NEXT:    mov x7, x8
; CHECK-CAS-O0-NEXT:    casp x4, x5, x6, x7, [x2]
; CHECK-CAS-O0-NEXT:    mov x8, x4
; CHECK-CAS-O0-NEXT:    mov x9, x5
; CHECK-CAS-O0-NEXT:    // implicit-def: $q0
; CHECK-CAS-O0-NEXT:    mov v0.d[0], x8
; CHECK-CAS-O0-NEXT:    mov v0.d[1], x9
...
; CHECK-LLSC-O0-NEXT:    ldaxp x8, x1, [x0]
; CHECK-LLSC-O0-NEXT:    cmp x8, x2
; CHECK-LLSC-O0-NEXT:    cset w9, ne
; CHECK-LLSC-O0-NEXT:    cmp x1, x3
; CHECK-LLSC-O0-NEXT:    cinc w9, w9, ne
; CHECK-LLSC-O0-NEXT:    cbnz w9, .LBB5_3
; CHECK-LLSC-O0-NEXT:  // %bb.2: // in Loop: Header=BB5_1 Depth=1
; CHECK-LLSC-O0-NEXT:    stxp w9, x4, x5, [x0]
; CHECK-LLSC-O0-NEXT:    cbnz w9, .LBB5_1
; CHECK-LLSC-O0-NEXT:    b .LBB5_4
; CHECK-LLSC-O0-NEXT:  .LBB5_3: // in Loop: Header=BB5_1 Depth=1
; CHECK-LLSC-O0-NEXT:    stxp w9, x8, x1, [x0]
; CHECK-LLSC-O0-NEXT:    cbnz w9, .LBB5_1
; CHECK-LLSC-O0-NEXT:  .LBB5_4:
; CHECK-LLSC-O0-NEXT:    mov x0, x8
; CHECK-LLSC-O0-NEXT:    ret
;
...
; CHECK-CAS-O0-NEXT:    mov x3, x5
; CHECK-CAS-O0-NEXT:    caspa x6, x7, x2, x3, [x0]
; CHECK-CAS-O0-NEXT:    mov x0, x6
; CHECK-CAS-O0-NEXT:    mov x1, x7
; CHECK-CAS-O0-NEXT:    ret
