...
; CHECK-NEXT:    ld.d $a0, $a0, %got_pc_lo12(var)
; CHECK-NEXT:    ld.w $a1, $a0, 0
; CHECK-NEXT:    ld.w $a2, $a0, 0
; CHECK-NEXT:    ld.w $a3, $a0, 0
; CHECK-NEXT:    ld.w $a4, $a0, 0
; CHECK-NEXT:    ld.w $a5, $a0, 0
; CHECK-NEXT:    ld.w $a6, $a0, 0
; CHECK-NEXT:    ld.w $a7, $a0, 0
; CHECK-NEXT:    ld.w $t0, $a0, 0
; CHECK-NEXT:    ld.w $t1, $a0, 0
; CHECK-NEXT:    ld.w $t2, $a0, 0
; CHECK-NEXT:    ld.w $t3, $a0, 0
; CHECK-NEXT:    ld.w $t4, $a0, 0
; CHECK-NEXT:    ld.w $t5, $a0, 0
; CHECK-NEXT:    ld.w $t6, $a0, 0
; CHECK-NEXT:    ld.w $t7, $a0, 0
; CHECK-NEXT:    ld.w $t8, $a0, 0
; CHECK-NEXT:    st.d $fp, $sp, 0 # 8-byte Folded Spill
; CHECK-NEXT:    lu12i.w $fp, 1
; CHECK-NEXT:    ori $fp, $fp, 12
; CHECK-NEXT:    add.d $fp, $sp, $fp
; CHECK-NEXT:    st.w $a1, $fp, 0
...
; CHECK-NEXT:    st.w $a5, $a0, 0
; CHECK-NEXT:    st.w $a6, $a0, 0
; CHECK-NEXT:    st.w $a7, $a0, 0
; CHECK-NEXT:    st.w $t0, $a0, 0
; CHECK-NEXT:    st.w $t1, $a0, 0
; CHECK-NEXT:    st.w $t2, $a0, 0
; CHECK-NEXT:    st.w $t3, $a0, 0
; CHECK-NEXT:    st.w $t4, $a0, 0
; CHECK-NEXT:    st.w $t5, $a0, 0
; CHECK-NEXT:    st.w $t6, $a0, 0
; CHECK-NEXT:    st.w $t7, $a0, 0
; CHECK-NEXT:    st.w $t8, $a0, 0
; CHECK-NEXT:    lu12i.w $a0, 1
; CHECK-NEXT:    ori $a0, $a0, 16
