...
; RUN:      -mattr=+aix-small-local-dynamic-tls -mtriple powerpc64-ibm-aix-xcoff --code-model=small < %s \
...
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addis r4, L..C1@u(r2)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r4, L..C1@l(r4)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    std r3, 56(r1) # 8-byte Folded Spill
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mr r3, r4
...
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r4, L..C0(r2) # target-flags(ppc-tlsldm) @"_$TLSML"
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    stw r3, 60(r1) # 4-byte Folded Spill
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    mr r3, r4
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    bla .__tls_get_mod[PR]
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    la r3, tlv_char[TL]@ld(r3)
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    lwz r4, 60(r1) # 4-byte Folded Reload
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    stb r4, 0(r3)
...
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addis r4, L..C0@u(r2)
...
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mr r3, r4
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    bla .__tls_get_mod[PR]
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    la r3, tlv_char[TL]@ld(r3)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    lwz r4, 60(r1) # 4-byte Folded Reload
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    stb r4, 0(r3)
...
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r4, L..C0(r2) # target-flags(ppc-tlsldm) @"_$TLSML"
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    stw r3, 60(r1) # 4-byte Folded Spill
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    mr r3, r4
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    bla .__tls_get_mod[PR]
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r4, L..C4(r2) # target-flags(ppc-tlsld) @tlv_char
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    add r3, r3, r4
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    lwz r4, 60(r1) # 4-byte Folded Reload
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    stb r4, 0(r3)
...
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addis r4, L..C4@u(r2)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addis r5, L..C1@u(r2)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r5, L..C1@l(r5)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    stw r3, 60(r1) # 4-byte Folded Spill
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mr r3, r5
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    std r4, 48(r1) # 8-byte Folded Spill
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    bla .__tls_get_mod[PR]
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r4, 48(r1) # 8-byte Folded Reload
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r4, L..C4@l(r4)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    add r3, r3, r4
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    lwz r4, 60(r1) # 4-byte Folded Reload
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    stb r4, 0(r3)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addi r1, r1, 64
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r0, 16(r1)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mtlr r0
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    blr
...
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    mr r3, r4
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    bla .__tls_get_mod[PR]
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    la r3, tlv_short[TL]@ld(r3)
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    lwz r4, 60(r1) # 4-byte Folded Reload
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    sth r4, 0(r3)
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    addi r1, r1, 64
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r0, 16(r1)
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    mtlr r0
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    blr
...
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mr r3, r4
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    bla .__tls_get_mod[PR]
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    la r3, tlv_short[TL]@ld(r3)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    lwz r4, 60(r1) # 4-byte Folded Reload
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    sth r4, 0(r3)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addi r1, r1, 64
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r0, 16(r1)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mtlr r0
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    blr
...
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    mr r3, r4
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    bla .__tls_get_mod[PR]
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r4, L..C5(r2) # target-flags(ppc-tlsld) @tlv_short
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    add r3, r3, r4
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    lwz r4, 60(r1) # 4-byte Folded Reload
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    sth r4, 0(r3)
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    addi r1, r1, 64
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r0, 16(r1)
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    mtlr r0
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    blr
...
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    std r0, 80(r1)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    # kill: def $r3 killed $r3 killed $x3
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addis r4, L..C5@u(r2)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addis r5, L..C1@u(r2)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r5, L..C1@l(r5)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    stw r3, 60(r1) # 4-byte Folded Spill
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mr r3, r5
...
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    add r3, r3, r4
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    lwz r4, 60(r1) # 4-byte Folded Reload
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    sth r4, 0(r3)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addi r1, r1, 64
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r0, 16(r1)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mtlr r0
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    blr
...
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r4, L..C1(r2) # @tlv_int_init
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    lwz r4, 0(r4)
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    add r3, r4, r3
...
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addis r4, L..C1@u(r2)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r4, L..C1@l(r4)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    lwz r4, 0(r4)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    add r3, r4, r3
...
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r4, L..C8(r2) # @tlv_int_init
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    lwz r4, 0(r4)
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    add r3, r4, r3
...
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addis r4, L..C8@u(r2)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r4, L..C8@l(r4)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    lwz r4, 0(r4)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    add r3, r4, r3
...
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r3, L..C0(r2) # target-flags(ppc-tlsldm) @"_$TLSML"
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    bla .__tls_get_mod[PR]
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    la r3, internal_tlv_long[TL]@ld(r3)
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r4, 0(r3)
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    addi r4, r4, 9
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    std r4, 0(r3)
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    addi r1, r1, 48
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r0, 16(r1)
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    mtlr r0
; SMALL-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    blr
...
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r3, L..C0@l(r3)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    bla .__tls_get_mod[PR]
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    la r3, internal_tlv_long[TL]@ld(r3)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r4, 0(r3)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addi r4, r4, 9
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    std r4, 0(r3)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addi r1, r1, 48
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r0, 16(r1)
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mtlr r0
; SMALL-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    blr
...
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    add r3, r3, r4
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r4, 0(r3)
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    addi r4, r4, 9
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    std r4, 0(r3)
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    addi r1, r1, 48
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    ld r0, 16(r1)
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    mtlr r0
; DEFAULT-LOCAL-DYNAMIC-SMALLCM64-O0-NEXT:    blr
...
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    add r3, r3, r4
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r4, 0(r3)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addi r4, r4, 9
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    std r4, 0(r3)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    addi r1, r1, 64
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    ld r0, 16(r1)
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    mtlr r0
; DEFAULT-LOCAL-DYNAMIC-LARGECM64-O0-NEXT:    blr
