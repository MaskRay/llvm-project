...
; RUN:   -verify-machineinstrs < %s | FileCheck -check-prefixes=CHECK,CHECK-OPT %s
; RUN: llc -O0 -mcpu=pwr9 -mtriple=powerpc64le-unknown-linux-gnu \
; RUN:   -verify-machineinstrs < %s | FileCheck -check-prefixes=CHECK,CHECK-O0 %s
; RUN: llc -mcpu=pwr9 -mtriple=powerpc64-unknown-linux-gnu \
; RUN:   -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK-BE,CHECK-BE-OPT
; RUN: llc -O0 -mcpu=pwr9 -mtriple=powerpc64-unknown-linux-gnu \
; RUN:   -verify-machineinstrs < %s | FileCheck %s --check-prefixes=CHECK-BE,CHECK-BE-O0
...
; CHECK-NEXT:    vinserth 2, 3, 2
; CHECK-NEXT:    blr
;
; CHECK-BE-LABEL: shuffle_vector_halfword_6_11:
; CHECK-BE:       # %bb.0: # %entry
; CHECK-BE-NEXT:    vinserth 2, 3, 12
; CHECK-BE-NEXT:    blr
entry:
...
; CHECK-OPT-LABEL: insert_halfword_0:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinserth 2, 3, 14
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_halfword_0:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinserth 2, 3, 0
...
; CHECK-OPT-LABEL: insert_halfword_1:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinserth 2, 3, 12
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_halfword_1:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinserth 2, 3, 2
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_halfword_2:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinserth 2, 3, 10
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_halfword_2:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinserth 2, 3, 4
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_halfword_3:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinserth 2, 3, 8
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_halfword_3:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinserth 2, 3, 6
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_halfword_4:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinserth 2, 3, 6
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_halfword_4:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinserth 2, 3, 8
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_halfword_5:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinserth 2, 3, 4
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_halfword_5:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinserth 2, 3, 10
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_halfword_6:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinserth 2, 3, 2
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_halfword_6:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinserth 2, 3, 12
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_halfword_7:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinserth 2, 3, 0
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_halfword_7:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinserth 2, 3, 14
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_0:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 15
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_0:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 0
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_1:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 14
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_1:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 1
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_2:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 13
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_2:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 2
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_3:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 12
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_3:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 3
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_4:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 11
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_4:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 4
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_5:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 10
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_5:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 5
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_6:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 9
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_6:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 6
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_7:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 8
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_7:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 7
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_8:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 7
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_8:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 8
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_9:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 6
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_9:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 9
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_10:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 5
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_10:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 10
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_11:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 4
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_11:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 11
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_12:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 3
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_12:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 12
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_13:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 2
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_13:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 13
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_14:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 1
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_14:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 14
; CHECK-BE-OPT-NEXT:    blr
;
...
; CHECK-OPT-LABEL: insert_byte_15:
; CHECK-OPT:       # %bb.0: # %entry
; CHECK-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-OPT-NEXT:    vinsertb 2, 3, 0
; CHECK-OPT-NEXT:    blr
;
...
; CHECK-O0-NEXT:    blr
;
; CHECK-BE-OPT-LABEL: insert_byte_15:
; CHECK-BE-OPT:       # %bb.0: # %entry
; CHECK-BE-OPT-NEXT:    mtvsrwz 35, 5
; CHECK-BE-OPT-NEXT:    vinsertb 2, 3, 15
; CHECK-BE-OPT-NEXT:    blr
;
