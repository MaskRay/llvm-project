...
; CHECK-O0-NEXT:    vmovaps 240(%rbp), %ymm8
; CHECK-O0-NEXT:    vmovaps 208(%rbp), %ymm9
; CHECK-O0-NEXT:    vmovaps 176(%rbp), %ymm10
; CHECK-O0-NEXT:    vmovaps 144(%rbp), %ymm10
...
; CHECK-O0-NEXT:    # kill: def $ymm4 killed $ymm4
; CHECK-O0-NEXT:    # kill: def $ymm3 killed $ymm3
; CHECK-O0-NEXT:    # kill: def $ymm1 killed $ymm1
; CHECK-O0-NEXT:    # kill: def $ymm0 killed $ymm0
; CHECK-O0-NEXT:    vpblendd {{.*#+}} ymm0 = ymm6[0,1,2,3,4,5],ymm2[6,7]
; CHECK-O0-NEXT:    vxorps %xmm1, %xmm1, %xmm1
; CHECK-O0-NEXT:    # kill: def $ymm1 killed $xmm1
; CHECK-O0-NEXT:    vpunpcklqdq {{.*#+}} ymm2 = ymm10[0],ymm9[0],ymm10[2],ymm9[2]
...
; CHECK-O0-NEXT:    vpblendd {{.*#+}} ymm2 = ymm2[0,1],ymm1[2,3],ymm2[4,5,6,7]
; CHECK-O0-NEXT:    vmovaps %xmm9, %xmm1
; CHECK-O0-NEXT:    vmovaps %xmm7, %xmm3
; CHECK-O0-NEXT:    vpblendd {{.*#+}} xmm1 = xmm3[0,1],xmm1[2,3]
; CHECK-O0-NEXT:    # implicit-def: $ymm3
; CHECK-O0-NEXT:    vmovaps %xmm1, %xmm3
; CHECK-O0-NEXT:    vpermq {{.*#+}} ymm1 = ymm3[0,0,1,3]
...
; CHECK-O0-NEXT:    vpblendd {{.*#+}} ymm3 = ymm3[0,1],ymm1[2,3,4,5],ymm3[6,7]
; CHECK-O0-NEXT:    vpunpcklqdq {{.*#+}} ymm1 = ymm7[0],ymm5[0],ymm7[2],ymm5[2]
; CHECK-O0-NEXT:    vpblendd {{.*#+}} ymm1 = ymm8[0,1,2,3],ymm1[4,5,6,7]
