...
; RUN: llc -mcpu=novalake -mattr=-ndd,-egpr,-ccmp,-cf,-nf,-push2pop2,-ppx -o - -O0 < %s | FileCheck %s -check-prefix=NO-SETZUCC
; RUN: llc -mcpu=diamondrapids -mattr=-ndd,-egpr,-ccmp,-cf,-nf,-push2pop2,-ppx -o - -O0 < %s | FileCheck %s -check-prefix=NO-SETZUCC
