...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x0
; GFX6-NEXT:    s_load_dwordx2 s[6:7], s[8:9], 0x2
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_mov_b32 s8, s7
; GFX6-NEXT:    ; kill: def $sgpr6 killed $sgpr6 killed $sgpr6_sgpr7
; GFX6-NEXT:    s_mov_b32 s7, 0x100f000
; GFX6-NEXT:    s_mov_b32 s9, -1
; GFX6-NEXT:    s_mov_b32 s12, s6
; GFX6-NEXT:    s_mov_b32 s13, s8
; GFX6-NEXT:    s_mov_b32 s14, s9
...
; GFX10-WGP-NEXT:    global_store_dword v0, v1, s[6:7]
...
; GFX10-CU-NEXT:    global_store_dword v0, v1, s[6:7]
...
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s4, s3
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr2 killed $sgpr2 killed $sgpr2_sgpr3
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s3, 0xf000
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s5, -1
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s8, s2
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s9, s4
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s10, s5
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s11, s3
; SKIP-CACHE-INV-NEXT:    s_load_dword s0, s[0:1], 0x0
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v0, s0
; SKIP-CACHE-INV-NEXT:    buffer_store_dword v0, off, s[8:11], 0
...
; GFX90A-NOTTGSPLIT-NEXT:    global_store_dword v0, v1, s[6:7]
...
; GFX6:       ; %bb.0: ; %entry
; GFX6-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX6-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x0
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x2
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX6-NEXT:    v_mov_b32_e32 v2, v0
; GFX6-NEXT:    v_mov_b32_e32 v3, v1
; GFX6-NEXT:    s_mov_b32 s8, 2
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[2:3], s8
...
; GFX10-WGP-NEXT:    v_lshlrev_b64 v[2:3], s8, v[3:4]
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-WGP-NEXT:    v_add_co_u32 v0, s5, s8, v0
; GFX10-WGP-NEXT:    v_add_co_ci_u32_e64 v2, s4, s4, v2, s5
; GFX10-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX10-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX10-WGP-NEXT:    global_load_dword v0, v[3:4], off slc
; GFX10-WGP-NEXT:    s_waitcnt vmcnt(0)
; GFX10-WGP-NEXT:    global_store_dword v1, v0, s[6:7]
; GFX10-WGP-NEXT:    s_endpgm
;
...
; GFX10-CU-NEXT:    v_lshlrev_b64 v[2:3], s8, v[3:4]
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-CU-NEXT:    v_add_co_u32 v0, s5, s8, v0
; GFX10-CU-NEXT:    v_add_co_ci_u32_e64 v2, s4, s4, v2, s5
; GFX10-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX10-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX10-CU-NEXT:    global_load_dword v0, v[3:4], off slc
; GFX10-CU-NEXT:    s_waitcnt vmcnt(0)
; GFX10-CU-NEXT:    global_store_dword v1, v0, s[6:7]
; GFX10-CU-NEXT:    s_endpgm
;
...
; GFX90A-NOTTGSPLIT-NEXT:    v_lshlrev_b64 v[2:3], s8, v[4:5]
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-NOTTGSPLIT-NEXT:    v_add_co_u32_e64 v0, s[8:9], s8, v0
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v3, s4
; GFX90A-NOTTGSPLIT-NEXT:    v_addc_co_u32_e64 v2, s[4:5], v3, v2, s[8:9]
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v4, v0
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v5, v2
; GFX90A-NOTTGSPLIT-NEXT:    global_load_dword v0, v[4:5], off glc slc
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NOTTGSPLIT-NEXT:    global_store_dword v1, v0, s[6:7]
; GFX90A-NOTTGSPLIT-NEXT:    s_endpgm
;
...
; GFX90A-TGSPLIT-NEXT:    v_lshlrev_b64 v[2:3], s8, v[4:5]
; GFX90A-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-TGSPLIT-NEXT:    v_add_co_u32_e64 v0, s[8:9], s8, v0
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v3, s4
; GFX90A-TGSPLIT-NEXT:    v_addc_co_u32_e64 v2, s[4:5], v3, v2, s[8:9]
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v4, v0
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v5, v2
; GFX90A-TGSPLIT-NEXT:    global_load_dword v0, v[4:5], off glc slc
; GFX90A-TGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-TGSPLIT-NEXT:    global_store_dword v1, v0, s[6:7]
; GFX90A-TGSPLIT-NEXT:    s_endpgm
;
...
; GFX942-NOTTGSPLIT-NEXT:    v_lshl_add_u64 v[2:3], v[4:5], s4, v[2:3]
; GFX942-NOTTGSPLIT-NEXT:    global_load_dword v0, v[2:3], off nt
...
; GFX942-TGSPLIT-NEXT:    v_lshl_add_u64 v[2:3], v[4:5], s4, v[2:3]
; GFX942-TGSPLIT-NEXT:    global_load_dword v0, v[2:3], off nt
...
; GFX11-WGP-NEXT:    v_lshlrev_b64 v[2:3], s4, v[3:4]
; GFX11-WGP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-WGP-NEXT:    v_add_co_u32 v0, s1, s4, v0
; GFX11-WGP-NEXT:    v_add_co_ci_u32_e64 v2, s0, s0, v2, s1
; GFX11-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX11-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX11-WGP-NEXT:    global_load_b32 v0, v[3:4], off slc dlc
...
; GFX11-CU-NEXT:    v_lshlrev_b64 v[2:3], s4, v[3:4]
; GFX11-CU-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-CU-NEXT:    v_add_co_u32 v0, s1, s4, v0
; GFX11-CU-NEXT:    v_add_co_ci_u32_e64 v2, s0, s0, v2, s1
; GFX11-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX11-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX11-CU-NEXT:    global_load_b32 v0, v[3:4], off slc dlc
...
; GFX12-WGP-NEXT:    v_lshlrev_b64_e64 v[2:3], s4, v[3:4]
; GFX12-WGP-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-WGP-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-WGP-NEXT:    v_add_co_u32 v0, s1, s4, v0
; GFX12-WGP-NEXT:    v_add_co_ci_u32_e64 v2, s0, s0, v2, s1
; GFX12-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX12-WGP-NEXT:    global_load_b32 v0, v[3:4], off th:TH_LOAD_NT
...
; GFX12-CU-NEXT:    v_lshlrev_b64_e64 v[2:3], s4, v[3:4]
; GFX12-CU-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-CU-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-CU-NEXT:    v_add_co_u32 v0, s1, s4, v0
; GFX12-CU-NEXT:    v_add_co_ci_u32_e64 v2, s0, s0, v2, s1
; GFX12-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX12-CU-NEXT:    global_load_b32 v0, v[3:4], off th:TH_LOAD_NT
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v0, s4
; GFX6-NEXT:    buffer_store_dword v0, off, s[12:15], 0 glc slc
; GFX6-NEXT:    s_endpgm
;
...
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-WGP-NEXT:    v_mov_b32_e32 v1, s4
; GFX10-WGP-NEXT:    global_store_dword v0, v1, s[6:7] glc slc
; GFX10-WGP-NEXT:    s_endpgm
;
...
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-CU-NEXT:    v_mov_b32_e32 v1, s4
; GFX10-CU-NEXT:    global_store_dword v0, v1, s[6:7] glc slc
; GFX10-CU-NEXT:    s_endpgm
;
...
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v0, s0
; SKIP-CACHE-INV-NEXT:    buffer_store_dword v0, off, s[8:11], 0 glc slc
; SKIP-CACHE-INV-NEXT:    s_endpgm
;
...
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v1, s4
; GFX90A-NOTTGSPLIT-NEXT:    global_store_dword v0, v1, s[6:7] glc slc
; GFX90A-NOTTGSPLIT-NEXT:    s_endpgm
;
...
; GFX90A-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v1, s4
; GFX90A-TGSPLIT-NEXT:    global_store_dword v0, v1, s[6:7] glc slc
; GFX90A-TGSPLIT-NEXT:    s_endpgm
;
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_load_dword s4, s[4:5], 0x0
; GFX6-NEXT:    s_mov_b32 s5, 0x100f000
...
; GFX6-NEXT:    s_mov_b64 s[14:15], s[8:9]
; GFX6-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX6-NEXT:    v_mov_b32_e32 v2, v0
; GFX6-NEXT:    v_mov_b32_e32 v3, v1
; GFX6-NEXT:    s_mov_b32 s5, 2
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[2:3], s5
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s4
; GFX6-NEXT:    buffer_store_dword v2, v[0:1], s[12:15], 0 addr64 glc slc
; GFX6-NEXT:    s_endpgm
;
...
; GFX7-NEXT:    v_lshl_b64 v[0:1], v[2:3], s5
; GFX7-NEXT:    s_mov_b32 s5, s6
; GFX7-NEXT:    v_mov_b32_e32 v2, v0
; GFX7-NEXT:    s_mov_b32 s6, s7
; GFX7-NEXT:    v_mov_b32_e32 v0, v1
; GFX7-NEXT:    v_add_i32_e64 v1, s[8:9], s5, v2
; GFX7-NEXT:    v_mov_b32_e32 v2, s6
; GFX7-NEXT:    v_addc_u32_e64 v0, s[6:7], v2, v0, s[8:9]
; GFX7-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX7-NEXT:    v_mov_b32_e32 v2, v0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-WGP-NEXT:    v_lshlrev_b64 v[0:1], s5, v[2:3]
; GFX10-WGP-NEXT:    s_mov_b32 s5, s6
; GFX10-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-WGP-NEXT:    s_mov_b32 s6, s7
; GFX10-WGP-NEXT:    v_mov_b32_e32 v0, v1
; GFX10-WGP-NEXT:    v_add_co_u32 v1, s5, s5, v2
; GFX10-WGP-NEXT:    v_add_co_ci_u32_e64 v0, s5, s6, v0, s5
; GFX10-WGP-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX10-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-WGP-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-WGP-NEXT:    global_store_dword v[1:2], v0, off glc slc
; GFX10-WGP-NEXT:    s_endpgm
;
...
; GFX10-CU-NEXT:    v_lshlrev_b64 v[0:1], s5, v[2:3]
; GFX10-CU-NEXT:    s_mov_b32 s5, s6
; GFX10-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-CU-NEXT:    s_mov_b32 s6, s7
; GFX10-CU-NEXT:    v_mov_b32_e32 v0, v1
; GFX10-CU-NEXT:    v_add_co_u32 v1, s5, s5, v2
; GFX10-CU-NEXT:    v_add_co_ci_u32_e64 v0, s5, s6, v0, s5
; GFX10-CU-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX10-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-CU-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-CU-NEXT:    global_store_dword v[1:2], v0, off glc slc
; GFX10-CU-NEXT:    s_endpgm
;
...
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    s_load_dword s0, s[0:1], 0x0
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s1, 0xf000
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s4, 0
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_sgpr5
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s5, s1
; SKIP-CACHE-INV-NEXT:    s_mov_b64 s[8:9], s[2:3]
; SKIP-CACHE-INV-NEXT:    s_mov_b64 s[10:11], s[4:5]
; SKIP-CACHE-INV-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v2, v0
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v3, v1
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s1, 2
; SKIP-CACHE-INV-NEXT:    v_lshl_b64 v[0:1], v[2:3], s1
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v2, s0
; SKIP-CACHE-INV-NEXT:    buffer_store_dword v2, v[0:1], s[8:11], 0 addr64 glc slc
; SKIP-CACHE-INV-NEXT:    s_endpgm
;
...
; GFX90A-NOTTGSPLIT-NEXT:    v_lshlrev_b64 v[0:1], s5, v[2:3]
; GFX90A-NOTTGSPLIT-NEXT:    s_mov_b32 s5, s6
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v2, v0
; GFX90A-NOTTGSPLIT-NEXT:    s_mov_b32 s6, s7
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v0, v1
; GFX90A-NOTTGSPLIT-NEXT:    v_add_co_u32_e64 v1, s[8:9], s5, v2
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v2, s6
; GFX90A-NOTTGSPLIT-NEXT:    v_addc_co_u32_e64 v0, s[6:7], v2, v0, s[8:9]
...
; GFX90A-NOTTGSPLIT-NEXT:    global_store_dword v[2:3], v0, off glc slc
; GFX90A-NOTTGSPLIT-NEXT:    s_endpgm
;
...
; GFX90A-TGSPLIT-NEXT:    v_lshlrev_b64 v[0:1], s5, v[2:3]
; GFX90A-TGSPLIT-NEXT:    s_mov_b32 s5, s6
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v2, v0
; GFX90A-TGSPLIT-NEXT:    s_mov_b32 s6, s7
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v0, v1
; GFX90A-TGSPLIT-NEXT:    v_add_co_u32_e64 v1, s[8:9], s5, v2
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v2, s6
; GFX90A-TGSPLIT-NEXT:    v_addc_co_u32_e64 v0, s[6:7], v2, v0, s[8:9]
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v2, v1
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v3, v0
; GFX90A-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v0, s4
; GFX90A-TGSPLIT-NEXT:    global_store_dword v[2:3], v0, off glc slc
; GFX90A-TGSPLIT-NEXT:    s_endpgm
;
...
; GFX942-NOTTGSPLIT-NEXT:    v_lshl_add_u64 v[0:1], v[2:3], s1, v[0:1]
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX942-TGSPLIT-NEXT:    v_lshl_add_u64 v[0:1], v[2:3], s1, v[0:1]
; GFX942-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-WGP-NEXT:    v_lshlrev_b64 v[0:1], s1, v[2:3]
; GFX11-WGP-NEXT:    s_mov_b32 s1, s2
; GFX11-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-WGP-NEXT:    s_mov_b32 s2, s3
; GFX11-WGP-NEXT:    v_mov_b32_e32 v0, v1
; GFX11-WGP-NEXT:    v_add_co_u32 v1, s1, s1, v2
; GFX11-WGP-NEXT:    v_add_co_ci_u32_e64 v0, s1, s2, v0, s1
; GFX11-WGP-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX11-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-WGP-NEXT:    v_mov_b32_e32 v0, s0
; GFX11-WGP-NEXT:    global_store_b32 v[1:2], v0, off glc slc dlc
; GFX11-WGP-NEXT:    s_endpgm
;
...
; GFX11-CU-NEXT:    v_lshlrev_b64 v[0:1], s1, v[2:3]
; GFX11-CU-NEXT:    s_mov_b32 s1, s2
; GFX11-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-CU-NEXT:    s_mov_b32 s2, s3
; GFX11-CU-NEXT:    v_mov_b32_e32 v0, v1
; GFX11-CU-NEXT:    v_add_co_u32 v1, s1, s1, v2
; GFX11-CU-NEXT:    v_add_co_ci_u32_e64 v0, s1, s2, v0, s1
; GFX11-CU-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX11-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-CU-NEXT:    v_mov_b32_e32 v0, s0
; GFX11-CU-NEXT:    global_store_b32 v[1:2], v0, off glc slc dlc
; GFX11-CU-NEXT:    s_endpgm
;
...
; GFX12-WGP-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-WGP-NEXT:    v_lshlrev_b64_e64 v[0:1], s1, v[2:3]
; GFX12-WGP-NEXT:    s_mov_b32 s1, s2
; GFX12-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-WGP-NEXT:    s_mov_b32 s2, s3
; GFX12-WGP-NEXT:    v_mov_b32_e32 v0, v1
; GFX12-WGP-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-WGP-NEXT:    v_add_co_u32 v1, s1, s1, v2
; GFX12-WGP-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-WGP-NEXT:    v_add_co_ci_u32_e64 v0, s1, s2, v0, s1
; GFX12-WGP-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX12-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-WGP-NEXT:    s_wait_kmcnt 0x0
; GFX12-WGP-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-WGP-NEXT:    global_store_b32 v[1:2], v0, off th:TH_STORE_NT
; GFX12-WGP-NEXT:    s_endpgm
;
...
; GFX12-CU-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-CU-NEXT:    v_lshlrev_b64_e64 v[0:1], s1, v[2:3]
; GFX12-CU-NEXT:    s_mov_b32 s1, s2
; GFX12-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-CU-NEXT:    s_mov_b32 s2, s3
; GFX12-CU-NEXT:    v_mov_b32_e32 v0, v1
; GFX12-CU-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-CU-NEXT:    v_add_co_u32 v1, s1, s1, v2
; GFX12-CU-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-CU-NEXT:    v_add_co_ci_u32_e64 v0, s1, s2, v0, s1
; GFX12-CU-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX12-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-CU-NEXT:    s_wait_kmcnt 0x0
; GFX12-CU-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-CU-NEXT:    global_store_b32 v[1:2], v0, off th:TH_STORE_NT
; GFX12-CU-NEXT:    s_endpgm
;
...
; GFX6-NEXT:    s_mov_b32 s5, 0x100f000
; GFX6-NEXT:    s_mov_b32 s9, -1
; GFX6-NEXT:    s_mov_b32 s12, s4
; GFX6-NEXT:    s_mov_b32 s13, s8
; GFX6-NEXT:    s_mov_b32 s14, s9
; GFX6-NEXT:    s_mov_b32 s15, s5
; GFX6-NEXT:    s_mov_b32 s4, s7
; GFX6-NEXT:    ; kill: def $sgpr6 killed $sgpr6 killed $sgpr6_sgpr7
; GFX6-NEXT:    s_mov_b32 s16, s6
; GFX6-NEXT:    s_mov_b32 s17, s4
; GFX6-NEXT:    s_mov_b32 s18, s9
; GFX6-NEXT:    s_mov_b32 s19, s5
; GFX6-NEXT:    buffer_load_dword v0, off, s[12:15], 0 glc
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    buffer_store_dword v0, off, s[16:19], 0
; GFX6-NEXT:    s_endpgm
;
...
; GFX10-WGP-NEXT:    s_load_dwordx2 s[6:7], s[8:9], 0x8
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-WGP-NEXT:    global_load_dword v1, v0, s[4:5] glc dlc
; GFX10-WGP-NEXT:    s_waitcnt vmcnt(0)
; GFX10-WGP-NEXT:    global_store_dword v0, v1, s[6:7]
; GFX10-WGP-NEXT:    s_endpgm
;
...
; GFX10-CU-NEXT:    s_load_dwordx2 s[6:7], s[8:9], 0x8
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-CU-NEXT:    global_load_dword v1, v0, s[4:5] glc dlc
; GFX10-CU-NEXT:    s_waitcnt vmcnt(0)
; GFX10-CU-NEXT:    global_store_dword v0, v1, s[6:7]
; GFX10-CU-NEXT:    s_endpgm
;
...
; SKIP-CACHE-INV-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x2
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s4, s1
...
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s9, s4
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s10, s5
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s11, s1
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s0, s3
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr2 killed $sgpr2 killed $sgpr2_sgpr3
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s12, s2
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s13, s0
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s14, s5
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s15, s1
; SKIP-CACHE-INV-NEXT:    buffer_load_dword v0, off, s[8:11], 0 glc
; SKIP-CACHE-INV-NEXT:    s_waitcnt vmcnt(0)
; SKIP-CACHE-INV-NEXT:    buffer_store_dword v0, off, s[12:15], 0
; SKIP-CACHE-INV-NEXT:    s_endpgm
;
...
; GFX90A-NOTTGSPLIT-NEXT:    s_load_dwordx2 s[6:7], s[8:9], 0x8
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NOTTGSPLIT-NEXT:    global_load_dword v1, v0, s[4:5] glc
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-NOTTGSPLIT-NEXT:    global_store_dword v0, v1, s[6:7]
; GFX90A-NOTTGSPLIT-NEXT:    s_endpgm
;
