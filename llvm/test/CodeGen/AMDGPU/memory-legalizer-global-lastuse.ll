...
;
; GFX13-LABEL: global_last_use_load_0:
; GFX13:       ; %bb.0: ; %entry
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_load_b32 s0, s[0:1], 0x0
; GFX13-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    v_lshlrev_b64_e64 v[2:3], s4, v[3:4]
; GFX12-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    v_add_co_ci_u32_e64 v2, s0, s0, v2, s1
; GFX12-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-NEXT:    v_mov_b32_e32 v4, v2
; GFX12-NEXT:    global_load_b32 v0, v[3:4], off th:TH_LOAD_LU
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_load_b32 v0, v0, s[0:1] scale_offset th:TH_LOAD_LU
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    global_store_b32 v1, v0, s[2:3]
; GFX1250-NEXT:    s_endpgm
;
; GFX13-LABEL: global_last_use_load_1:
; GFX13:       ; %bb.0: ; %entry
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    global_load_b32 v0, v0, s[0:1] scale_offset th:TH_LOAD_LU
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_load_b32 v1, v0, s[0:1] th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    global_store_b32 v0, v1, s[2:3]
; GFX1250-NEXT:    s_endpgm
;
; GFX13-LABEL: global_last_use_and_volatile_load:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8 nv
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    global_load_b32 v1, v0, s[0:1] th:TH_LOAD_BYPASS scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_endpgm
;
; GFX13-LABEL: global_last_use_and_nontemporal_load:
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX13-NEXT:    s_wait_kmcnt 0x0
