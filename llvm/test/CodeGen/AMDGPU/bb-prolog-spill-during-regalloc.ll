...
define i32 @prolog_spill(i32 %arg0, i32 %arg1, i32 %arg2) {
  ...
  ; REGALLOC-NEXT: {{  $}}
  ; REGALLOC-NEXT:   renamable $vgpr2 = COPY killed $vgpr2
  ; REGALLOC-NEXT:   SI_SPILL_V32_SAVE $vgpr2, %stack.3, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.3, addrspace 5)
  ; REGALLOC-NEXT:   renamable $vgpr1 = COPY killed $vgpr1
  ; REGALLOC-NEXT:   SI_SPILL_V32_SAVE $vgpr1, %stack.4, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.4, addrspace 5)
  ; REGALLOC-NEXT:   renamable $vgpr0 = COPY killed $vgpr0
  ...
  ; REGALLOC-NEXT:   $vgpr63 = SI_SPILL_S32_TO_VGPR killed $sgpr6, 0, $vgpr63, implicit-def $sgpr6_sgpr7, implicit killed $sgpr6_sgpr7
  ; REGALLOC-NEXT:   SI_SPILL_WWM_V32_SAVE $vgpr63, %stack.2, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.2, addrspace 5)
  ...
  ; REGALLOC-NEXT:   renamable $vgpr1 = COPY renamable $vgpr0
  ; REGALLOC-NEXT:   SI_SPILL_V32_SAVE $vgpr1, %stack.6, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.6, addrspace 5)
  ; REGALLOC-NEXT:   renamable $sgpr4_sgpr5 = S_AND_B64 $exec, killed renamable $sgpr4_sgpr5, implicit-def dead $scc
  ; REGALLOC-NEXT:   $vgpr63 = SI_SPILL_S32_TO_VGPR killed $sgpr4, 2, $vgpr63, implicit-def $sgpr4_sgpr5, implicit killed $sgpr4_sgpr5
  ; REGALLOC-NEXT:   SI_SPILL_WWM_V32_SAVE $vgpr63, %stack.2, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.2, addrspace 5)
  ...
  ; REGALLOC-NEXT:   $vgpr1 = SI_SPILL_V32_RESTORE %stack.4, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.4, addrspace 5)
  ; REGALLOC-NEXT:   renamable $vgpr0 = V_ADD_U32_e64 $vgpr1, killed $sgpr4, 0, implicit $exec
  ; REGALLOC-NEXT:   SI_SPILL_V32_SAVE $vgpr0, %stack.6, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.6, addrspace 5)
  ...
  ; REGALLOC-NEXT:   $vgpr2 = SI_SPILL_V32_RESTORE %stack.3, $sgpr32, 0, implicit $exec :: (load (s32) from %stack.3, addrspace 5)
  ; REGALLOC-NEXT:   renamable $vgpr0 = V_ADD_U32_e64 $vgpr2, killed $sgpr4, 0, implicit $exec
  ; REGALLOC-NEXT:   SI_SPILL_V32_SAVE killed $vgpr0, %stack.5, $sgpr32, 0, implicit $exec :: (store (s32) into %stack.5, addrspace 5)
  ...
  ; REGALLOC-NEXT:   renamable $vgpr0 = V_LSHL_ADD_U32_e64 killed $vgpr0, 2, killed $vgpr0, implicit $exec
