...
; GFX12-NEXT:    flat_load_b32 v0, v[0:1] th:TH_LOAD_LU
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    flat_load_b32 v1, v0, s[0:1] th:TH_LOAD_LU
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX13-NEXT:    s_load_b64 s[2:3], s[4:5], 0x8 nv
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    flat_load_b32 v1, v0, s[0:1] th:TH_LOAD_LU
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    flat_store_b32 v0, v1, s[2:3]
; GFX13-NEXT:    s_endpgm
entry:
...
; GFX12:       ; %bb.0: ; %entry
; GFX12-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX12-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX12-NEXT:    s_wait_kmcnt 0x0
; GFX12-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX12-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    v_and_b32_e64 v0, v0, s4
; GFX12-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX12-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-NEXT:    v_mov_b32_e32 v3, v1
; GFX12-NEXT:    s_mov_b32 s4, 2
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_lshlrev_b64_e64 v[0:1], s4, v[2:3]
; GFX12-NEXT:    s_wait_kmcnt 0x0
...
; GFX12-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-NEXT:    v_add_co_u32 v1, s1, s4, v2
; GFX12-NEXT:    v_add_co_ci_u32_e64 v0, s0, s0, v0, s1
; GFX12-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX12-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-NEXT:    flat_load_b32 v0, v[1:2] th:TH_LOAD_LU
; GFX12-NEXT:    v_mov_b32_e32 v1, s2
; GFX12-NEXT:    v_mov_b32_e32 v2, s3
; GFX12-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-NEXT:    flat_store_b32 v[1:2], v0
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    flat_load_b32 v0, v0, s[0:1] scale_offset th:TH_LOAD_LU
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
...
; GFX13:       ; %bb.0: ; %entry
; GFX13-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8 nv
; GFX13-NEXT:    s_wait_kmcnt 0x0
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    flat_load_b32 v0, v0, s[0:1] scale_offset th:TH_LOAD_LU
; GFX13-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX13-NEXT:    flat_store_b32 v1, v0, s[2:3]
; GFX13-NEXT:    s_endpgm
entry:
...
; GFX12-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-NEXT:    v_mov_b32_e32 v1, s1
; GFX12-NEXT:    flat_load_b32 v0, v[0:1] th:TH_LOAD_BYPASS scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    flat_load_b32 v1, v0, s[0:1] th:TH_LOAD_BYPASS scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    flat_store_b32 v0, v1, s[2:3]
; GFX1250-NEXT:    s_endpgm
;
...
; GFX13-NEXT:    s_wait_kmcnt 0x0
; GFX13-NEXT:    flat_load_b32 v1, v0, s[0:1] th:TH_LOAD_BYPASS scope:SCOPE_SYS
