...
; RUN: llc %s -o - -mtriple=amdgpu9.00 | FileCheck --check-prefix=NOHSA-TRAP-GFX900 %s
; RUN: llc %s -o - -mtriple=amdgpu8.03-amd-amdhsa | FileCheck --check-prefix=HSA-TRAP-GFX803 %s
; RUN: llc %s -o - -mtriple=amdgpu9.00-amd-amdhsa | FileCheck --check-prefix=HSA-TRAP-GFX900 %s
; RUN: llc %s -o - -mtriple=amdgpu9.00-amd-amdhsa -mattr=-trap-handler | FileCheck --check-prefix=HSA-NOTRAP-GFX900 %s
; RUN: llc %s -o - -mtriple=amdgpu11.00-amd-amdhsa | FileCheck --check-prefix=HSA-TRAP-GFX1100 %s
; RUN: llc %s -o - -O0 -mtriple=amdgpu11.00-amd-amdhsa | FileCheck --check-prefix=HSA-TRAP-GFX1100-O0 %s
...
; HSA-TRAP-GFX1100-O0-NEXT:    scratch_store_b32 off, v2, off ; 4-byte Folded Spill
; HSA-TRAP-GFX1100-O0-NEXT:    s_mov_b32 exec_lo, s6
; HSA-TRAP-GFX1100-O0-NEXT:    global_load_b32 v1, v0, s[0:1] glc dlc
; HSA-TRAP-GFX1100-O0-NEXT:    s_waitcnt vmcnt(0)
; HSA-TRAP-GFX1100-O0-NEXT:    scratch_store_b32 off, v1, off offset:8 ; 4-byte Folded Spill
