...
; GFX1250-NEXT:    ds_store_b32 v2, v1
; GFX1250-NEXT:    v_mov_b32_e32 v1, 3
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_mov_b32 s7, s9
; GFX1250-NEXT:    s_and_b32 s8, s3, exec_lo
; GFX1250-NEXT:    s_cselect_b32 s6, s7, s6
; GFX1250-NEXT:    ; kill: def $sgpr4 killed $sgpr4 killed $sgpr4_sgpr5
; GFX1250-NEXT:    s_and_b32 s3, s3, exec_lo
...
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_load_b32 s0, s[4:5], 0x10 nv
; GFX1250-NEXT:    v_mov_b32_e32 v0, 0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX1250-NEXT:    s_load_b64 s[2:3], s[4:5], 0x8 nv
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_load_b32 s4, s[4:5], 0x10 nv
; GFX1250-NEXT:    v_mov_b32_e32 v1, 1
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    global_wb scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_or_saveexec_b32 s3, -1
...
; GFX1250-NEXT:    s_cmp_eq_u32 s2, s0
...
; GFX1250-NEXT:    ; implicit-def: $vgpr2 : SGPR spill to VGPR lane
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_writelane_b32 v2, s0, 0
; GFX1250-NEXT:    s_or_saveexec_b32 s6, -1
; GFX1250-NEXT:    scratch_store_b32 off, v2, off nv ; 4-byte Folded Spill
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_mov_b32 exec_lo, s6
; GFX1250-NEXT:    v_writelane_b32 v2, s1, 1
; GFX1250-NEXT:    s_or_saveexec_b32 s6, -1
; GFX1250-NEXT:    scratch_store_b32 off, v2, off nv ; 4-byte Folded Spill
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_mov_b32 exec_lo, s6
; GFX1250-NEXT:    s_mov_b32 s3, 0
; GFX1250-NEXT:    v_writelane_b32 v2, s2, 2
; GFX1250-NEXT:    s_or_saveexec_b32 s6, -1
; GFX1250-NEXT:    scratch_store_b32 off, v2, off nv ; 4-byte Folded Spill
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_mov_b32 exec_lo, s6
; GFX1250-NEXT:    v_writelane_b32 v2, s3, 3
; GFX1250-NEXT:    s_or_saveexec_b32 s6, -1
; GFX1250-NEXT:    scratch_store_b32 off, v2, off nv ; 4-byte Folded Spill
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_mov_b32 exec_lo, s6
...
; GFX1250-NEXT:    v_readlane_b32 s2, v2, 2
; GFX1250-NEXT:    s_cmp_ge_u32 s1, s2
; GFX1250-NEXT:    s_cselect_b32 s2, -1, 0
; GFX1250-NEXT:    s_mov_b32 s3, -1
; GFX1250-NEXT:    s_xor_b32 s2, s2, s3
; GFX1250-NEXT:    s_and_b32 vcc_lo, exec_lo, s2
; GFX1250-NEXT:    s_mov_b32 s0, s1
...
; GFX1250-NEXT:    s_cmp_lg_u32 s2, s1
...
; GFX1250-NEXT:    s_xor_b32 s0, s2, s0
; GFX1250-NEXT:    s_and_b32 vcc_lo, exec_lo, s0
