...
; GCN_DBG-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GCN_DBG-NEXT:    buffer_store_dword v2, off, s[12:15], 0 ; 4-byte Folded Spill
; GCN_DBG-NEXT:    s_mov_b64 exec, s[8:9]
; GCN_DBG-NEXT:    s_load_dword s1, s[4:5], 0xa
; GCN_DBG-NEXT:    s_mov_b32 s2, 0
; GCN_DBG-NEXT:    s_mov_b32 s3, -1
; GCN_DBG-NEXT:    s_waitcnt lgkmcnt(0)
; GCN_DBG-NEXT:    s_cmp_eq_u32 s1, s3
; GCN_DBG-NEXT:    s_cselect_b64 s[4:5], -1, 0
; GCN_DBG-NEXT:    s_mov_b64 s[6:7], -1
; GCN_DBG-NEXT:    s_xor_b64 s[4:5], s[4:5], s[6:7]
; GCN_DBG-NEXT:    s_and_b64 vcc, exec, s[4:5]
...
; GCN_DBG-NEXT:    s_mov_b32 s0, 32
; GCN_DBG-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GCN_DBG-NEXT:    s_waitcnt expcnt(0)
; GCN_DBG-NEXT:    buffer_load_dword v2, off, s[12:15], 0 ; 4-byte Folded Reload
; GCN_DBG-NEXT:    s_mov_b64 exec, s[8:9]
; GCN_DBG-NEXT:    s_waitcnt vmcnt(0)
; GCN_DBG-NEXT:    v_readlane_b32 s1, v2, 1
; GCN_DBG-NEXT:    s_mov_b32 s2, s1
; GCN_DBG-NEXT:    s_add_i32 s0, s2, s0
; GCN_DBG-NEXT:    s_mov_b32 s3, 2
; GCN_DBG-NEXT:    s_lshl_b32 s0, s0, s3
; GCN_DBG-NEXT:    v_readlane_b32 s3, v2, 0
; GCN_DBG-NEXT:    s_add_i32 s0, s3, s0
; GCN_DBG-NEXT:    s_mov_b32 m0, -1
; GCN_DBG-NEXT:    v_mov_b32_e32 v0, s0
; GCN_DBG-NEXT:    ds_read_b32 v0, v0
; GCN_DBG-NEXT:    s_mov_b32 s3, 1.0
; GCN_DBG-NEXT:    s_waitcnt lgkmcnt(0)
; GCN_DBG-NEXT:    v_add_f32_e64 v0, v0, s3
; GCN_DBG-NEXT:    s_mov_b32 m0, -1
; GCN_DBG-NEXT:    v_mov_b32_e32 v1, s0
; GCN_DBG-NEXT:    ds_write_b32 v1, v0
; GCN_DBG-NEXT:    s_mov_b32 s0, 1
; GCN_DBG-NEXT:    s_add_i32 s0, s2, s0
; GCN_DBG-NEXT:    s_mov_b64 s[2:3], -1
; GCN_DBG-NEXT:    s_and_b64 vcc, exec, s[2:3]
; GCN_DBG-NEXT:    s_mov_b32 s1, s0
; GCN_DBG-NEXT:    v_writelane_b32 v2, s1, 1
; GCN_DBG-NEXT:    s_or_saveexec_b64 s[8:9], -1
; GCN_DBG-NEXT:    buffer_store_dword v2, off, s[12:15], 0 ; 4-byte Folded Spill
; GCN_DBG-NEXT:    s_mov_b64 exec, s[8:9]
; GCN_DBG-NEXT:    s_cbranch_vccnz .LBB0_2
...
; GCN_DBG-NEXT:    s_waitcnt lgkmcnt(0)
; GCN_DBG-NEXT:    v_readfirstlane_b32 s1, v0
; GCN_DBG-NEXT:    s_and_b32 s1, 1, s1
...
; GCN_DBG-NEXT:    s_mov_b32 s1, 0
; GCN_DBG-NEXT:    s_waitcnt expcnt(0)
; GCN_DBG-NEXT:    v_writelane_b32 v2, s1, 3
; GCN_DBG-NEXT:    s_or_saveexec_b64 s[6:7], -1
; GCN_DBG-NEXT:    buffer_store_dword v2, off, s[12:15], 0 ; 4-byte Folded Spill
; GCN_DBG-NEXT:    s_mov_b64 exec, s[6:7]
...
; GCN_DBG-NEXT:    s_mov_b64 exec, s[6:7]
; GCN_DBG-NEXT:    s_waitcnt vmcnt(0)
; GCN_DBG-NEXT:    v_readlane_b32 s1, v2, 3
; GCN_DBG-NEXT:    s_mov_b32 s2, s1
; GCN_DBG-NEXT:    s_add_i32 s0, s2, s0
; GCN_DBG-NEXT:    s_mov_b32 s3, 2
; GCN_DBG-NEXT:    s_lshl_b32 s0, s0, s3
