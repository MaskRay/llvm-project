...
; GFX1250-NEXT:    s_mov_b32 s6, s0
; GFX1250-NEXT:    s_mov_b32 s7, s1
; GFX1250-NEXT:    s_mov_b32 s0, s7
; GFX1250-NEXT:    s_mov_b32 s1, s6
; GFX1250-NEXT:    s_mov_b32 s8, s1
; GFX1250-NEXT:    s_mov_b32 s9, s0
; GFX1250-NEXT:    s_mov_b32 s10, s3
; GFX1250-NEXT:    s_mov_b32 s11, s2
; GFX1250-NEXT:    ; kill: def $sgpr0 killed $sgpr16
; GFX1250-NEXT:    v_mov_b32_e32 v1, s16
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_atomic_add_u32 v0, v1, s[8:11], null offen
...
; GFX1250-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_atomic_add_u32 v0, v1, s[8:11], null offen th:TH_ATOMIC_RETURN
; GFX1250-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
...
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    ; kill: def $vgpr1 killed $vgpr1 killed $exec
; GFX1250-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_atomic_pk_add_f16 v0, v1, s[4:7], s16 offen
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_atomic_pk_add_f16 v0, v1, s[4:7], s16 offen th:TH_ATOMIC_RETURN
; GFX1250-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %ret = call <2 x half> @llvm.amdgcn.raw.buffer.atomic.fadd.v2f16(<2 x half> %val, <4 x i32> %rsrc, i32 %voffset, i32 %soffset, i32 0)
...
; GFX1250:       ; %bb.0:
; GFX1250-NEXT:    ; kill: def $vgpr2 killed $vgpr2 killed $exec
; GFX1250-NEXT:    ; kill: def $vgpr1 killed $vgpr1 killed $exec
; GFX1250-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_atomic_pk_add_f16 v0, v[4:5], s[4:7], s16 idxen offen th:TH_ATOMIC_RETURN
; GFX1250-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    v_mov_b32_e32 v5, v2
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_atomic_pk_add_f16 v0, v[4:5], s[4:7], s16 idxen offen
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
  %orig = call <2 x half> @llvm.amdgcn.struct.buffer.atomic.fadd.v2f16(<2 x half> %val, <4 x i32> %rsrc, i32 %vindex, i32 %voffset, i32 %soffset, i32 0)
  ret void
}
...
; GFX1250-NEXT:    s_mov_b32 s7, s3
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_store_b32 v0, off, s[4:7], null scope:SCOPE_SYS
...
; GFX1250-NEXT:    buffer_store_b32 v0, v1, s[4:7], null idxen
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    v_mov_b32_e32 v1, 0
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_store_b32 v0, v1, s[4:7], null idxen scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    buffer_load_b32 v0, v0, s[4:7], null idxen
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    ; kill: def $sgpr0 killed $sgpr16
; GFX1250-NEXT:    v_mov_b32_e32 v1, s16
; GFX1250-NEXT:    buffer_store_b32 v0, v1, s[8:11], null offen
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    v_mov_b32_e32 v1, s16
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_store_b32 v0, v1, s[8:11], null offen scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    buffer_load_b32 v0, v0, s[8:11], null offen
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
...
; GFX1250-NEXT:    v_mov_b32_e32 v0, s16
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    buffer_load_b32 v0, v0, s[8:11], null offen scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
; GFX1250-NEXT:    s_set_pc_i64 s[30:31]
