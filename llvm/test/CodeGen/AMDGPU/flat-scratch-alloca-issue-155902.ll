...
; GFX950:       ; %bb.0: ; %bb
; GFX950-NEXT:    s_mov_b32 s0, 0x4008
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x188
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x180
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x178
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x170
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x168
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x160
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x158
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x150
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x148
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x140
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x138
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x130
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x128
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x120
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x118
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x110
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x108
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x100
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xf8
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xf0
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xe8
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xe0
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xd8
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xd0
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xc8
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xc0
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xb8
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xb0
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xa8
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xa0
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x98
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x90
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x88
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x80
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x78
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x70
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x68
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x60
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x58
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x50
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x48
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x40
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x0
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x8
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x10
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x18
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x20
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x28
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x30
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x38
; GFX950-NEXT:    s_waitcnt lgkmcnt(0)
; GFX950-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x0
; GFX950-NEXT:    s_load_dwordx2 s[6:7], s[4:5], 0x8
; GFX950-NEXT:    s_load_dwordx2 s[8:9], s[4:5], 0x10
; GFX950-NEXT:    s_load_dwordx2 s[10:11], s[4:5], 0x18
; GFX950-NEXT:    s_load_dwordx2 s[12:13], s[4:5], 0x20
; GFX950-NEXT:    s_load_dwordx2 s[14:15], s[4:5], 0x28
; GFX950-NEXT:    s_load_dwordx2 s[16:17], s[4:5], 0x30
; GFX950-NEXT:    s_load_dwordx2 s[18:19], s[4:5], 0x38
; GFX950-NEXT:    s_load_dwordx2 s[20:21], s[4:5], 0x40
; GFX950-NEXT:    s_load_dwordx2 s[22:23], s[4:5], 0x48
; GFX950-NEXT:    s_load_dwordx2 s[24:25], s[4:5], 0x50
; GFX950-NEXT:    s_load_dwordx2 s[26:27], s[4:5], 0x58
; GFX950-NEXT:    s_load_dwordx2 s[28:29], s[4:5], 0x60
; GFX950-NEXT:    s_load_dwordx2 s[30:31], s[4:5], 0x68
; GFX950-NEXT:    s_load_dwordx2 s[34:35], s[4:5], 0x70
; GFX950-NEXT:    s_load_dwordx2 s[36:37], s[4:5], 0x78
; GFX950-NEXT:    s_load_dwordx2 s[38:39], s[4:5], 0x80
; GFX950-NEXT:    s_load_dwordx2 s[40:41], s[4:5], 0x88
; GFX950-NEXT:    s_load_dwordx2 s[42:43], s[4:5], 0x90
; GFX950-NEXT:    s_load_dwordx2 s[44:45], s[4:5], 0x98
; GFX950-NEXT:    s_load_dwordx2 s[46:47], s[4:5], 0xa0
; GFX950-NEXT:    s_load_dwordx2 s[48:49], s[4:5], 0xa8
; GFX950-NEXT:    s_load_dwordx2 s[50:51], s[4:5], 0xb0
; GFX950-NEXT:    s_load_dwordx2 s[52:53], s[4:5], 0xb8
; GFX950-NEXT:    s_load_dwordx2 s[54:55], s[4:5], 0xc0
; GFX950-NEXT:    s_load_dwordx2 s[56:57], s[4:5], 0xc8
; GFX950-NEXT:    s_load_dwordx2 s[58:59], s[4:5], 0xd0
; GFX950-NEXT:    s_load_dwordx2 s[60:61], s[4:5], 0xd8
; GFX950-NEXT:    s_load_dwordx2 s[62:63], s[4:5], 0xe0
; GFX950-NEXT:    s_load_dwordx2 s[64:65], s[4:5], 0xe8
; GFX950-NEXT:    s_load_dwordx2 s[66:67], s[4:5], 0xf0
; GFX950-NEXT:    s_load_dwordx2 s[68:69], s[4:5], 0xf8
; GFX950-NEXT:    s_load_dwordx2 s[70:71], s[4:5], 0x100
; GFX950-NEXT:    s_load_dwordx2 s[72:73], s[4:5], 0x108
; GFX950-NEXT:    s_load_dwordx2 s[74:75], s[4:5], 0x110
; GFX950-NEXT:    s_load_dwordx2 s[76:77], s[4:5], 0x118
; GFX950-NEXT:    s_load_dwordx2 s[78:79], s[4:5], 0x120
; GFX950-NEXT:    s_load_dwordx2 s[80:81], s[4:5], 0x128
; GFX950-NEXT:    s_load_dwordx2 s[82:83], s[4:5], 0x130
; GFX950-NEXT:    s_load_dwordx2 s[84:85], s[4:5], 0x138
; GFX950-NEXT:    s_load_dwordx2 s[86:87], s[4:5], 0x140
; GFX950-NEXT:    s_load_dwordx2 s[88:89], s[4:5], 0x148
; GFX950-NEXT:    s_load_dwordx2 s[90:91], s[4:5], 0x150
; GFX950-NEXT:    s_load_dwordx2 s[92:93], s[4:5], 0x158
; GFX950-NEXT:    s_load_dwordx2 s[94:95], s[4:5], 0x160
; GFX950-NEXT:    s_load_dwordx2 s[96:97], s[4:5], 0x168
; GFX950-NEXT:    s_load_dwordx2 s[98:99], s[4:5], 0x170
; GFX950-NEXT:    s_load_dwordx2 vcc, s[4:5], 0x178
; GFX950-NEXT:    ; implicit-def: $vgpr2 : SGPR spill to VGPR lane
; GFX950-NEXT:    v_writelane_b32 v2, s0, 0
; GFX950-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x180
; GFX950-NEXT:    s_nop 0
; GFX950-NEXT:    s_load_dwordx2 s[4:5], s[4:5], 0x188
; GFX950-NEXT:    v_mov_b64_e32 v[0:1], 0
; GFX950-NEXT:    v_readlane_b32 s33, v2, 0
; GFX950-NEXT:    s_nop 4
...
; GFX950-NEXT:    s_nop 0
; GFX950-NEXT:    v_readlane_b32 s4, v2, 0
; GFX950-NEXT:    s_nop 4
; GFX950-NEXT:    scratch_store_dwordx2 off, v[0:1], s4 offset:8
; GFX950-NEXT:    scratch_store_dwordx2 off, v[0:1], s4
; GFX950-NEXT:    v_mov_b64_e32 v[0:1], 0x384
; GFX950-NEXT:    scratch_store_dwordx2 off, v[0:1], s4 offset:16
; GFX950-NEXT:    v_mov_b64_e32 v[0:1], s[2:3]
; GFX950-NEXT:    scratch_store_dwordx2 off, v[0:1], s4 offset:16
; GFX950-NEXT:    v_mov_b64_e32 v[0:1], s[6:7]
; GFX950-NEXT:    scratch_store_dwordx2 off, v[0:1], s4 offset:16
