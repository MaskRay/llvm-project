...
; GFX12-WGP-NEXT:    s_wait_kmcnt 0x0
; GFX12-WGP-NEXT:    scratch_load_b32 v1, off, s0 scope:SCOPE_SYS
...
; GFX12-CU-NEXT:    s_wait_kmcnt 0x0
; GFX12-CU-NEXT:    scratch_load_b32 v1, off, s0 scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    scratch_load_b32 v1, off, s0 scope:SCOPE_SYS
...
; GFX6-NEXT:    v_lshlrev_b32_e64 v0, s1, v0
...
; GFX10-WGP-NEXT:    buffer_load_dword v0, v0, s[0:3], 0 offen glc dlc
; GFX10-WGP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-CU-NEXT:    buffer_load_dword v0, v0, s[0:3], 0 offen glc dlc
; GFX10-CU-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-WGP-NEXT:    s_wait_kmcnt 0x0
; GFX12-WGP-NEXT:    scratch_load_b32 v0, v0, s0 scope:SCOPE_SYS
; GFX12-WGP-NEXT:    s_wait_bvhcnt 0x0
; GFX12-WGP-NEXT:    s_wait_samplecnt 0x0
; GFX12-WGP-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-CU-NEXT:    s_wait_kmcnt 0x0
; GFX12-CU-NEXT:    scratch_load_b32 v0, v0, s0 scope:SCOPE_SYS
; GFX12-CU-NEXT:    s_wait_bvhcnt 0x0
; GFX12-CU-NEXT:    s_wait_samplecnt 0x0
; GFX12-CU-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    scratch_load_b32 v0, v0, s0 scale_offset scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    scratch_store_b32 off, v0, s2 scope:SCOPE_SYS
...
; GFX6-NEXT:    s_mov_b32 s1, 2
; GFX6-NEXT:    v_lshlrev_b32_e64 v0, s1, v0
; GFX6-NEXT:    v_add_i32_e64 v0, s[2:3], s2, v0
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-WGP-NEXT:    v_mov_b32_e32 v1, s4
; GFX10-WGP-NEXT:    buffer_store_dword v1, v0, s[0:3], 0 offen
; GFX10-WGP-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-WGP-NEXT:    s_endpgm
;
...
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-CU-NEXT:    v_mov_b32_e32 v1, s4
; GFX10-CU-NEXT:    buffer_store_dword v1, v0, s[0:3], 0 offen
; GFX10-CU-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-CU-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    scratch_store_b32 v0, v1, s2 scale_offset scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(5) %out) {
entry:
