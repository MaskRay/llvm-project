...
; W64-O0-NEXT:    v_mov_b32_e32 v3, v5
; W64-O0-NEXT:    v_mov_b32_e32 v5, v0
; W64-O0-NEXT:    v_mov_b32_e32 v6, v1
; W64-O0-NEXT:    v_mov_b32_e32 v0, v6
; W64-O0-NEXT:    v_mov_b32_e32 v1, v5
...
; W64-O0-NEXT:    ; implicit-def: $vgpr9 : SGPR spill to VGPR lane
; W64-O0-NEXT:    v_writelane_b32 v9, s4, 0
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b64 s[6:7], exec
; W64-O0-NEXT:    v_writelane_b32 v9, s6, 1
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v9, s7, 2
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
...
; W64-O0-NEXT:    v_readfirstlane_b32 s4, v0
; W64-O0-NEXT:    s_waitcnt vmcnt(2)
; W64-O0-NEXT:    v_readfirstlane_b32 s5, v1
; W64-O0-NEXT:    s_mov_b32 s6, s4
; W64-O0-NEXT:    s_mov_b32 s7, s5
; W64-O0-NEXT:    v_cmp_eq_u64_e64 s[6:7], s[6:7], v[0:1]
; W64-O0-NEXT:    s_waitcnt vmcnt(1)
; W64-O0-NEXT:    v_readfirstlane_b32 s8, v2
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readfirstlane_b32 s9, v3
; W64-O0-NEXT:    s_mov_b32 s10, s8
; W64-O0-NEXT:    s_mov_b32 s11, s9
; W64-O0-NEXT:    v_cmp_eq_u64_e64 s[10:11], s[10:11], v[2:3]
; W64-O0-NEXT:    s_and_b64 s[6:7], s[6:7], s[10:11]
; W64-O0-NEXT:    s_mov_b32 s12, s4
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_load_dword v9, off, s[0:3], s32 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_writelane_b32 v9, s12, 3
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v9, s13, 4
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v9, s14, 5
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v9, s15, 6
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b32 s13, s5
; W64-O0-NEXT:    v_writelane_b32 v9, s12, 3
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
...
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_and_saveexec_b64 s[4:5], s[6:7]
; W64-O0-NEXT:    v_writelane_b32 v9, s4, 7
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v9, s5, 8
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v9, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v9, 3
; W64-O0-NEXT:    v_readlane_b32 s5, v9, 4
; W64-O0-NEXT:    v_readlane_b32 s6, v9, 5
; W64-O0-NEXT:    v_readlane_b32 s7, v9, 6
; W64-O0-NEXT:    v_readlane_b32 s8, v9, 0
; W64-O0-NEXT:    buffer_load_dword v4, off, s[0:3], s32 offset:4 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    s_nop 2
; W64-O0-NEXT:    buffer_load_format_x v0, v4, s[4:7], s8 idxen
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:24 ; 4-byte Folded Spill
; W64-O0-NEXT:    v_readlane_b32 s4, v9, 7
; W64-O0-NEXT:    v_readlane_b32 s5, v9, 8
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v9, 1
; W64-O0-NEXT:    v_readlane_b32 s5, v9, 2
; W64-O0-NEXT:    s_mov_b64 exec, s[4:5]
; W64-O0-NEXT:    buffer_load_dword v0, off, s[0:3], s32 offset:24 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; W64-O0-NEXT:    buffer_load_dword v9, off, s[0:3], s32 offset:28 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_mov_b64 exec, s[4:5]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
...
; W64-O0-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; W64-O0-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 offset:64 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[4:5]
...
; W64-O0-NEXT:    v_mov_b32_e32 v5, v13
; W64-O0-NEXT:    v_mov_b32_e32 v13, v5
; W64-O0-NEXT:    buffer_store_dword v13, off, s[0:3], s32 offset:8 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v14, off, s[0:3], s32 offset:12 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v15, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v16, off, s[0:3], s32 offset:20 ; 4-byte Folded Spill
...
; W64-O0-NEXT:    v_mov_b32_e32 v5, v1
; W64-O0-NEXT:    v_mov_b32_e32 v0, v5
...
; W64-O0-NEXT:    buffer_store_dword v6, off, s[0:3], s32 offset:32 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v7, off, s[0:3], s32 offset:36 ; 4-byte Folded Spill
; W64-O0-NEXT:    v_mov_b32_e32 v0, v11
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:40 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:44 ; 4-byte Folded Spill
; W64-O0-NEXT:    v_mov_b32_e32 v1, v12
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:40 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:44 ; 4-byte Folded Spill
; W64-O0-NEXT:    v_mov_b32_e32 v2, v9
; W64-O0-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:48 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v3, off, s[0:3], s32 offset:52 ; 4-byte Folded Spill
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b64 s[6:7], exec
; W64-O0-NEXT:    v_writelane_b32 v17, s6, 1
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v17, s7, 2
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
...
; W64-O0-NEXT:    buffer_load_dword v2, off, s[0:3], s32 offset:32 ; 4-byte Folded Reload
; W64-O0-NEXT:    buffer_load_dword v3, off, s[0:3], s32 offset:36 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_waitcnt vmcnt(3)
; W64-O0-NEXT:    v_readfirstlane_b32 s4, v0
; W64-O0-NEXT:    s_waitcnt vmcnt(2)
; W64-O0-NEXT:    v_readfirstlane_b32 s5, v1
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_writelane_b32 v17, s12, 3
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v17, s13, 4
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v17, s14, 5
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v17, s15, 6
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b32 s13, s5
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v17, 3
; W64-O0-NEXT:    v_readlane_b32 s5, v17, 4
; W64-O0-NEXT:    v_readlane_b32 s6, v17, 5
; W64-O0-NEXT:    v_readlane_b32 s7, v17, 6
; W64-O0-NEXT:    v_readlane_b32 s8, v17, 0
; W64-O0-NEXT:    buffer_load_dword v8, off, s[0:3], s32 offset:4 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    s_nop 2
; W64-O0-NEXT:    buffer_load_format_x v0, v8, s[4:7], s8 idxen
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_writelane_b32 v17, s12, 11
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v17, s13, 12
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v17, s14, 13
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v17, s15, 14
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v17, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b32 s13, s5
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v17, 11
; W64-O0-NEXT:    v_readlane_b32 s5, v17, 12
; W64-O0-NEXT:    v_readlane_b32 s6, v17, 13
; W64-O0-NEXT:    v_readlane_b32 s7, v17, 14
; W64-O0-NEXT:    v_readlane_b32 s8, v17, 0
; W64-O0-NEXT:    buffer_load_dword v8, off, s[0:3], s32 offset:4 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    s_nop 2
...
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    buffer_load_dword v0, off, s[0:3], s32 offset:40 ; 4-byte Folded Reload
...
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; W64-O0-NEXT:    buffer_load_dword v17, off, s[0:3], s32 offset:64 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_mov_b64 exec, s[4:5]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    s_setpc_b64 s[30:31]
entry:
...
; W64-O0-NEXT:    s_waitcnt vmcnt(0) expcnt(0) lgkmcnt(0)
; W64-O0-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 offset:84 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[4:5]
; W64-O0-NEXT:    ; kill: def $vgpr31 killed $vgpr31 killed $exec
; W64-O0-NEXT:    buffer_store_dword v31, off, s[0:3], s32 offset:4 ; 4-byte Folded Spill
; W64-O0-NEXT:    ; kill: def $vgpr12 killed $vgpr12 killed $exec
; W64-O0-NEXT:    ; kill: def $vgpr11 killed $vgpr11 killed $exec
; W64-O0-NEXT:    ; kill: def $vgpr7 killed $vgpr7 killed $exec
; W64-O0-NEXT:    ; kill: def $vgpr6 killed $vgpr6 killed $exec
...
; W64-O0-NEXT:    v_mov_b32_e32 v0, v9
...
; W64-O0-NEXT:    buffer_store_dword v15, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v16, off, s[0:3], s32 offset:20 ; 4-byte Folded Spill
; W64-O0-NEXT:    v_mov_b32_e32 v14, v0
; W64-O0-NEXT:    buffer_store_dword v13, off, s[0:3], s32 offset:8 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v14, off, s[0:3], s32 offset:12 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v15, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v16, off, s[0:3], s32 offset:20 ; 4-byte Folded Spill
; W64-O0-NEXT:    v_mov_b32_e32 v15, v3
; W64-O0-NEXT:    buffer_store_dword v13, off, s[0:3], s32 offset:8 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v14, off, s[0:3], s32 offset:12 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v15, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v16, off, s[0:3], s32 offset:20 ; 4-byte Folded Spill
; W64-O0-NEXT:    v_mov_b32_e32 v16, v2
; W64-O0-NEXT:    buffer_store_dword v13, off, s[0:3], s32 offset:8 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v14, off, s[0:3], s32 offset:12 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v15, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
...
; W64-O0-NEXT:    v_mov_b32_e32 v2, v4
; W64-O0-NEXT:    v_mov_b32_e32 v3, v5
; W64-O0-NEXT:    v_mov_b32_e32 v4, v11
; W64-O0-NEXT:    v_mov_b32_e32 v5, v12
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:24 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v1, off, s[0:3], s32 offset:28 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v3, off, s[0:3], s32 offset:36 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v4, off, s[0:3], s32 offset:40 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b32 s6, 0
; W64-O0-NEXT:    v_writelane_b32 v10, s6, 1
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_mov_b32_e32 v6, s4
; W64-O0-NEXT:    buffer_store_dword v6, off, s[0:3], s32 offset:48 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 s[8:9], exec
; W64-O0-NEXT:    v_writelane_b32 v10, s8, 2
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v10, s9, 3
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_writelane_b32 v10, s12, 4
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v10, s13, 5
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v10, s14, 6
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v10, s15, 7
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b32 s13, s5
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v10, 4
; W64-O0-NEXT:    v_readlane_b32 s5, v10, 5
; W64-O0-NEXT:    v_readlane_b32 s6, v10, 6
; W64-O0-NEXT:    v_readlane_b32 s7, v10, 7
; W64-O0-NEXT:    v_readlane_b32 s8, v10, 1
; W64-O0-NEXT:    buffer_load_dword v0, off, s[0:3], s32 offset:48 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    s_nop 2
; W64-O0-NEXT:    buffer_load_format_x v0, v0, s[4:7], s8 idxen
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:52 ; 4-byte Folded Spill
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v10, 2
; W64-O0-NEXT:    v_readlane_b32 s5, v10, 3
; W64-O0-NEXT:    s_mov_b64 exec, s[4:5]
; W64-O0-NEXT:    s_mov_b32 s4, 0x3ff
; W64-O0-NEXT:    buffer_load_dword v31, off, s[0:3], s32 offset:4 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_and_b32_e64 v0, v31, s4
; W64-O0-NEXT:    v_readlane_b32 s4, v10, 1
; W64-O0-NEXT:    v_cmp_eq_u32_e64 s[4:5], v0, s4
; W64-O0-NEXT:    buffer_load_dword v0, off, s[0:3], s32 offset:52 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:56 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 s[6:7], exec
; W64-O0-NEXT:    v_writelane_b32 v10, s6, 10
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v10, s7, 11
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_and_b64 s[4:5], s[6:7], s[4:5]
; W64-O0-NEXT:    s_mov_b64 exec, s[4:5]
...
; W64-O0-NEXT:    buffer_load_dword v3, off, s[0:3], s32 offset:24 ; 4-byte Folded Reload
; W64-O0-NEXT:    buffer_load_dword v4, off, s[0:3], s32 offset:28 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_mov_b32_e32 v1, v4
; W64-O0-NEXT:    v_mov_b32_e32 v4, v0
; W64-O0-NEXT:    buffer_store_dword v4, off, s[0:3], s32 offset:60 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v5, off, s[0:3], s32 offset:64 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v6, off, s[0:3], s32 offset:68 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v7, off, s[0:3], s32 offset:72 ; 4-byte Folded Spill
; W64-O0-NEXT:    v_mov_b32_e32 v5, v2
; W64-O0-NEXT:    buffer_store_dword v4, off, s[0:3], s32 offset:60 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v5, off, s[0:3], s32 offset:64 ; 4-byte Folded Spill
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_writelane_b32 v10, s4, 12
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_readlane_b32 s5, v10, 0
; W64-O0-NEXT:    v_mov_b32_e32 v0, s5
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:76 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 s[6:7], exec
; W64-O0-NEXT:    v_writelane_b32 v10, s6, 13
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v10, s7, 14
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_writelane_b32 v10, s12, 15
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v10, s13, 16
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v10, s14, 17
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v10, s15, 18
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v10, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b32 s13, s5
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v10, 15
; W64-O0-NEXT:    v_readlane_b32 s5, v10, 16
; W64-O0-NEXT:    v_readlane_b32 s6, v10, 17
; W64-O0-NEXT:    v_readlane_b32 s7, v10, 18
; W64-O0-NEXT:    v_readlane_b32 s8, v10, 12
...
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    global_store_dword v[1:2], v0, off
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    s_xor_saveexec_b64 s[4:5], -1
; W64-O0-NEXT:    buffer_load_dword v10, off, s[0:3], s32 offset:84 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_mov_b64 exec, s[4:5]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    s_setpc_b64 s[30:31]
entry:
