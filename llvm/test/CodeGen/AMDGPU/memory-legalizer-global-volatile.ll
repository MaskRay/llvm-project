...
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x9
; GFX6-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0xb
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    s_mov_b32 s4, s1
; GFX6-NEXT:    ; kill: def $sgpr0 killed $sgpr0 killed $sgpr0_sgpr1
; GFX6-NEXT:    s_mov_b32 s1, 0xf000
; GFX6-NEXT:    s_mov_b32 s5, -1
; GFX6-NEXT:    s_mov_b32 s8, s0
; GFX6-NEXT:    s_mov_b32 s9, s4
; GFX6-NEXT:    s_mov_b32 s10, s5
; GFX6-NEXT:    s_mov_b32 s11, s1
; GFX6-NEXT:    s_mov_b32 s0, s3
; GFX6-NEXT:    ; kill: def $sgpr2 killed $sgpr2 killed $sgpr2_sgpr3
; GFX6-NEXT:    s_mov_b32 s12, s2
; GFX6-NEXT:    s_mov_b32 s13, s0
; GFX6-NEXT:    s_mov_b32 s14, s5
; GFX6-NEXT:    s_mov_b32 s15, s1
...
; GFX6-NEXT:    s_mov_b64 s[2:3], s[4:5]
; GFX6-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX6-NEXT:    v_mov_b32_e32 v2, v0
; GFX6-NEXT:    v_mov_b32_e32 v3, v1
; GFX6-NEXT:    s_mov_b32 s4, 2
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[2:3], s4
...
; GFX7-NEXT:    v_mov_b32_e32 v2, v0
; GFX7-NEXT:    flat_load_dword v0, v[1:2] glc
; GFX7-NEXT:    s_waitcnt vmcnt(0)
; GFX7-NEXT:    v_mov_b32_e32 v1, s6
; GFX7-NEXT:    v_mov_b32_e32 v2, s7
; GFX7-NEXT:    flat_store_dword v[1:2], v0
...
; GFX10-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX10-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX10-WGP-NEXT:    global_load_dword v0, v[3:4], off glc dlc
; GFX10-WGP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX10-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX10-CU-NEXT:    global_load_dword v0, v[3:4], off glc dlc
; GFX10-CU-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX11-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX11-WGP-NEXT:    global_load_b32 v0, v[3:4], off glc dlc
; GFX11-WGP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX11-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX11-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX11-CU-NEXT:    global_load_b32 v0, v[3:4], off glc dlc
; GFX11-CU-NEXT:    s_waitcnt vmcnt(0)
...
; GFX12-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX12-WGP-NEXT:    global_load_b32 v0, v[3:4], off scope:SCOPE_SYS
; GFX12-WGP-NEXT:    s_wait_bvhcnt 0x0
; GFX12-WGP-NEXT:    s_wait_samplecnt 0x0
; GFX12-WGP-NEXT:    s_wait_loadcnt 0x0
...
; GFX12-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX12-CU-NEXT:    global_load_b32 v0, v[3:4], off scope:SCOPE_SYS
; GFX12-CU-NEXT:    s_wait_bvhcnt 0x0
; GFX12-CU-NEXT:    s_wait_samplecnt 0x0
; GFX12-CU-NEXT:    s_wait_loadcnt 0x0
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    global_load_b32 v0, v0, s[0:1] scale_offset scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt 0x0
...
; GFX6-NEXT:    ; kill: def $sgpr4 killed $sgpr4 def $sgpr4_sgpr5
; GFX6-NEXT:    s_mov_b32 s5, s1
; GFX6-NEXT:    s_mov_b64 s[8:9], s[2:3]
; GFX6-NEXT:    s_mov_b64 s[10:11], s[4:5]
; GFX6-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX6-NEXT:    v_mov_b32_e32 v2, v0
; GFX6-NEXT:    v_mov_b32_e32 v3, v1
; GFX6-NEXT:    s_mov_b32 s1, 2
; GFX6-NEXT:    v_lshl_b64 v[0:1], v[2:3], s1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v2, s0
; GFX6-NEXT:    buffer_store_dword v2, v[0:1], s[8:11], 0 addr64
; GFX6-NEXT:    s_waitcnt vmcnt(0)
; GFX6-NEXT:    s_endpgm
;
...
; GFX10-WGP-NEXT:    global_store_dword v[1:2], v0, off
; GFX10-WGP-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-WGP-NEXT:    s_endpgm
;
...
; GFX10-CU-NEXT:    global_store_dword v[1:2], v0, off
; GFX10-CU-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX10-CU-NEXT:    s_endpgm
;
...
; SKIP-CACHE-INV-NEXT:    buffer_store_dword v2, v[0:1], s[8:11], 0 addr64
; SKIP-CACHE-INV-NEXT:    s_waitcnt vmcnt(0)
; SKIP-CACHE-INV-NEXT:    s_endpgm
;
...
; GFX11-WGP-NEXT:    global_store_b32 v[1:2], v0, off dlc
; GFX11-WGP-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-WGP-NEXT:    s_endpgm
;
...
; GFX11-CU-NEXT:    global_store_b32 v[1:2], v0, off dlc
; GFX11-CU-NEXT:    s_waitcnt_vscnt null, 0x0
; GFX11-CU-NEXT:    s_endpgm
;
...
; GFX12-WGP-NEXT:    s_wait_kmcnt 0x0
; GFX12-WGP-NEXT:    s_wait_storecnt 0x0
; GFX12-WGP-NEXT:    global_store_b32 v[1:2], v0, off scope:SCOPE_SYS
; GFX12-WGP-NEXT:    s_wait_storecnt 0x0
; GFX12-WGP-NEXT:    s_endpgm
;
...
; GFX12-CU-NEXT:    s_wait_kmcnt 0x0
; GFX12-CU-NEXT:    s_wait_storecnt 0x0
; GFX12-CU-NEXT:    global_store_b32 v[1:2], v0, off scope:SCOPE_SYS
; GFX12-CU-NEXT:    s_wait_storecnt 0x0
; GFX12-CU-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    v_mov_b32_e32 v1, s0
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    global_store_b32 v0, v1, s[2:3] scale_offset scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_storecnt 0x0
; GFX1250-NEXT:    s_endpgm
    ptr addrspace(1) %in, ptr addrspace(1) %out) {
entry:
...
; GFX10-WGP-NEXT:    s_load_dwordx2 s[6:7], s[8:9], 0x8
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-WGP-NEXT:    global_load_dword v1, v0, s[4:5] glc
; GFX10-WGP-NEXT:    s_waitcnt vmcnt(0)
...
; GFX10-CU-NEXT:    s_load_dwordx2 s[6:7], s[8:9], 0x8
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-CU-NEXT:    global_load_dword v1, v0, s[4:5]
; GFX10-CU-NEXT:    s_waitcnt vmcnt(0)
; GFX10-CU-NEXT:    global_store_dword v0, v1, s[6:7]
; GFX10-CU-NEXT:    s_endpgm
;
...
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s14, s5
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s15, s1
; SKIP-CACHE-INV-NEXT:    buffer_load_dword v0, off, s[8:11], 0
; SKIP-CACHE-INV-NEXT:    s_waitcnt vmcnt(0)
; SKIP-CACHE-INV-NEXT:    buffer_store_dword v0, off, s[12:15], 0
; SKIP-CACHE-INV-NEXT:    s_endpgm
;
...
; GFX12-WGP-NEXT:    s_load_b64 s[2:3], s[4:5], 0x8
; GFX12-WGP-NEXT:    s_wait_kmcnt 0x0
; GFX12-WGP-NEXT:    global_load_b32 v1, v0, s[0:1] scope:SCOPE_SE
; GFX12-WGP-NEXT:    s_wait_loadcnt 0x0
...
; SKIP-CACHE-INV-NEXT:    ; kill: def $sgpr2 killed $sgpr2 killed $sgpr2_sgpr3
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s3, 0xf000
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s4, -1
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s8, s2
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s9, s1
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s10, s4
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s11, s3
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v0, s0
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    buffer_store_dword v0, off, s[8:11], 0
...
; GFX12-WGP-NEXT:    global_store_b32 v0, v1, s[2:3] scope:SCOPE_SE
; GFX12-WGP-NEXT:    s_endpgm
;
