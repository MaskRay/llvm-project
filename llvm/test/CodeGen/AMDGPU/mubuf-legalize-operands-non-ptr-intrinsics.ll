...
; W64-O0-NEXT:    buffer_store_dword v15, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v16, off, s[0:3], s32 offset:20 ; 4-byte Folded Spill
; W64-O0-NEXT:    v_mov_b32_e32 v16, v7
; W64-O0-NEXT:    buffer_store_dword v13, off, s[0:3], s32 offset:8 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_nop 0
; W64-O0-NEXT:    buffer_store_dword v14, off, s[0:3], s32 offset:12 ; 4-byte Folded Spill
; W64-O0-NEXT:    buffer_store_dword v15, off, s[0:3], s32 offset:16 ; 4-byte Folded Spill
...
; W64-O0-NEXT:    v_writelane_b32 v8, s6, 1
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_mov_b32_e32 v2, s4
; W64-O0-NEXT:    buffer_store_dword v2, off, s[0:3], s32 offset:48 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 s[8:9], exec
; W64-O0-NEXT:    v_writelane_b32 v8, s8, 2
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v8, s9, 3
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_writelane_b32 v8, s12, 4
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v8, s13, 5
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v8, s14, 6
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v8, s15, 7
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b32 s13, s5
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v8, 4
; W64-O0-NEXT:    v_readlane_b32 s5, v8, 5
; W64-O0-NEXT:    v_readlane_b32 s6, v8, 6
; W64-O0-NEXT:    v_readlane_b32 s7, v8, 7
; W64-O0-NEXT:    v_readlane_b32 s8, v8, 1
; W64-O0-NEXT:    buffer_load_dword v0, off, s[0:3], s32 offset:48 ; 4-byte Folded Reload
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    s_nop 2
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v8, 2
; W64-O0-NEXT:    v_readlane_b32 s5, v8, 3
; W64-O0-NEXT:    s_mov_b64 exec, s[4:5]
...
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:56 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 s[6:7], exec
; W64-O0-NEXT:    v_writelane_b32 v8, s6, 10
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v8, s7, 11
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_writelane_b32 v8, s4, 12
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_readlane_b32 s5, v8, 0
; W64-O0-NEXT:    v_mov_b32_e32 v0, s5
; W64-O0-NEXT:    buffer_store_dword v0, off, s[0:3], s32 offset:60 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 s[6:7], exec
; W64-O0-NEXT:    v_writelane_b32 v8, s6, 13
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v8, s7, 14
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_writelane_b32 v8, s12, 15
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v8, s13, 16
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v8, s14, 17
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    v_writelane_b32 v8, s15, 18
; W64-O0-NEXT:    s_or_saveexec_b64 s[18:19], -1
; W64-O0-NEXT:    buffer_store_dword v8, off, s[0:3], s32 ; 4-byte Folded Spill
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_mov_b32 s13, s5
...
; W64-O0-NEXT:    s_mov_b64 exec, s[18:19]
; W64-O0-NEXT:    s_waitcnt vmcnt(0)
; W64-O0-NEXT:    v_readlane_b32 s4, v8, 15
; W64-O0-NEXT:    v_readlane_b32 s5, v8, 16
; W64-O0-NEXT:    v_readlane_b32 s6, v8, 17
; W64-O0-NEXT:    v_readlane_b32 s7, v8, 18
; W64-O0-NEXT:    v_readlane_b32 s8, v8, 12
