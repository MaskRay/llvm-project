...
; GFX10-WGP-NEXT:    flat_load_dword v0, v[0:1] slc
; GFX10-WGP-NEXT:    v_mov_b32_e32 v1, s6
; GFX10-WGP-NEXT:    v_mov_b32_e32 v2, s7
; GFX10-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-WGP-NEXT:    flat_store_dword v[1:2], v0
...
; GFX10-CU-NEXT:    flat_load_dword v0, v[0:1] slc
; GFX10-CU-NEXT:    v_mov_b32_e32 v1, s6
; GFX10-CU-NEXT:    v_mov_b32_e32 v2, s7
; GFX10-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-CU-NEXT:    flat_store_dword v[1:2], v0
...
; SKIP-CACHE-INV-NEXT:    flat_store_dword v[1:2], v0
...
; GFX90A-NOTTGSPLIT-NEXT:    v_pk_mov_b32 v[2:3], s[6:7], s[6:7] op_sel:[0,1]
...
; GFX90A-TGSPLIT-NEXT:    v_pk_mov_b32 v[2:3], s[6:7], s[6:7] op_sel:[0,1]
...
; GFX942-NOTTGSPLIT-NEXT:    flat_load_dword v0, v[0:1] nt
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NOTTGSPLIT-NEXT:    flat_store_dword v[2:3], v0
...
; GFX942-TGSPLIT-NEXT:    flat_load_dword v0, v[0:1] nt
; GFX942-TGSPLIT-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-TGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX942-TGSPLIT-NEXT:    flat_store_dword v[2:3], v0
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    flat_load_b32 v1, v0, s[0:1] th:TH_LOAD_NT
...
; GFX7-NEXT:    s_add_i32 s12, s12, s17
; GFX7-NEXT:    s_lshr_b32 flat_scratch_hi, s12, 8
; GFX7-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX7-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x0
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x2
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x0
; GFX7-NEXT:    s_load_dwordx2 s[6:7], s[8:9], 0x2
; GFX7-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX7-NEXT:    v_mov_b32_e32 v2, v0
; GFX7-NEXT:    v_mov_b32_e32 v3, v1
; GFX7-NEXT:    s_mov_b32 s8, 2
; GFX7-NEXT:    v_lshl_b64 v[0:1], v[2:3], s8
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
; GFX7-NEXT:    s_mov_b32 s8, s4
; GFX7-NEXT:    v_mov_b32_e32 v2, v0
; GFX7-NEXT:    s_mov_b32 s4, s5
; GFX7-NEXT:    v_mov_b32_e32 v0, v1
; GFX7-NEXT:    v_add_i32_e64 v1, s[8:9], s8, v2
; GFX7-NEXT:    v_mov_b32_e32 v2, s4
; GFX7-NEXT:    v_addc_u32_e64 v0, s[4:5], v2, v0, s[8:9]
; GFX7-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX7-NEXT:    v_mov_b32_e32 v2, v0
; GFX7-NEXT:    flat_load_dword v0, v[1:2] glc slc
; GFX7-NEXT:    v_mov_b32_e32 v1, s6
; GFX7-NEXT:    v_mov_b32_e32 v2, s7
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    flat_store_dword v[1:2], v0
...
; GFX10-WGP-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_LO), s12
; GFX10-WGP-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_HI), s13
; GFX10-WGP-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX10-WGP-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x0
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-WGP-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x8
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-WGP-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x0
; GFX10-WGP-NEXT:    s_load_dwordx2 s[6:7], s[8:9], 0x8
; GFX10-WGP-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX10-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-WGP-NEXT:    v_mov_b32_e32 v3, v1
; GFX10-WGP-NEXT:    s_mov_b32 s8, 2
; GFX10-WGP-NEXT:    v_lshlrev_b64 v[0:1], s8, v[2:3]
; GFX10-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-WGP-NEXT:    s_mov_b32 s8, s4
; GFX10-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-WGP-NEXT:    s_mov_b32 s4, s5
; GFX10-WGP-NEXT:    v_mov_b32_e32 v0, v1
; GFX10-WGP-NEXT:    v_add_co_u32 v1, s5, s8, v2
; GFX10-WGP-NEXT:    v_add_co_ci_u32_e64 v0, s4, s4, v0, s5
; GFX10-WGP-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX10-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-WGP-NEXT:    flat_load_dword v0, v[1:2] slc
; GFX10-WGP-NEXT:    v_mov_b32_e32 v1, s6
; GFX10-WGP-NEXT:    v_mov_b32_e32 v2, s7
; GFX10-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-WGP-NEXT:    flat_store_dword v[1:2], v0
...
; GFX10-CU-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_LO), s12
; GFX10-CU-NEXT:    s_setreg_b32 hwreg(HW_REG_FLAT_SCR_HI), s13
; GFX10-CU-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX10-CU-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x0
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-CU-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x8
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-CU-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x0
; GFX10-CU-NEXT:    s_load_dwordx2 s[6:7], s[8:9], 0x8
; GFX10-CU-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX10-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-CU-NEXT:    v_mov_b32_e32 v3, v1
; GFX10-CU-NEXT:    s_mov_b32 s8, 2
; GFX10-CU-NEXT:    v_lshlrev_b64 v[0:1], s8, v[2:3]
; GFX10-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX10-CU-NEXT:    s_mov_b32 s8, s4
; GFX10-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-CU-NEXT:    s_mov_b32 s4, s5
; GFX10-CU-NEXT:    v_mov_b32_e32 v0, v1
; GFX10-CU-NEXT:    v_add_co_u32 v1, s5, s8, v2
; GFX10-CU-NEXT:    v_add_co_ci_u32_e64 v0, s4, s4, v0, s5
; GFX10-CU-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX10-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX10-CU-NEXT:    flat_load_dword v0, v[1:2] slc
; GFX10-CU-NEXT:    v_mov_b32_e32 v1, s6
; GFX10-CU-NEXT:    v_mov_b32_e32 v2, s7
; GFX10-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-CU-NEXT:    flat_store_dword v[1:2], v0
...
; SKIP-CACHE-INV:       ; %bb.0: ; %entry
; SKIP-CACHE-INV-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; SKIP-CACHE-INV-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x2
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; SKIP-CACHE-INV-NEXT:    s_load_dwordx2 s[2:3], s[4:5], 0x2
; SKIP-CACHE-INV-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v2, v0
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v3, v1
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s4, 2
; SKIP-CACHE-INV-NEXT:    v_lshl_b64 v[0:1], v[2:3], s4
; SKIP-CACHE-INV-NEXT:    s_waitcnt lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s4, s0
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v2, v0
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s0, s1
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v0, v1
; SKIP-CACHE-INV-NEXT:    v_add_i32_e64 v1, s[4:5], s4, v2
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v2, s0
; SKIP-CACHE-INV-NEXT:    v_addc_u32_e64 v0, s[0:1], v2, v0, s[4:5]
; SKIP-CACHE-INV-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v2, v0
; SKIP-CACHE-INV-NEXT:    flat_load_dword v0, v[1:2] glc slc
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v1, s2
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v2, s3
; SKIP-CACHE-INV-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    flat_store_dword v[1:2], v0
...
; GFX90A-NOTTGSPLIT-NEXT:    s_add_u32 flat_scratch_lo, s12, s17
; GFX90A-NOTTGSPLIT-NEXT:    s_addc_u32 flat_scratch_hi, s13, 0
; GFX90A-NOTTGSPLIT-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX90A-NOTTGSPLIT-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x0
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NOTTGSPLIT-NEXT:    s_load_dwordx2 s[4:5], s[8:9], 0x8
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX90A-NOTTGSPLIT-NEXT:    v_and_b32_e64 v0, v0, s8
; GFX90A-NOTTGSPLIT-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v2, v0
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v3, v1
; GFX90A-NOTTGSPLIT-NEXT:    s_mov_b32 s8, 2
; GFX90A-NOTTGSPLIT-NEXT:    v_lshlrev_b64 v[0:1], s8, v[2:3]
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-NOTTGSPLIT-NEXT:    s_mov_b32 s8, s4
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v2, v0
; GFX90A-NOTTGSPLIT-NEXT:    s_mov_b32 s4, s5
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v0, v1
; GFX90A-NOTTGSPLIT-NEXT:    v_add_co_u32_e64 v1, s[8:9], s8, v2
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v2, s4
; GFX90A-NOTTGSPLIT-NEXT:    v_addc_co_u32_e64 v0, s[4:5], v2, v0, s[8:9]
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v2, v1
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v3, v0
; GFX90A-NOTTGSPLIT-NEXT:    flat_load_dword v0, v[2:3] glc slc
; GFX90A-NOTTGSPLIT-NEXT:    v_pk_mov_b32 v[2:3], s[6:7], s[6:7] op_sel:[0,1]
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-NOTTGSPLIT-NEXT:    flat_store_dword v[2:3], v0
; GFX90A-NOTTGSPLIT-NEXT:    s_endpgm
...
; GFX90A-TGSPLIT-NEXT:    v_and_b32_e64 v0, v0, s8
; GFX90A-TGSPLIT-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v2, v0
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v3, v1
; GFX90A-TGSPLIT-NEXT:    s_mov_b32 s8, 2
; GFX90A-TGSPLIT-NEXT:    v_lshlrev_b64 v[0:1], s8, v[2:3]
; GFX90A-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX90A-TGSPLIT-NEXT:    s_mov_b32 s8, s4
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v2, v0
; GFX90A-TGSPLIT-NEXT:    s_mov_b32 s4, s5
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v0, v1
; GFX90A-TGSPLIT-NEXT:    v_add_co_u32_e64 v1, s[8:9], s8, v2
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v2, s4
; GFX90A-TGSPLIT-NEXT:    v_addc_co_u32_e64 v0, s[4:5], v2, v0, s[8:9]
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v2, v1
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v3, v0
; GFX90A-TGSPLIT-NEXT:    flat_load_dword v0, v[2:3] glc slc
; GFX90A-TGSPLIT-NEXT:    v_pk_mov_b32 v[2:3], s[6:7], s[6:7] op_sel:[0,1]
; GFX90A-TGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-TGSPLIT-NEXT:    flat_store_dword v[2:3], v0
; GFX90A-TGSPLIT-NEXT:    s_endpgm
...
; GFX942-NOTTGSPLIT:       ; %bb.0: ; %entry
; GFX942-NOTTGSPLIT-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX942-NOTTGSPLIT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NOTTGSPLIT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x8
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX942-NOTTGSPLIT-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v2, v0
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v3, v1
; GFX942-NOTTGSPLIT-NEXT:    s_mov_b32 s4, 2
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX942-NOTTGSPLIT-NEXT:    v_lshl_add_u64 v[0:1], v[2:3], s4, v[0:1]
; GFX942-NOTTGSPLIT-NEXT:    flat_load_dword v0, v[0:1] nt
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NOTTGSPLIT-NEXT:    flat_store_dword v[2:3], v0
...
; GFX942-TGSPLIT:       ; %bb.0: ; %entry
; GFX942-TGSPLIT-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX942-TGSPLIT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; GFX942-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-TGSPLIT-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x8
; GFX942-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX942-TGSPLIT-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX942-TGSPLIT-NEXT:    v_mov_b32_e32 v2, v0
; GFX942-TGSPLIT-NEXT:    v_mov_b32_e32 v3, v1
; GFX942-TGSPLIT-NEXT:    s_mov_b32 s4, 2
; GFX942-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-TGSPLIT-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX942-TGSPLIT-NEXT:    v_lshl_add_u64 v[0:1], v[2:3], s4, v[0:1]
; GFX942-TGSPLIT-NEXT:    flat_load_dword v0, v[0:1] nt
; GFX942-TGSPLIT-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-TGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX942-TGSPLIT-NEXT:    flat_store_dword v[2:3], v0
...
; GFX11-WGP:       ; %bb.0: ; %entry
; GFX11-WGP-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX11-WGP-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX11-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-WGP-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX11-WGP-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-WGP-NEXT:    v_and_b32_e64 v0, v0, s4
; GFX11-WGP-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX11-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-WGP-NEXT:    v_mov_b32_e32 v3, v1
; GFX11-WGP-NEXT:    s_mov_b32 s4, 2
; GFX11-WGP-NEXT:    v_lshlrev_b64 v[0:1], s4, v[2:3]
; GFX11-WGP-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-WGP-NEXT:    s_mov_b32 s4, s0
; GFX11-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-WGP-NEXT:    s_mov_b32 s0, s1
; GFX11-WGP-NEXT:    v_mov_b32_e32 v0, v1
; GFX11-WGP-NEXT:    v_add_co_u32 v1, s1, s4, v2
; GFX11-WGP-NEXT:    v_add_co_ci_u32_e64 v0, s0, s0, v0, s1
; GFX11-WGP-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX11-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-WGP-NEXT:    flat_load_b32 v0, v[1:2] slc dlc
; GFX11-WGP-NEXT:    v_mov_b32_e32 v1, s2
; GFX11-WGP-NEXT:    v_mov_b32_e32 v2, s3
; GFX11-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-WGP-NEXT:    flat_store_b32 v[1:2], v0
...
; GFX11-CU:       ; %bb.0: ; %entry
; GFX11-CU-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX11-CU-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0
; GFX11-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-CU-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8
; GFX11-CU-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX11-CU-NEXT:    v_and_b32_e64 v0, v0, s4
; GFX11-CU-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
; GFX11-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-CU-NEXT:    v_mov_b32_e32 v3, v1
; GFX11-CU-NEXT:    s_mov_b32 s4, 2
; GFX11-CU-NEXT:    v_lshlrev_b64 v[0:1], s4, v[2:3]
; GFX11-CU-NEXT:    s_waitcnt lgkmcnt(0)
; GFX11-CU-NEXT:    s_mov_b32 s4, s0
; GFX11-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-CU-NEXT:    s_mov_b32 s0, s1
; GFX11-CU-NEXT:    v_mov_b32_e32 v0, v1
; GFX11-CU-NEXT:    v_add_co_u32 v1, s1, s4, v2
; GFX11-CU-NEXT:    v_add_co_ci_u32_e64 v0, s0, s0, v0, s1
; GFX11-CU-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX11-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX11-CU-NEXT:    flat_load_b32 v0, v[1:2] slc dlc
; GFX11-CU-NEXT:    v_mov_b32_e32 v1, s2
; GFX11-CU-NEXT:    v_mov_b32_e32 v2, s3
; GFX11-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-CU-NEXT:    flat_store_b32 v[1:2], v0
...
; GFX12-WGP-NEXT:    v_and_b32_e64 v0, v0, s4
; GFX12-WGP-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
...
; GFX12-WGP-NEXT:    v_lshlrev_b64_e64 v[0:1], s4, v[2:3]
; GFX12-WGP-NEXT:    s_wait_kmcnt 0x0
; GFX12-WGP-NEXT:    s_mov_b32 s4, s0
; GFX12-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-WGP-NEXT:    s_mov_b32 s0, s1
; GFX12-WGP-NEXT:    v_mov_b32_e32 v0, v1
; GFX12-WGP-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-WGP-NEXT:    v_add_co_u32 v1, s1, s4, v2
; GFX12-WGP-NEXT:    v_add_co_ci_u32_e64 v0, s0, s0, v0, s1
; GFX12-WGP-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX12-WGP-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-WGP-NEXT:    flat_load_b32 v0, v[1:2] th:TH_LOAD_NT
; GFX12-WGP-NEXT:    v_mov_b32_e32 v1, s2
; GFX12-WGP-NEXT:    v_mov_b32_e32 v2, s3
; GFX12-WGP-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-WGP-NEXT:    flat_store_b32 v[1:2], v0
...
; GFX12-CU-NEXT:    v_and_b32_e64 v0, v0, s4
; GFX12-CU-NEXT:    v_ashrrev_i32_e64 v1, 31, v0
...
; GFX12-CU-NEXT:    v_lshlrev_b64_e64 v[0:1], s4, v[2:3]
; GFX12-CU-NEXT:    s_wait_kmcnt 0x0
; GFX12-CU-NEXT:    s_mov_b32 s4, s0
; GFX12-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-CU-NEXT:    s_mov_b32 s0, s1
; GFX12-CU-NEXT:    v_mov_b32_e32 v0, v1
; GFX12-CU-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-CU-NEXT:    v_add_co_u32 v1, s1, s4, v2
; GFX12-CU-NEXT:    v_add_co_ci_u32_e64 v0, s0, s0, v0, s1
; GFX12-CU-NEXT:    ; kill: def $vgpr1 killed $vgpr1 def $vgpr1_vgpr2 killed $exec
; GFX12-CU-NEXT:    v_mov_b32_e32 v2, v0
; GFX12-CU-NEXT:    flat_load_b32 v0, v[1:2] th:TH_LOAD_NT
; GFX12-CU-NEXT:    v_mov_b32_e32 v1, s2
; GFX12-CU-NEXT:    v_mov_b32_e32 v2, s3
; GFX12-CU-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-CU-NEXT:    flat_store_b32 v[1:2], v0
...
; GFX1250-NEXT:    v_nop
; GFX1250-NEXT:    s_setreg_imm32_b32 hwreg(HW_REG_WAVE_MODE, 25, 1), 1 ; msbs: dst=0 src0=0 src1=0 src2=0
; GFX1250-NEXT:    ; kill: def $vgpr0 killed $vgpr0 killed $exec
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x0 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    s_load_b64 s[0:1], s[4:5], 0x8 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
...
; GFX1250-NEXT:    v_and_b32_e64 v0, v0, s4
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    flat_load_b32 v0, v0, s[0:1] scale_offset th:TH_LOAD_NT
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    flat_store_b32 v1, v0, s[2:3]
; GFX1250-NEXT:    s_endpgm
    ptr %in, ptr %out) #0 {
entry:
...
; GFX7-NEXT:    v_mov_b32_e32 v2, s7
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    flat_store_dword v[1:2], v0 glc slc
; GFX7-NEXT:    s_endpgm
;
...
; GFX10-WGP-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-WGP-NEXT:    v_mov_b32_e32 v1, s5
; GFX10-WGP-NEXT:    flat_load_dword v0, v[0:1]
; GFX10-WGP-NEXT:    v_mov_b32_e32 v1, s6
; GFX10-WGP-NEXT:    v_mov_b32_e32 v2, s7
; GFX10-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-WGP-NEXT:    flat_store_dword v[1:2], v0 glc slc
; GFX10-WGP-NEXT:    s_endpgm
;
...
; GFX10-CU-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-CU-NEXT:    v_mov_b32_e32 v1, s5
; GFX10-CU-NEXT:    flat_load_dword v0, v[0:1]
; GFX10-CU-NEXT:    v_mov_b32_e32 v1, s6
; GFX10-CU-NEXT:    v_mov_b32_e32 v2, s7
; GFX10-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-CU-NEXT:    flat_store_dword v[1:2], v0 glc slc
; GFX10-CU-NEXT:    s_endpgm
;
...
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v2, s3
; SKIP-CACHE-INV-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    flat_store_dword v[1:2], v0 glc slc
; SKIP-CACHE-INV-NEXT:    s_endpgm
;
...
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX942-NOTTGSPLIT-NEXT:    flat_load_dword v0, v[0:1]
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NOTTGSPLIT-NEXT:    flat_store_dword v[2:3], v0 nt
; GFX942-NOTTGSPLIT-NEXT:    s_endpgm
;
...
; GFX942-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-TGSPLIT-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX942-TGSPLIT-NEXT:    flat_load_dword v0, v[0:1]
; GFX942-TGSPLIT-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-TGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX942-TGSPLIT-NEXT:    flat_store_dword v[2:3], v0 nt
; GFX942-TGSPLIT-NEXT:    s_endpgm
;
...
; GFX11-WGP-NEXT:    v_mov_b32_e32 v0, s0
; GFX11-WGP-NEXT:    v_mov_b32_e32 v1, s1
; GFX11-WGP-NEXT:    flat_load_b32 v0, v[0:1]
; GFX11-WGP-NEXT:    v_mov_b32_e32 v1, s2
; GFX11-WGP-NEXT:    v_mov_b32_e32 v2, s3
; GFX11-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-WGP-NEXT:    flat_store_b32 v[1:2], v0 glc slc dlc
; GFX11-WGP-NEXT:    s_endpgm
;
...
; GFX11-CU-NEXT:    v_mov_b32_e32 v0, s0
; GFX11-CU-NEXT:    v_mov_b32_e32 v1, s1
; GFX11-CU-NEXT:    flat_load_b32 v0, v[0:1]
; GFX11-CU-NEXT:    v_mov_b32_e32 v1, s2
; GFX11-CU-NEXT:    v_mov_b32_e32 v2, s3
; GFX11-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-CU-NEXT:    flat_store_b32 v[1:2], v0 glc slc dlc
; GFX11-CU-NEXT:    s_endpgm
;
...
; GFX12-WGP-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-WGP-NEXT:    v_mov_b32_e32 v1, s1
; GFX12-WGP-NEXT:    flat_load_b32 v0, v[0:1]
; GFX12-WGP-NEXT:    v_mov_b32_e32 v1, s2
; GFX12-WGP-NEXT:    v_mov_b32_e32 v2, s3
; GFX12-WGP-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-WGP-NEXT:    flat_store_b32 v[1:2], v0 th:TH_STORE_NT
; GFX12-WGP-NEXT:    s_endpgm
;
...
; GFX12-CU-NEXT:    v_mov_b32_e32 v2, s3
; GFX12-CU-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-CU-NEXT:    flat_store_b32 v[1:2], v0 th:TH_STORE_NT
; GFX12-CU-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    flat_store_b32 v0, v1, s[2:3] th:TH_STORE_NT
; GFX1250-NEXT:    s_endpgm
    ptr %in, ptr %out) #0 {
entry:
...
; GFX7-NEXT:    flat_load_dword v1, v[1:2]
; GFX7-NEXT:    v_ashrrev_i32_e64 v2, 31, v0
; GFX7-NEXT:    v_mov_b32_e32 v3, v0
; GFX7-NEXT:    v_mov_b32_e32 v4, v2
; GFX7-NEXT:    s_mov_b32 s4, 2
; GFX7-NEXT:    v_lshl_b64 v[2:3], v[3:4], s4
; GFX7-NEXT:    s_mov_b32 s4, s6
; GFX7-NEXT:    v_mov_b32_e32 v0, v2
; GFX7-NEXT:    s_mov_b32 s5, s7
; GFX7-NEXT:    v_mov_b32_e32 v2, v3
; GFX7-NEXT:    v_add_i32_e64 v0, s[6:7], s4, v0
; GFX7-NEXT:    v_mov_b32_e32 v3, s5
; GFX7-NEXT:    v_addc_u32_e64 v2, s[4:5], v3, v2, s[6:7]
; GFX7-NEXT:    v_mov_b32_e32 v3, v0
; GFX7-NEXT:    v_mov_b32_e32 v4, v2
; GFX7-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX7-NEXT:    flat_store_dword v[3:4], v1 glc slc
; GFX7-NEXT:    s_endpgm
;
...
; GFX10-WGP-NEXT:    flat_load_dword v1, v[1:2]
; GFX10-WGP-NEXT:    v_ashrrev_i32_e64 v2, 31, v0
; GFX10-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX10-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX10-WGP-NEXT:    s_mov_b32 s4, 2
; GFX10-WGP-NEXT:    v_lshlrev_b64 v[2:3], s4, v[3:4]
; GFX10-WGP-NEXT:    s_mov_b32 s4, s6
; GFX10-WGP-NEXT:    v_mov_b32_e32 v0, v2
; GFX10-WGP-NEXT:    s_mov_b32 s5, s7
; GFX10-WGP-NEXT:    v_mov_b32_e32 v2, v3
; GFX10-WGP-NEXT:    v_add_co_u32 v0, s4, s4, v0
; GFX10-WGP-NEXT:    v_add_co_ci_u32_e64 v2, s4, s5, v2, s4
; GFX10-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX10-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX10-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-WGP-NEXT:    flat_store_dword v[3:4], v1 glc slc
; GFX10-WGP-NEXT:    s_endpgm
;
...
; GFX10-CU-NEXT:    flat_load_dword v1, v[1:2]
; GFX10-CU-NEXT:    v_ashrrev_i32_e64 v2, 31, v0
; GFX10-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX10-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX10-CU-NEXT:    s_mov_b32 s4, 2
; GFX10-CU-NEXT:    v_lshlrev_b64 v[2:3], s4, v[3:4]
; GFX10-CU-NEXT:    s_mov_b32 s4, s6
; GFX10-CU-NEXT:    v_mov_b32_e32 v0, v2
; GFX10-CU-NEXT:    s_mov_b32 s5, s7
; GFX10-CU-NEXT:    v_mov_b32_e32 v2, v3
; GFX10-CU-NEXT:    v_add_co_u32 v0, s4, s4, v0
; GFX10-CU-NEXT:    v_add_co_ci_u32_e64 v2, s4, s5, v2, s4
; GFX10-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX10-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX10-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX10-CU-NEXT:    flat_store_dword v[3:4], v1 glc slc
; GFX10-CU-NEXT:    s_endpgm
;
...
; SKIP-CACHE-INV-NEXT:    flat_load_dword v1, v[1:2]
; SKIP-CACHE-INV-NEXT:    v_ashrrev_i32_e64 v2, 31, v0
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v3, v0
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v4, v2
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s0, 2
; SKIP-CACHE-INV-NEXT:    v_lshl_b64 v[2:3], v[3:4], s0
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s0, s2
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v0, v2
; SKIP-CACHE-INV-NEXT:    s_mov_b32 s1, s3
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v2, v3
; SKIP-CACHE-INV-NEXT:    v_add_i32_e64 v0, s[2:3], s0, v0
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v3, s1
; SKIP-CACHE-INV-NEXT:    v_addc_u32_e64 v2, s[0:1], v3, v2, s[2:3]
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v3, v0
; SKIP-CACHE-INV-NEXT:    v_mov_b32_e32 v4, v2
; SKIP-CACHE-INV-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; SKIP-CACHE-INV-NEXT:    flat_store_dword v[3:4], v1 glc slc
; SKIP-CACHE-INV-NEXT:    s_endpgm
;
...
; GFX90A-NOTTGSPLIT-NEXT:    flat_load_dword v1, v[2:3]
...
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v4, v0
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v5, v2
; GFX90A-NOTTGSPLIT-NEXT:    s_mov_b32 s4, 2
; GFX90A-NOTTGSPLIT-NEXT:    v_lshlrev_b64 v[2:3], s4, v[4:5]
; GFX90A-NOTTGSPLIT-NEXT:    s_mov_b32 s4, s6
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v0, v2
; GFX90A-NOTTGSPLIT-NEXT:    s_mov_b32 s5, s7
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v2, v3
; GFX90A-NOTTGSPLIT-NEXT:    v_add_co_u32_e64 v0, s[6:7], s4, v0
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v3, s5
; GFX90A-NOTTGSPLIT-NEXT:    v_addc_co_u32_e64 v2, s[4:5], v3, v2, s[6:7]
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v4, v0
; GFX90A-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v5, v2
; GFX90A-NOTTGSPLIT-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX90A-NOTTGSPLIT-NEXT:    flat_store_dword v[4:5], v1 glc slc
; GFX90A-NOTTGSPLIT-NEXT:    s_endpgm
;
...
; GFX90A-TGSPLIT-NEXT:    flat_load_dword v1, v[2:3]
...
; GFX90A-TGSPLIT-NEXT:    v_lshlrev_b64 v[2:3], s4, v[4:5]
; GFX90A-TGSPLIT-NEXT:    s_mov_b32 s4, s6
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v0, v2
; GFX90A-TGSPLIT-NEXT:    s_mov_b32 s5, s7
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v2, v3
; GFX90A-TGSPLIT-NEXT:    v_add_co_u32_e64 v0, s[6:7], s4, v0
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v3, s5
; GFX90A-TGSPLIT-NEXT:    v_addc_co_u32_e64 v2, s[4:5], v3, v2, s[6:7]
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v4, v0
; GFX90A-TGSPLIT-NEXT:    v_mov_b32_e32 v5, v2
; GFX90A-TGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX90A-TGSPLIT-NEXT:    flat_store_dword v[4:5], v1 glc slc
; GFX90A-TGSPLIT-NEXT:    s_endpgm
;
...
; GFX942-NOTTGSPLIT-NEXT:    flat_load_dword v1, v[2:3]
...
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v4, v0
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b32_e32 v5, v2
; GFX942-NOTTGSPLIT-NEXT:    s_mov_b32 s0, 2
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-NOTTGSPLIT-NEXT:    v_lshl_add_u64 v[2:3], v[4:5], s0, v[2:3]
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX942-NOTTGSPLIT-NEXT:    flat_store_dword v[2:3], v1 nt
; GFX942-NOTTGSPLIT-NEXT:    s_endpgm
;
...
; GFX942-TGSPLIT-NEXT:    flat_load_dword v1, v[2:3]
...
; GFX942-TGSPLIT-NEXT:    v_mov_b32_e32 v4, v0
; GFX942-TGSPLIT-NEXT:    v_mov_b32_e32 v5, v2
; GFX942-TGSPLIT-NEXT:    s_mov_b32 s0, 2
; GFX942-TGSPLIT-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-TGSPLIT-NEXT:    v_lshl_add_u64 v[2:3], v[4:5], s0, v[2:3]
; GFX942-TGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX942-TGSPLIT-NEXT:    flat_store_dword v[2:3], v1 nt
; GFX942-TGSPLIT-NEXT:    s_endpgm
;
...
; GFX11-WGP-NEXT:    flat_load_b32 v1, v[1:2]
...
; GFX11-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX11-WGP-NEXT:    s_mov_b32 s0, 2
; GFX11-WGP-NEXT:    v_lshlrev_b64 v[2:3], s0, v[3:4]
; GFX11-WGP-NEXT:    s_mov_b32 s0, s2
; GFX11-WGP-NEXT:    v_mov_b32_e32 v0, v2
; GFX11-WGP-NEXT:    s_mov_b32 s1, s3
; GFX11-WGP-NEXT:    v_mov_b32_e32 v2, v3
; GFX11-WGP-NEXT:    v_add_co_u32 v0, s0, s0, v0
; GFX11-WGP-NEXT:    v_add_co_ci_u32_e64 v2, s0, s1, v2, s0
; GFX11-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX11-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX11-WGP-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-WGP-NEXT:    flat_store_b32 v[3:4], v1 glc slc dlc
; GFX11-WGP-NEXT:    s_endpgm
;
...
; GFX11-CU-NEXT:    flat_load_b32 v1, v[1:2]
...
; GFX11-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX11-CU-NEXT:    s_mov_b32 s0, 2
; GFX11-CU-NEXT:    v_lshlrev_b64 v[2:3], s0, v[3:4]
; GFX11-CU-NEXT:    s_mov_b32 s0, s2
; GFX11-CU-NEXT:    v_mov_b32_e32 v0, v2
; GFX11-CU-NEXT:    s_mov_b32 s1, s3
; GFX11-CU-NEXT:    v_mov_b32_e32 v2, v3
; GFX11-CU-NEXT:    v_add_co_u32 v0, s0, s0, v0
; GFX11-CU-NEXT:    v_add_co_ci_u32_e64 v2, s0, s1, v2, s0
; GFX11-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX11-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX11-CU-NEXT:    s_waitcnt vmcnt(0) lgkmcnt(0)
; GFX11-CU-NEXT:    flat_store_b32 v[3:4], v1 glc slc dlc
; GFX11-CU-NEXT:    s_endpgm
;
...
; GFX12-WGP-NEXT:    flat_load_b32 v1, v[1:2]
...
; GFX12-WGP-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-WGP-NEXT:    v_lshlrev_b64_e64 v[2:3], s0, v[3:4]
; GFX12-WGP-NEXT:    s_mov_b32 s0, s2
; GFX12-WGP-NEXT:    v_mov_b32_e32 v0, v2
; GFX12-WGP-NEXT:    s_mov_b32 s1, s3
; GFX12-WGP-NEXT:    v_mov_b32_e32 v2, v3
; GFX12-WGP-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-WGP-NEXT:    v_add_co_u32 v0, s0, s0, v0
; GFX12-WGP-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-WGP-NEXT:    v_add_co_ci_u32_e64 v2, s0, s1, v2, s0
; GFX12-WGP-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-WGP-NEXT:    v_mov_b32_e32 v4, v2
; GFX12-WGP-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-WGP-NEXT:    flat_store_b32 v[3:4], v1 th:TH_STORE_NT
; GFX12-WGP-NEXT:    s_endpgm
;
...
; GFX12-CU-NEXT:    flat_load_b32 v1, v[1:2]
...
; GFX12-CU-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-CU-NEXT:    v_lshlrev_b64_e64 v[2:3], s0, v[3:4]
; GFX12-CU-NEXT:    s_mov_b32 s0, s2
; GFX12-CU-NEXT:    v_mov_b32_e32 v0, v2
; GFX12-CU-NEXT:    s_mov_b32 s1, s3
; GFX12-CU-NEXT:    v_mov_b32_e32 v2, v3
; GFX12-CU-NEXT:    s_wait_alu depctr_sa_sdst(0)
; GFX12-CU-NEXT:    v_add_co_u32 v0, s0, s0, v0
; GFX12-CU-NEXT:    s_wait_alu depctr_va_sdst(0)
; GFX12-CU-NEXT:    v_add_co_ci_u32_e64 v2, s0, s1, v2, s0
; GFX12-CU-NEXT:    v_mov_b32_e32 v3, v0
; GFX12-CU-NEXT:    v_mov_b32_e32 v4, v2
; GFX12-CU-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX12-CU-NEXT:    flat_store_b32 v[3:4], v1 th:TH_STORE_NT
; GFX12-CU-NEXT:    s_endpgm
;
...
; GFX1250-NEXT:    s_load_b64 s[2:3], s[4:5], 0x8 nv
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    flat_load_b32 v1, v1, s[0:1]
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_mov_b32 s0, 0x3ff
; GFX1250-NEXT:    v_and_b32_e64 v0, v0, s0
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    flat_store_b32 v0, v1, s[2:3] scale_offset th:TH_STORE_NT
; GFX1250-NEXT:    s_endpgm
    ptr %in, ptr %out) #0 {
entry:
  %tid = call i32 @llvm.amdgcn.workitem.id.x()
...
; GFX10-WGP-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-WGP-NEXT:    v_mov_b32_e32 v1, s5
; GFX10-WGP-NEXT:    flat_load_dword v0, v[0:1] glc dlc
...
; GFX10-CU-NEXT:    v_mov_b32_e32 v0, s4
; GFX10-CU-NEXT:    v_mov_b32_e32 v1, s5
; GFX10-CU-NEXT:    flat_load_dword v0, v[0:1] glc dlc
...
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-NOTTGSPLIT-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX942-NOTTGSPLIT-NEXT:    flat_load_dword v0, v[0:1] sc0 sc1
...
; GFX942-TGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
; GFX942-TGSPLIT-NEXT:    v_mov_b64_e32 v[0:1], s[0:1]
; GFX942-TGSPLIT-NEXT:    flat_load_dword v0, v[0:1] sc0 sc1
; GFX942-TGSPLIT-NEXT:    s_waitcnt vmcnt(0)
; GFX942-TGSPLIT-NEXT:    v_mov_b64_e32 v[2:3], s[2:3]
; GFX942-TGSPLIT-NEXT:    flat_store_dword v[2:3], v0
; GFX942-TGSPLIT-NEXT:    s_endpgm
...
; GFX11-WGP-NEXT:    v_mov_b32_e32 v0, s0
; GFX11-WGP-NEXT:    v_mov_b32_e32 v1, s1
; GFX11-WGP-NEXT:    flat_load_b32 v0, v[0:1] glc dlc
...
; GFX11-CU-NEXT:    v_mov_b32_e32 v0, s0
; GFX11-CU-NEXT:    v_mov_b32_e32 v1, s1
; GFX11-CU-NEXT:    flat_load_b32 v0, v[0:1] glc dlc
...
; GFX12-WGP-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-WGP-NEXT:    v_mov_b32_e32 v1, s1
; GFX12-WGP-NEXT:    flat_load_b32 v0, v[0:1] th:TH_LOAD_NT scope:SCOPE_SYS
...
; GFX12-CU-NEXT:    v_mov_b32_e32 v0, s0
; GFX12-CU-NEXT:    v_mov_b32_e32 v1, s1
; GFX12-CU-NEXT:    flat_load_b32 v0, v[0:1] th:TH_LOAD_NT scope:SCOPE_SYS
...
; GFX1250-NEXT:    s_wait_xcnt 0x0
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    flat_load_b32 v1, v0, s[0:1] th:TH_LOAD_NT scope:SCOPE_SYS
; GFX1250-NEXT:    s_wait_loadcnt_dscnt 0x0
; GFX1250-NEXT:    flat_store_b32 v0, v1, s[2:3]
; GFX1250-NEXT:    s_endpgm
    ptr %in, ptr %out) #0 {
