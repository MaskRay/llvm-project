...
; GFX942-NOTTGSPLIT-NEXT:    ds_read_b32 v0, v0
; GFX942-NOTTGSPLIT-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX12-WGP-NEXT:    v_lshl_add_u32 v0, v0, s1, s0
...
; GFX12-CU-NEXT:    v_lshl_add_u32 v0, v0, s1, s0
...
; GFX1250-NEXT:    s_wait_kmcnt 0x0
; GFX1250-NEXT:    v_lshl_add_u32 v0, v0, s1, s0
...
; GFX6-NEXT:    v_add_i32_e64 v0, s[6:7], s4, v0
; GFX6-NEXT:    s_mov_b32 m0, -1
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_mov_b32_e32 v1, s5
; GFX6-NEXT:    ds_write_b32 v0, v1
