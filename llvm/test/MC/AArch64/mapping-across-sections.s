...
// RUN: llvm-mc -triple=aarch64 -filetype=obj -aarch64-initial-mapping-for-text=0 %s | llvm-objdump -t - | FileCheck %s --check-prefix=CHECK1
...
// CHECK-NEXT: 0000000000000008 l       .rodata        0000000000000000 $d.6
// CHECK-NOT:  {{.}}
