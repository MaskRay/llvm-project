...
# CHECK-NEXT: [ 5] .crel.data      CREL          0000000000000000 000198 00002a 01   I 10   4  1
# CHECK-NEXT: [ 6] .rodata           PROGBITS        0000000000000000 000042 00008b 00   A  0   0  1
# CHECK-NEXT: [ 7] .crel.rodata    CREL          0000000000000000 0001c2 000015 01   I 10   6  1
# CHECK-NEXT: [ 8] .debug_addr       PROGBITS        0000000000000000 0000cd 000008 00      0   0  1
# CHECK-NEXT: [ 9] .crel.debug_addr CREL         0000000000000000 0001d7 000005 01   I 10   8  1
...
# CHECK-EMPTY:
# CHECK-NEXT: Relocation section '.crel.rodata' at offset {{.*}} contains 5 entries:
# CHECK-NEXT:     Offset             Info             Type               Symbol's Value  Symbol's Name + Addend
...
# CHECK-EMPTY:
# CHECK-NEXT: Relocation section '.crel.debug_addr' at offset {{.*}} contains 1 entries:
# CHECK-NEXT:     Offset             Info             Type               Symbol's Value  Symbol's Name + Addend
