...
.ifdef ERR
# ERR: [[#@LINE+1]]:17: error: %pltpcrel can only be used in a .word directive
.quad %pltpcrel(g)

# ERR: [[#@LINE+1]]:18: error: expected relocatable expression
.word %pltpcrel(g-.)

# ERR: [[#@LINE+1]]:24: error: expected relocatable expression
.word %pltpcrel(extern - und)

# ERR: [[#@LINE+1]]:17: error: %gotpcrel can only be used in a .word directive
.quad %gotpcrel(g)
