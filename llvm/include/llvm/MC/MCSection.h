...
public:
  ...
  Align getAlignment() const { return u.align.Alignment; }
  int64_t getAlignFill() const { return u.align.Fill; }
  uint8_t getAlignFillLen() const { return u.align.FillLen; }
  unsigned getAlignMaxBytesToEmit() const { return u.align.MaxBytesToEmit; }
  bool hasAlignEmitNops() const { return u.align.EmitNops; }
