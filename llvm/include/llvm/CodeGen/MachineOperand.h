...
private:
  ...
  /// register has to move the rest with it.  Rewriting a tie moves one operand
  /// alone, so for virtual registers none of them may be tied to a def that
  /// names a different register; read a register defined by IMPLICIT_DEF
  /// instead.
  ///
  unsigned IsUndef : 1;
