...
# LAZY-NEXT:      Offset             Info             Type               Symbol's Value  Symbol's Name + Addend
# LAZY-NEXT:  [[#D+8]]          {{.*}}           R_X86_64_64            {{.*}}           _start + 0
# LAZY-NEXT:                    {{.*}}           R_X86_64_GLOB_DAT      0000000000000000 func + 0
# LAZY-NEXT:  [[#D]]            {{.*}}           R_X86_64_RELATIVE                       0
# LAZY-EMPTY:
